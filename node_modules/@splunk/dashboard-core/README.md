...
@splunk/dashboard-core is a core component in Dashboard Framework that manages the state between visualizations, inputs and their datasources. You must wrap this component with a [DashboardContextProvider](http://eng.sv.splunk.com/dashboard/20.7.0/index.html#/DashboardContext).
