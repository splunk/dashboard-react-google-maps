...
var parse = function parse(dataSources, userDefinedEncoding) {
  ...
  if (lodash_isEmpty__WEBPACK_IMPORTED_MODULE_1___default()(userDefinedEncoding) || !userDefinedEncoding.trend || !userDefinedEncoding.trend.length) {
    console.warn(_errorMsgs__WEBPACK_IMPORTED_MODULE_2__["ErrorMsgs"].NO_ENCODING); // eslint-disable-line no-console
  }
  ...
  var props = Object(_splunk_visualization_encoding_parsers_Base__WEBPACK_IMPORTED_MODULE_0__["parse"])(dataSources, encoding);
  var parsedProps = {};

  try {
    Object.keys(props).forEach(function (encodingKey) {
      var encodingValue = props[encodingKey];
      var valueIndex = encodingValue.length - 1;

      if (encodingKey === 'trend') {
        parsedProps.value = encodingValue[valueIndex];
        parsedProps.deltaValue = encodingValue.length === 1 ? null : encodingValue[valueIndex] - encodingValue[valueIndex - 1];
    ...
    throw new Error(_errorMsgs__WEBPACK_IMPORTED_MODULE_2__["ErrorMsgs"].ERROR_PARSE);
  }
...
/******/ });
//# sourceMappingURL=SingleValueRadialParser.js.map