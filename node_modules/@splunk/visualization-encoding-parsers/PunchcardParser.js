...
var parse = function parse(dataSources, userDefinedEncoding) {
  ...
  var parsedSize = parsedProps.size;

  if (typeof parsedProps.size[0] === 'string') {
    parsedSize = parsedProps.size.map(function (sizeValue) {
      var parsedSizeNum = Number(sizeValue);
  ...
  return {
    ...
    // eslint-disable-line dot-notation
    categoryFieldName: parsedProps['_meta'].fieldNames.category,
    // eslint-disable-line dot-notation
...
/******/ });
//# sourceMappingURL=PunchcardParser.js.map