...
var FormatterPresets_1 = __webpack_require__(18);

var DataPrimitive_1 = __webpack_require__(20);
...
var DslParser_1 = __webpack_require__(23);

var EncodingParser_1 = __webpack_require__(24);
...
var DataSeries_1 = __webpack_require__(4);
...
var DataFrame_1 = __webpack_require__(13);
...
var SetColorChannel_1 = __webpack_require__(26);
...
var EncodingExecutor_1 = __webpack_require__(5);
...
var nearley_1 = __webpack_require__(29);
...
exports.getFieldsFromDSL = exports.buildDSLFromDataSelectorAndFormatter = exports.getLastFormatterFromDSL = exports.getFormattersFromDSL = exports.getDataSelectorsFromDSL = void 0;

var FormatterPresets_1 = __webpack_require__(18);

var EncodingParser_1 = __webpack_require__(24);

var Options_1 = __webpack_require__(48);

var lodash_1 = __webpack_require__(3);

var supportedFormatters = Object.keys(FormatterPresets_1.formatterClasses);

var isFormatter = function isFormatter(str) {
  return supportedFormatters.indexOf(str) !== -1;
};
/**
...
var getDataSelectorsFromDSL = function getDataSelectorsFromDSL(dslString) {
  var ast = EncodingParser_1.default.parseOptions({
    options: {
      value: dslString
    },
    context: {}
  });
  return lodash_1.get(ast, ['expressions', 'value'], []) // filter out formatters, the rest is considered data selectors
  .filter(function (expression) {
    return !(expression.type === 'method' && isFormatter(expression.name));
  }).map(function (expression) {
    if (expression.type !== 'method') {
      return "".concat(expression.v);
    } else {
      return "".concat(expression.name, "(").concat(lodash_1.get(expression, 'args', []).map(function (arg) {
        return arg.v;
      }).join(','), ")");
    }
  });
...
exports.getDataSelectorsFromDSL = getDataSelectorsFromDSL;
/**
...
var getFormattersFromDSL = function getFormattersFromDSL(dslString) {
  var ast = EncodingParser_1.default.parseOptions({
    options: {
      value: dslString
    },
  ...
  return lodash_1.get(ast, ['expressions', 'value'], []).filter(function (expression) {
    return expression.type === 'method' && isFormatter(expression.name);
  }).map(function (expression) {
    return {
      type: expression.name,
      paramKey: lodash_1.get(expression, ['args', '0', 'v'], '')
    };
  });
};

exports.getFormattersFromDSL = getFormattersFromDSL;
/**
...
var getLastFormatterFromDSL = function getLastFormatterFromDSL(dslString) {
  return lodash_1.last(exports.getFormattersFromDSL(dslString));
};

exports.getLastFormatterFromDSL = getLastFormatterFromDSL;
/**
...
var buildDSLFromDataSelectorAndFormatter = function buildDSLFromDataSelectorAndFormatter(dataSelector, formatter) {
  var formatterParamKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
  return "> ".concat(dataSelector, " | ").concat(formatter, "(").concat(formatterParamKey, ")");
};

exports.buildDSLFromDataSelectorAndFormatter = buildDSLFromDataSelectorAndFormatter;
/**
...
var getFieldsFromDSL = function getFieldsFromDSL(dsl, dataSources) {
  // @TODO(pwied):
  // for seriesByName & seriesByIndex we could skip evaluation completely
  try {
    var _Options_1$Options$ev = Options_1.Options.evaluate({
      context: {},
      options: {
        fields: "".concat(dsl, " | getField()")
      }
    }, dataSources, function () {}),
        fields = _Options_1$Options$ev.fields;
...
exports.getFieldsFromDSL = getFieldsFromDSL;
...
var _inherits = __webpack_require__(10);

var _possibleConstructorReturn = __webpack_require__(11);
...
var Formatter_1 = __webpack_require__(14);
...
var lodash_2 = __webpack_require__(3);

var types_1 = __webpack_require__(6);

var formatterUtils_1 = __webpack_require__(17);
...
var lodash_1 = __webpack_require__(3); // There is a mismatch between typedefinition of numbro and numbro export.
// eslint-disable-next-line @typescript-eslint/no-var-requires


var numbrofn = __webpack_require__(38);
...
var Options = /*#__PURE__*/function () {
  ...
  _createClass(Options, null, [{
     ...
     * that were expressions are evaluated. The resulting object it suitable to pass to a pure viz as props.
     * @param {OptionsStanza} options
     * @param dataSources
     * @param themeFunc
     * @returns {object}
     */
    function evaluate(options, dataSources, themeFunc) {
      var dataFrames = lodash_1.mapValues(dataSources, function (ds) {
