...
var IconRegistry = /*#__PURE__*/function (_BaseRegistry) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(IconRegistry, _BaseRegistry);

  var _super = _createSuper(IconRegistry);

  function IconRegistry() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, IconRegistry);

    return _super.apply(this, arguments);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(IconRegistry, [{
    ...
    function isValidMediaType(dataURI) {
      return IconRegistry.VALID_MEDIA_TYPES.some(function (type) {
        return dataURI.indexOf("image/".concat(type)) > -1;
      });
    }
    /**
    ...
    value: function upload(dataURI, metaData, providerType) {
      if (!this.isValidMediaType(dataURI)) {
        throw new Error(Object(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_7__["_"])('The format of the uploaded file is not supported. Please upload svg file.'));
      }

      return _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(IconRegistry.prototype), "upload", this).call(this, dataURI, metaData, providerType);
    }
  }], [{
    key: "create",
    value: function create() {
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(IconRegistry, "VALID_MEDIA_TYPES", ['svg']);

/* harmony default export */ __webpack_exports__["default"] = (IconRegistry);
