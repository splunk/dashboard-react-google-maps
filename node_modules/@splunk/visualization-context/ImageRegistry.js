...
/* harmony import */ var _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
/* harmony import */ var _splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(0);
/* harmony import */ var _splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _BaseRegistry__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
...
var ImageRegistry = /*#__PURE__*/function (_BaseRegistry) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(ImageRegistry, _BaseRegistry);

  var _super = _createSuper(ImageRegistry);

  function ImageRegistry() {
    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, ImageRegistry);

    return _super.apply(this, arguments);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(ImageRegistry, [{
    key: "isValidMediaType",
    value:
    /**
     ...
     * @returns {Boolean}
     */
    function isValidMediaType(dataURI) {
      var validMediaType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ImageRegistry.VALID_MEDIA_TYPES;
      return validMediaType.some(function (type) {
        var regex = "^data:image\\/".concat(type === 'svg' ? "".concat(type, "\\+xml") : type, ";base64,.*$");
    ...
    key: "upload",
    value: function upload(dataURI, metaData, providerType) {
      var validMediaType = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : ImageRegistry.VALID_MEDIA_TYPES;

      if (!this.isValidMediaType(dataURI, validMediaType)) {
        throw new Error(Object(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_7__["_"])("The format of the uploaded file is not supported. Please upload ".concat(validMediaType.join(', '), ".")));
      }

      return _babel_runtime_helpers_get__WEBPACK_IMPORTED_MODULE_2___default()(_babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5___default()(ImageRegistry.prototype), "upload", this).call(this, dataURI, metaData, providerType);
    }
  }], [{
    key: "create",
    value: function create() {
...
}(_BaseRegistry__WEBPACK_IMPORTED_MODULE_8__["default"]);

_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_6___default()(ImageRegistry, "VALID_MEDIA_TYPES", ['png', 'jpeg', 'svg', 'gif', 'webp']);

/* harmony default export */ __webpack_exports__["default"] = (ImageRegistry);
