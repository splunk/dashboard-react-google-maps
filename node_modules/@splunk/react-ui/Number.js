...
var StyledControls = external_styled_components_default.a.div.withConfig({
...
})(["position:absolute;top:0;bottom:0;z-index:1;width:", ";", ""], Object(themes_["pick"])({
  enterprise: {
    comfortable: '20px',
    compact: '16px'
  },
  ...
  return $isAppend ? Object(external_styled_components_["css"])(["left:0;"]) : Object(external_styled_components_["css"])(["right:0;"]);
});
var incrementor = Object(external_styled_components_["css"])(["position:absolute;padding:3px;font-size:inherit;min-width:0;min-height:0;height:calc(50% + 0.5px);width:100%;"]);
...
})(["", ";bottom:0;border-top-left-radius:0;border-top-right-radius:0;", " &:not([disabled]){&,&:hover{", ";}}"], incrementor, function (_ref3) {
...
})(["top:0;border-top-right-radius:4px;padding-top:5px;"]);
...
})(["bottom:0;border-bottom-right-radius:4px;padding-bottom:5px;"]);
...
var Number_Number = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Number, null, [{
    ...
    value: function numberToString(number, props) {
      if (number === undefined || !Object(external_lodash_["isFinite"])(number)) {
        return '';
      }
    ...
    value: function limitValue(val, _ref) {
      ...
      if (min !== undefined && Object(external_lodash_["isFinite"])(min)) {
        newVal = Math.max(min, newVal);
      }

      if (max !== undefined && Object(external_lodash_["isFinite"])(max)) {
  ...
  _createClass(Number, [{
    ...
    value: function increment(e, amount) {
      ...
      if (valNumeric !== undefined && Object(external_lodash_["isFinite"])(valNumeric)) {
        // increment the entered value
        targetValNumeric = valNumeric + amount;
      } else if (this.props.defaultValue !== undefined && Object(external_lodash_["isFinite"])(this.props.defaultValue)) {
    ...
    value: function preventNegativeNumbers() {
      return this.props.min !== undefined && Object(external_lodash_["isFinite"])(this.props.min) && this.props.min >= 0;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var disableIncrement = value !== undefined && Object(external_lodash_["isFinite"])(value) && max !== undefined && Object(external_lodash_["isFinite"])(max) && value >= max;
      var disableDecrement = value !== undefined && Object(external_lodash_["isFinite"])(value) && min !== undefined && Object(external_lodash_["isFinite"])(min) && value <= min;
      ...
      }), (isPrisma || !disabled) && !hideStepButtons && /*#__PURE__*/external_react_default.a.createElement(StyledControls, {
        $isAppend: append && !prepend
