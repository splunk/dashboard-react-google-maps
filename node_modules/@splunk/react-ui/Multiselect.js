...
function Compact_createSuper(Derived) { var hasNativeReflectConstruct = Compact_isNativeReflectConstruct(); return function _createSuperInternal() { var Super = Compact_getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = Compact_getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return Compact_possibleConstructorReturn(this, result); }; }
...
function Compact_isNativeReflectConstruct() { if (typeof Reflect === "undefined" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === "function") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }
...
var Normal_Normal = /*#__PURE__*/function (_Component) {
  ...
  function Normal(props) {
    ...
    Normal_defineProperty(Normal_assertThisInitialized(_this), "activeItemId", void 0);

    Normal_defineProperty(Normal_assertThisInitialized(_this), "activeValue", void 0);

    Normal_defineProperty(Normal_assertThisInitialized(_this), "availableOptionCount", void 0);

    Normal_defineProperty(Normal_assertThisInitialized(_this), "children", void 0);

    Normal_defineProperty(Normal_assertThisInitialized(_this), "controlledExternally", void 0);

    Normal_defineProperty(Normal_assertThisInitialized(_this), "input", null);
    ...
    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleClick", function () {
      ...
      (_this$input = _this.input) === null || _this$input === void 0 ? void 0 : _this$input.focus();
    });

    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleRequestRemove", function (e, _ref) {
    ...
    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleInputFocus", function (e) {
    ...
    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleInputKeyDown", function (e) {
      var _this$input3, _this$getCurrentValue2;
      ...
      if (eventKeyCode === 'tab' && _this.state.open) {
        if (tabConfirmsNewValue && !Object(external_lodash_["isUndefined"])(_this.activeValue) && _this.availableOptionCount <= 1) {
          ...
          (_this$input2 = _this.input) === null || _this$input2 === void 0 ? void 0 : _this$input2.focus();
        } else {
          _this.setState({
            open: false
          });
      ...
      if (eventKeyCode === 'backspace' && ((_this$input3 = _this.input) === null || _this$input3 === void 0 ? void 0 : _this$input3.value) === '' && ((_this$getCurrentValue2 = _this.getCurrentValues()) === null || _this$getCurrentValue2 === void 0 ? void 0 : _this$getCurrentValue2.length)) {
        _this.removeValue(e, Object(external_lodash_["last"])(_this.getCurrentValues()));
      }
    });

    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleInputChange", function (e) {
      var _this$props$onFilterC2, _this$props4;
      ...
      (_this$props$onFilterC2 = (_this$props4 = _this.props).onFilterChange) === null || _this$props$onFilterC2 === void 0 ? void 0 : _this$props$onFilterC2.call(_this$props4, e, {
        keyword: e.target.value
      });
    });

    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleMenuOptionClick", function (e, _ref2) {
      var _this$input4;
      ...
      (_this$input4 = _this.input) === null || _this$input4 === void 0 ? void 0 : _this$input4.focus();
    });

    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleInputBlur", function (e) {
      var popoverEl = document.getElementById(_this.popoverId);
      var blurTo = e.relatedTarget || document.activeElement; // IE11 doesn't support relatedTarget but sets activeElement

      var isBlurToOwnOption = popoverEl && blurTo && popoverEl.contains(blurTo); // TS: target as Node is an unsafe assumption
      ...
      if (!isBlurToOwnOption) {
        var _this$props$onFilterC3, _this$props5;

        (_this$props$onFilterC3 = (_this$props5 = _this.props).onFilterChange) === null || _this$props$onFilterC3 === void 0 ? void 0 : _this$props$onFilterC3.call(_this$props5, e, {
          keyword: ''
        });
      }
    });

    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleRequestClose", function (_ref3) {
      var _this$state$el;

      var reason = _ref3.reason,
          event = _ref3.event;

      if (reason === 'escapeKey' || reason === 'offScreen' || reason === 'clickAway' && event !== undefined && !((_this$state$el = _this.state.el) === null || _this$state$el === void 0 ? void 0 : _this$state$el.contains(event.target)) // TS: target as Node is an unsafe assumption
      ) {
          _this.setState({
            open: false
          }, function () {
      ...
      if (reason === 'escapeKey') {
        ...
        (_this$input5 = _this.input) === null || _this$input5 === void 0 ? void 0 : _this$input5.focus();
      }
    });
    ...
    Normal_defineProperty(Normal_assertThisInitialized(_this), "handleMount", function (el) {
      _this.setState({
        el: el
      });
  ...
  Normal_createClass(Normal, [{
    ...
    value: function addValue(e, value) {
      var _this$getCurrentValue3, _this$props$onChange, _this$props8;

      var values = ((_this$getCurrentValue3 = this.getCurrentValues()) !== null && _this$getCurrentValue3 !== void 0 ? _this$getCurrentValue3 : []).concat([value]);
      ...
      (_this$props$onChange = (_this$props8 = this.props).onChange) === null || _this$props$onChange === void 0 ? void 0 : _this$props$onChange.call(_this$props8, e, {
        values: values,
        name: name
      });
    }
    ...
    value: function removeValue(e, value) {
      var _this$props$onChange2, _this$props9;
      ...
      (_this$props$onChange2 = (_this$props9 = this.props).onChange) === null || _this$props$onChange2 === void 0 ? void 0 : _this$props$onChange2.call(_this$props9, e, {
        values: values,
        name: name
      });
    }
    ...
    value: function renderButtons(selectedItems) {
      ...
      return selectedItems.map(function (selectedItem) {
        ...
        return /*#__PURE__*/external_react_default.a.createElement(Chip_default.a, {
          "aria-selected": true,
          disabled: _this2.props.disabled,
          icon: item.props ? item.props.icon : undefined,
          key: (item.props ? item.props.value : item).toString(),
    ...
    value: function render() {
      ...
      var _this$props10 = this.props,
          ...
          defaultPlacement = _this$props10.defaultPlacement,
      ...
      if (currentValues && currentValues.length) {
        external_react_["Children"].toArray(children).filter(external_react_["isValidElement"]).filter(function (item) {
      ...
      this.children = external_react_["Children"].map(childrenFiltered, function (childrenItem, i) {
