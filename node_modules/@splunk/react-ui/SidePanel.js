...
var SidePanel_SidePanel = /*#__PURE__*/function (_Component) {
  ...
  function SidePanel(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderModal", function () {
      ...
      return /*#__PURE__*/external_react_default.a.createElement(StyledTransitionOpen, _extends({
        animateOnMount: true,
        animation: animationMap[dockPosition],
        "data-test": "side-panel",
        innerClassName: innerClassName,
        innerStyle: _objectSpread(_objectSpread({}, defaultInnerStyle), innerStyle),
        ...
        tabIndex: -1,
        takeFocus: true
      }, Object(external_lodash_["omit"])(_this.props, [].concat(_toConsumableArray(Object(external_lodash_["keys"])(SidePanel.propTypes)), ['onAnimationEnd']))), children);
    });
...
_defineProperty(SidePanel_SidePanel, "propTypes", propTypes);

_defineProperty(SidePanel_SidePanel, "defaultProps", defaultProps);

_defineProperty(SidePanel_SidePanel, "getDerivedStateFromProps", function (props, state) {
