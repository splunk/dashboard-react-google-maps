...
function Markdown(_ref) {
  var blockquoteRenderer = _ref.blockquoteRenderer,
      ...
      text = _ref.text,
      otherProps = _objectWithoutProperties(_ref, ["blockquoteRenderer", "codeBlockRenderer", "codeRenderer", "headingRenderer", "imageRenderer", "itemRenderer", "linkRenderer", "listRenderer", "paragraphRenderer", "text"]);
  ...
  return /*#__PURE__*/external_react_default.a.createElement(Box_default.a, _extends({
    "data-test": "markdown"
  }, otherProps), elements);
}
