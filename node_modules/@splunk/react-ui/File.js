...
var Progress_ = __webpack_require__(77);
...
function Retry(props) {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(SVG_default.a, Retry_extends({
    hideDefaultTooltip: true,
    viewBox: "0 0 24 24",
    width: size,
    height: size
...
function Trash(props) {
  ...
  var size = density === 'compact' ? '20px' : '24px';
  return /*#__PURE__*/external_react_default.a.createElement(SVG_default.a, Trash_extends({
    hideDefaultTooltip: true,
    viewBox: "0 0 24 24",
    width: size,
    height: size
...
var mixins_ = __webpack_require__(78);
...
function Item(_ref) {
  var _ref$disabled = _ref.disabled,
      ...
      onRequestRetry = _ref.onRequestRetry,
      uploadPercentage = _ref.uploadPercentage,
      otherProps = _objectWithoutProperties(_ref, ["disabled", "error", "itemId", "name", "onRequestRemove", "onRequestRetry", "uploadPercentage"]);
  ...
  var label = isPrisma && !Object(external_lodash_["isUndefined"])(uploadPercentage) && uploadPercentage > 0 ? progressLabel : name;
  return /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null, /*#__PURE__*/external_react_default.a.createElement(StyledBox, Item_extends({
    ...
    $error: error,
    $disabled: disabled
  }), isPrisma && Object(external_lodash_["isUndefined"])(uploadPercentage) && /*#__PURE__*/external_react_default.a.createElement(StyledPaperClipIcon, {
    ...
    $error: error,
    $disabled: disabled
  }, label), isPrisma && onRequestRetry && error && /*#__PURE__*/external_react_default.a.createElement(StyledIconClickable, {
    "data-test": "retry",
    onClick: handleRequestRetry,
    "aria-label": retryLabel
  }, /*#__PURE__*/external_react_default.a.createElement(Retry, {
    screenReaderText: Object(i18n_["_"])('Retry')
  })), !disabled && (isPrisma && Object(external_lodash_["isUndefined"])(uploadPercentage) && !error ? /*#__PURE__*/external_react_default.a.createElement(StyledTrashIcon, {
    "data-test": "remove",
    ...
    screenReaderText: Object(i18n_["_"])('Remove')
  }))), !Object(external_lodash_["isUndefined"])(uploadPercentage) && uploadPercentage > 0 && (isPrisma ? /*#__PURE__*/external_react_default.a.createElement(StyledProgress, {
...
function FileIcon(props) {
  return /*#__PURE__*/external_react_default.a.createElement(SVG_default.a, Icon_extends({
    hideDefaultTooltip: true,
...
var StyledHelp = external_styled_components_default.a.div.withConfig({
  ...
  enterprise: Object(external_styled_components_["css"])(["calc(", " * 1.5)"], themes_["variables"].spacing),
  ...
  _createClass(File, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          otherProps = File_objectWithoutProperties(_this$props3, ["accept", "allowMultiple", "children", "disabled", "dropAnywhere", "error", "fullscreen", "help", "name", "onRequestRemove", "onRequestRetry", "splunkTheme"]);
      ...
      var childrenCloned = external_react_["Children"].toArray(children).filter(external_react_["isValidElement"]).map(function (item, index) {
        ...
        if (onRequestRemove || onRequestRetry) {
        ...
        } // custom children have no onRequestRemove or onRequestRetry
      ...
      var fileTypes = Object(external_lodash_["isString"])(accept) && Object(external_lodash_["toUpper"])(accept.split(',').join(', '));
      return /*#__PURE__*/external_react_default.a.createElement(StyledDropTargetBox, File_extends({
        ...
        $fileCount: fileCount,
        "data-test": "file"
      }, Object(external_lodash_["omit"])(otherProps, 'onRequestAdd', 'onRequestRemove')), /*#__PURE__*/external_react_default.a.createElement(StyledTextBox, {
        $disabled: disabled,
        $dragOver: dragOver,
        $error: error
        ...
        type: "file"
      }), !disabled && Object(i18n_["_"])('browse...'))), isPrisma && !disabled && (accept ? /*#__PURE__*/external_react_default.a.createElement(StyledSubtitle, null, Object(i18n_["_"])("Supports ".concat(fileTypes))) : /*#__PURE__*/external_react_default.a.createElement(StyledSubtitle, null, Object(i18n_["_"])('Supports all file types')))), fullscreen && !disabled && /*#__PURE__*/external_react_default.a.createElement(StyledHelp, {
        "data-test": "help"
      ...
      }), dragOverNotDisabled && /*#__PURE__*/external_react_default.a.createElement(external_react_event_listener_default.a, {
