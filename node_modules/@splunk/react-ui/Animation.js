...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "Spring", function() { return /* reexport */ Spring; });
...
function Spring(_ref) {
  var children = _ref.children,
      ...
      otherProps = _objectWithoutProperties(_ref, ["children", "immediate"]);

  var animationToggle = Object(AnimationToggle_["useAnimationToggle"])();
  return children(Object(external_react_spring_["useSpring"])(_objectSpread({
    immediate: immediate || animationToggle !== 'on'
  }, otherProps)));
}
...
function Transition(_ref2) {
  var items = _ref2.items,
      ...
      otherProps = _objectWithoutProperties(_ref2, ["items", "children", "immediate"]);

  var animationToggle = Object(AnimationToggle_["useAnimationToggle"])();
  return Object(external_react_spring_["useTransition"])(items, _objectSpread({
    immediate: immediate || animationToggle !== 'on'
  }, otherProps))(children);
}
