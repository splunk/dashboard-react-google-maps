...
var Color_Color = /*#__PURE__*/function (_Component) {
  ...
  Color_createClass(Color, null, [{
    ...
    value: function hasTransparent(palette) {
      return palette.some(function (color) {
        return color !== null && Object(external_lodash_["toLower"])(color) === 'transparent';
      });
    }
  }]);
  ...
  function Color(props) {
    ...
    Color_defineProperty(Color_assertThisInitialized(_this), "handleRequestOpen", function () {
      ...
      var hidePalette = isPrisma ? Object(external_lodash_["slice"])(palette, 15) : palette;
      var isCustomColor = isPrisma && !Object(external_lodash_["includes"])(palette.map(function (c) {
        return c && Object(external_lodash_["toLower"])(c);
      }), value);
      var colorInHiddenPalette = isCustomColor || Object(external_lodash_["includes"])(hidePalette.map(function (c) {
        return c && Object(external_lodash_["toLower"])(c);
      }), value) || Object(external_lodash_["includes"])(toolPalette, value);
  ...
  Color_createClass(Color, [{
    ...
    value: function getValue() {
      var formatValueForProp = function formatValueForProp(value) {
        return value === null ? null : Object(external_lodash_["toLower"])(value);
      };
    ...
    value: function renderPalette() {
      ...
      if (isPrisma) {
        ...
        var swatchesDefaultDisplay = Object(external_lodash_["slice"])(swatches, 0, 15);
        var swatchesExpandDisplay = Object(external_lodash_["slice"])(swatches, 15);

        if (swatches.length === 8) {
          swatchesDefaultDisplay = Object(external_lodash_["slice"])(swatches, 0, 7);
          swatchesExpandDisplay = Object(external_lodash_["slice"])(swatches, 7);
        }
        ...
        return /*#__PURE__*/external_react_default.a.createElement("div", {
          ...
          "data-test": "tool-bar"
        }, /*#__PURE__*/external_react_default.a.createElement(SplunkThemeProvider_default.a, {
          density: "compact"
        }, this.renderInput({
          textAppend: false,
          textPrepend: false,
        ...
        }), isCustomColor && /*#__PURE__*/external_react_default.a.createElement(Check["a" /* default */], {
          role: "presentation",
          style: {
            color: '#d3d3d3',
            position: 'absolute',
        ...
        }, /*#__PURE__*/external_react_default.a.createElement(ChevronDown["a" /* default */], {
          prismaSize: "small"
        })));
      }
    ...
    value: function render() {
      ...
      var toggle = /*#__PURE__*/external_react_default.a.createElement(StyledToggleSwatch, Color_extends({
        ...
        prepend: prepend,
        value: value
      }, Object(external_lodash_["omit"])(otherProps, [].concat(_toConsumableArray(Object(external_lodash_["keys"])(Color.propTypes)), [// TS: trick omit
      'onChange']))));
