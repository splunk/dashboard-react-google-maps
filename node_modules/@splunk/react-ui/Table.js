...
var external_react_resize_detector_ = __webpack_require__(96);
...
var StyledTableCaption = external_styled_components_default.a.caption.withConfig({
  ...
  prisma: "5px 0"
}), themes_["variables"].fontSizeLarge, function (_ref) {
  var side = _ref.side;
  return side;
});
...
var SortedDown_ = __webpack_require__(98);
...
var SortedUp_ = __webpack_require__(99);
...
function SortedUp_Prisma24(_ref) {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(SVG["a" /* default */], SortedUp_extends({
    ...
    d: "M6.55135 11.6631C6.16082 12.0536 5.52766 12.0536 5.13713 11.6631C4.74661 11.2725 4.74661 10.6394 5.13713 10.2488L10.9396 4.44642C11.5253 3.86064 12.4751 3.86063 13.0609 4.44642L18.8633 10.2488C19.2538 10.6394 19.2538 11.2725 18.8633 11.6631C18.4728 12.0536 17.8396 12.0536 17.4491 11.6631L13 7.21397L13 19.0009C13 19.5532 12.5523 20.0009 12 20.0009C11.4477 20.0009 11 19.5532 11 19.0009V7.21441L6.55135 11.6631Z",
    fill: "currentColor"
  }));
}
...
function SortedUp_Prisma16(_ref2) {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(SVG["a" /* default */], SortedUp_extends({
    ...
    d: "M3.40737 9.39518L1.99316 7.98096L7.98834 1.98584L13.9855 7.98289L12.5713 9.39711L8.98828 5.81418L8.98828 13.98H6.98828L6.98828 5.81431L3.40737 9.39518Z",
    fill: "currentColor"
  }));
}
...
})(["flex:0 1 auto;position:relative;word-wrap:break-word;word-break:break-word;order:", ";", " ", " ", " ", " ", " + &{margin-left:", ";}"], Object(themes_["pick"])({
  enterprise: 1,
  prisma: 2
}), Object(themes_["pick"])({
...
})(["flex:0 0 auto;order:", ";", ";margin-top:-1px;", " color:", ";", " ", ""], Object(themes_["pick"])({
  enterprise: 2,
  prisma: 1
}), Object(themes_["pick"])({
...
function HeadInner(_ref) {
  ...
  var handleResizeKeyDown = function handleResizeKeyDown(e) {
    ...
    if (onRequestResize === undefined || width === undefined || index === undefined) {
      return;
    }
  ...
  return /*#__PURE__*/external_react_default.a.createElement(HeadInnerStyles_Styled, HeadInner_extends({
    ...
    $draggable: draggable,
    $dragging: !!isDragging
  }, Object(external_lodash_["omit"])(otherProps, [].concat(_toConsumableArray(Object.keys(HeadInner.propTypes)), ['id']))), isResizing && /*#__PURE__*/external_react_default.a.createElement(external_react_event_listener_default.a, {
    target: "window",
    ...
    $truncate: truncate,
    $fill: isMenu
  }, label, (isMenu || sortDir && isPrisma) && /*#__PURE__*/external_react_default.a.createElement(StyledMenuIcon, null, /*#__PURE__*/external_react_default.a.createElement(CaretDown["a" /* default */], {
    enterpriseSize: 0.5,
    prismaSize: "small" // this icon indicates both "has a menu" in all themes and "is sortable" in Prisma
    // so we need to avoid having the wrong screenReaderText when the column isn't sortable
    ,
    screenReaderText: sortDir === 'none' && isPrisma ? Object(i18n_["_"])('Click to sort') : undefined
  }))), sortDir && /*#__PURE__*/external_react_default.a.createElement(StyledSortIcon, {
    $sorted: sortDir !== 'none'
  }, sortDir === 'none' && !isPrisma &&
  /*#__PURE__*/
...
var Info_ = __webpack_require__(100);
  ...
  Row_createClass(Row, [{
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          actionPrimary = _this$props4.actionPrimary,
          ...
          movableColumns = _this$props4.movableColumns,
...
var Head_Head = /*#__PURE__*/function (_Component) {
  ...
  Head_createClass(Head, [{
    ...
    value: function getCellWidths() {
      ...
      return headRowCells.map(function (el) {
...
var Table_Table = /*#__PURE__*/function (_Component) {
  ...
  Table_createClass(Table, [{
    ...
    value: function render() {
      ...
      }, Object(external_lodash_["omit"])(this.props, [].concat(Table_toConsumableArray(Object.keys(Table.propTypes)), ['style']))), /*#__PURE__*/external_react_default.a.createElement(external_react_event_listener_default.a, {
        target: "window",
