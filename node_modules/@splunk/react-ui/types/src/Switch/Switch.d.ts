...
/** @public */
declare type SwitchClickHandler = (event: React.MouseEvent<HTMLButtonElement>, data: {
    selected: boolean;
    value?: any;
}) => void;
/** @public */
declare type SwitchCheckboxWithSomeClickHandler = (event: React.MouseEvent<HTMLButtonElement>, data: {
...
interface SwitchPropsBase {
    ...
    selected?: boolean | 'some';
    /**
     * The selectedLabel is shown in a tooltip and to screen readers.
     */
    selectedLabel?: string;
    /**
     * The someSelectedLabel is shown in a tooltip and to screen readers.
     */
    someSelectedLabel?: string;
    /**
     * The unselectedLabel is shown in a tooltip and to screen readers.
     */
...
declare const defaultProps: Required<Pick<SwitchPropsBase, 'appearance' | 'disabled' | 'error' | 'inline' | 'interactive' | 'selected' | 'selectedLabel' | 'someSelectedLabel' | 'unselectedLabel'>>;
...
declare type SwitchProps = ClassComponentProps<SwitchCheckboxWithSomePropsBase | SwitchNoSomePropsBase, typeof defaultProps, 'div'> & {
