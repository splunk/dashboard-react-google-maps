...
declare const defaultProps: Required<Pick<SelectPropsBase, 'animateLoading' | 'appearance' | 'append' | 'children' | 'defaultPlacement' | 'disabled' | 'error' | 'filter' | 'inline' | 'isLoadingOptions' | 'menuStyle' | 'noOptionsMessage' | 'placeholder' | 'prepend'>>;
