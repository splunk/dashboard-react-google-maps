...
function CaretRight_extends() { CaretRight_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return CaretRight_extends.apply(this, arguments); }
...
function Prisma24(_ref) {
  var otherProps = CaretRight_extends({}, _ref);

  return /*#__PURE__*/external_react_default.a.createElement(SVG["a" /* default */], CaretRight_extends({
    viewBox: "0 0 24 24"
...
function CaretRight(props) {
  return /*#__PURE__*/external_react_default.a.createElement(ThemedIcon["a" /* default */], CaretRight_extends({
    Enterprise: TriangleRightSmall_default.a,
    Prisma24: Prisma24
  }, props));
}
...
})(["", ";float:right;padding-left:", ";max-width:50%;text-align:right;box-sizing:border-box;"], itemDescription, themes_["variables"].spacing);
...
})(["position:absolute;", " color:", ";"], Object(themes_["pick"])({
  prisma: Object(external_styled_components_["css"])(["right:16px;"]),
  enterprise: Object(external_styled_components_["css"])(["top:5px;right:3px;left:8px;"])
}), Object(themes_["pick"])({
...
})(["flex:0 0 auto;padding-right:", ";min-width:10px;display:inline-block;text-align:center;vertical-align:", ";", ""], Object(themes_["pick"])({
  prisma: '8px',
  enterprise: '3px'
}), Object(themes_["pick"])({
  prisma: 'initial',
...
var StyledClickable = external_styled_components_default()(Clickable_default.a).withConfig({
  ...
  return $isSelectable && Object(themes_["pick"])({
    prisma: Object(external_styled_components_["css"])(["padding-right:44px;", ""], function () {
      return $selectableAppearance === 'checkbox' && 'padding-left: 42px;';
    }),
    enterprise: Object(external_styled_components_["css"])(["padding-right:10px;padding-left:", ";"], function () {
...
/* sc-sel */
StyledItemSelectedIcon, Object(themes_["pick"])({
  prisma: themes_["variables"].contentColorDisabled,
  ...
  return $selected && Object(themes_["pick"])({
    prisma: Object(external_styled_components_["css"])(["", "{color:", ";}"],
    /* sc-sel */
    StyledItemIcon, themes_["variables"].contentColorActive)
  });
});
...
})(["position:absolute;left:", ";top:", ";"], Object(themes_["pick"])({
  prisma: '16px',
  enterprise: '8px'
}), Object(themes_["pick"])({
  prisma: '0px',
...
})(["float:right;padding-left:", ";color:", ";"], themes_["variables"].spacingSmall, Object(themes_["pick"])({
  prisma: 'inherit',
  enterprise: themes_["variables"].textGray
}));
