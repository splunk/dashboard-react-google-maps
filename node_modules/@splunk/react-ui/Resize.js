...
var Resize_Resize = /*#__PURE__*/function (_Component) {
  ...
  function Resize(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyDown", function (e, dir) {
      ...
      var widthAdjust = (lastDir === 'e' || lastDir === 'w') && (key === 'right' || key === 'left') ? widthMap[lastDir][key] : 0;
      ...
      var heightAdjust = (firstDir === 'n' || firstDir === 's') && (key === 'up' || key === 'down') ? heightMap[firstDir][key] : 0;

      if ((widthAdjust || heightAdjust) && _this.state.el) {
        e.preventDefault();
        var _data = {
        ...
        _this.props.onRequestResize(e, _data);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "renderHandle", function (dir) {
  ...
  _createClass(Resize, [{
    ...
    value: function render() {
      ...
      }, el && beforeHandles, children, el && afterHandles, dragDirection && /*#__PURE__*/external_react_default.a.createElement(external_react_event_listener_default.a, {
        target: "window",
