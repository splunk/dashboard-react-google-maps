...
const getRelativeEarliest = (fromNumber, fromSnap, fromUnit) => {
  const earliestSnap = fromSnap ? "@".concat(fromUnit) : '';
  return "-".concat(fromNumber).concat(fromUnit).concat(earliestSnap);
};
/**
...
const getRelativeLatest = (fromUnit, toSnap) => {
  return toSnap ? "@".concat(fromUnit) : 'now';
};
/**
...
const getRealTimeEarliest = (fromNumber, fromUnit) => {
  return "rt-".concat(fromNumber).concat(fromUnit);
};
/**
