...
const getPresets = (0, _lodash.memoize)(() => fetch("".concat(timePath, "?output_mode=json&count=-1"), _fetch.defaultFetchInit).then((0, _fetch.handleResponse)(200)).then(data => data.entry.sort((a, b) => {
