...
var SetToken = /** @class */ (function () {
    ...
    // a token is valid if there is a non undefined value in it's payload[key]
    ...
    SetToken.prototype.getTokenValuesFromPayload = function (payload) {
        var tokenValuesMap = {};
        this.tokens.forEach(function (tokenOption) {
            tokenValuesMap[tokenOption.token] = payload[tokenOption.key];
        });
