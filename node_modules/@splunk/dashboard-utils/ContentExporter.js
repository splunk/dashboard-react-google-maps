...
var fetchExternalResources = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var response, responseBodyBlob, data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, exports.blobToDataUri(responseBodyBlob)];
            case 3:
                data = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                svgUri = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(exports.domNodeToSvg(svg, scaledWidth, scaledHeight));
                return [2 /*return*/, svgUri];
        }
    });
}); };
