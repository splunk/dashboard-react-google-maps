 ...
 * @param {*} tokenFilters
 */
export declare const replaceTokens: (value: string | null, tokens: PlainObject, tokenFilters?: Record<"n" | "s" | "u" | "h", (v: string) => string>) => string | null;
/**
 ...
 * @param {*} tokenFilters
 */
export declare const replaceTokensForObject: (value: string | PlainObject | unknown, tokens: PlainObject, tokenFilters?: Record<"n" | "s" | "u" | "h", (v: string) => string>, recursionLevel?: number) => string | PlainObject | unknown;
/**
