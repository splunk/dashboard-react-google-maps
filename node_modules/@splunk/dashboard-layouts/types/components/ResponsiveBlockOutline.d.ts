...
declare const ResponsiveBlockOutline: ({ itemId, scale, connectable, resizable, isBlockMoving, selected, onResize, onResized, onLineConnect, onLineDisconnect, handleDirections, x, y, w, h, }: ResponsiveBlockOutlineProps) => JSX.Element;
