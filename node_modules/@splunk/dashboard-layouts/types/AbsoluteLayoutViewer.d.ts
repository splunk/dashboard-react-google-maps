import type { SelectedItem, AbsoluteLayoutOptions, AbsoluteLayoutStructure } from '@splunk/dashboard-types';
...
declare const AbsoluteLayoutViewer: ({ containerWidth, layoutStructure, renderLayoutItem, options, }: AbsoluteLayoutViewerArgs) => JSX.Element;
export default AbsoluteLayoutViewer;
//# sourceMappingURL=AbsoluteLayoutViewer.d.ts.map