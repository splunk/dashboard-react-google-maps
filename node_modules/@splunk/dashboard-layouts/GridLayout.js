...
var isEqual_1 = __importDefault(__webpack_require__(54));
/**
...
var useMouseMoveHandler_1 = __importDefault(__webpack_require__(59));
...
var gridLayoutOptionsSchema_1 = __importDefault(__webpack_require__(55));
...
var renderBlockItems = memoize_one_1.default(function (_a) {
    var layoutStructure = _a.layoutStructure, renderLayoutItem = _a.renderLayoutItem, handleItemSelected = _a.handleItemSelected, isBlockItemMoving = _a.isBlockItemMoving, selectedItem = _a.selectedItem, mode = _a.mode, errors = _a.errors, padding = _a.padding;
    return layoutStructure.map(function (item) {
        ...
        return (react_1.default.createElement(MemoizedBlockItem, { key: key, itemId: key, selected: isSelected, x: paddedItem.position.x, y: paddedItem.position.y, h: paddedItem.position.h, w: paddedItem.position.w, renderLayoutItem: renderLayoutItem, onItemSelected: handleItemSelected, appearance: appearance, errorMessages: errorMessages }));
    });
}, isEqual_1.default);
var BaseGridLayout = function (_a) {
    var layoutApiRef = _a.layoutApiRef, onLayoutItemsSelect = _a.onLayoutItemsSelect, selectedLayoutItems = _a.selectedItems, layoutStructure = _a.layoutStructure, onLayoutStructureChange = _a.onLayoutStructureChange, _b = _a.options, options = _b === void 0 ? {} : _b, renderActionMenus = _a.renderActionMenus, renderLayoutItem = _a.renderLayoutItem, mode = _a.mode, showGrid = _a.showGrid, scale = _a.scale, canvasWidth = _a.canvasWidth;
    ...
    var _k = __read(react_1.useState(false), 2), isBlockItemResizing = _k[0], setIsBlockItemResizing = _k[1];
    var _l = __read(react_1.useState(edgeUtils_1.computeEdges({
        layout: layoutStructure,
        canvasWidth: canvasWidth,
        canvasHeight: layoutUtils_1.computeMaxHeight(layoutStructure),
    })), 2), edges = _l[0], setEdges = _l[1];
    var _m = __read(react_1.useState([]), 2), snappableEdges = _m[0], setSnappableEdges = _m[1];
    var _o = __read(react_1.useState(false), 2), scrollToBottom = _o[0], setScrollToBottom = _o[1];
    var _p = __read(react_1.useState(null), 2), mousePosition = _p[0], setMousePosition = _p[1];
    var _q = __read(react_1.useState(false), 2), isVizAdded = _q[0], setIsVizAdded = _q[1];
    var _r = __read(react_1.useState(null), 2), edgesBeforeMove = _r[0], setEdgesBeforeMove = _r[1];
    var _s = __read(react_1.useState(null), 2), invalidEdgeId = _s[0], setInvalidEdgeId = _s[1];
    var _t = __read(react_1.useState(null), 2), hoveredEdge = _t[0], setHoveredEdge = _t[1];
    var _u = __read(react_1.useState(null), 2), initialItemToMove = _u[0], setInitialItemToMove = _u[1];
    var _v = __read(react_1.useState(null), 2), hoveredBlock = _v[0], setHoveredBlock = _v[1];
    var _w = __read(react_1.useState(null), 2), hoveredQuadrant = _w[0], setHoveredQuadrant = _w[1];
    var _x = __read(react_1.useState(0), 2), setForceUpdate = _x[1];
    var _y = __read(react_1.useState([]), 2), selectedItemsForEdge = _y[0], setSelectedItemsForEdge = _y[1];
    var _z = __read(react_1.useState(false), 2), isInvalidVizDrop = _z[0], setIsInvalidVizDrop = _z[1];
    var _0 = __read(react_1.useState(true), 2), showPreviewPlaceholder = _0[0], setShowPreviewPlaceholder = _0[1];
    var _1 = __read(react_1.useState([]), 2), layoutErrors = _1[0], setLayoutErrors = _1[1];
    ...
    */
     ...
     * render action menus
     */
    var handleRenderActionMenus = react_1.useCallback(function () {
        // only render action menu for active item.
        if ((selectedLayoutItems === null || selectedLayoutItems === void 0 ? void 0 : selectedLayoutItems.length) === 1 &&
            firstSelectedItemStructure &&
            !isBlockItemMoving &&
            !isBlockItemResizing) {
            var paddedItem = edgeUtils_1.applyVizPadding({
            ...
            return (react_1.default.createElement(ActionMenus_1.default, { canvasWidth: canvasWidth, itemId: paddedItem.item, x: paddedItem.position.x, y: paddedItem.position.y, w: paddedItem.position.w, renderActionMenus: renderActionMenus }));
        }
        return null;
    }, [
        selectedLayoutItems,
    ...
    var renderOutline = function () {
        ...
        return blockItems.map(function (item) {
            ...
            if (displayOutline) {
                ...
                return (react_1.default.createElement(MemoizedBlockOutline, { handleDirections: HANDLE_DIRECTIONS, key: item.item, itemId: item.item, scale: mouseScale, x: paddedItem.position.x, y: paddedItem.position.y, w: paddedItem.position.w, h: paddedItem.position.h, isBlockMoving: isBlockItemMoving }));
            }
...
var isEmpty_1 = __importDefault(__webpack_require__(25));
var i18n_1 = __webpack_require__(27);
var gridLayoutApiUtils_1 = __webpack_require__(60);
var layoutUtils_1 = __webpack_require__(2);
var GridLayoutConstants_1 = __webpack_require__(26);
/**
