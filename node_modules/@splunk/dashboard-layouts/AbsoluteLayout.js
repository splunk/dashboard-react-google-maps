...
var customThemeVariables_1 = __webpack_require__(8);
...
// TODO: transform animation results in very low performance in edge drag scenarios
var getTransition = function (shouldHaveTransition) {
    return "transition: " + (shouldHaveTransition ? 'transform 0.5s,' : '') + " opacity 0.4s;";
};
var Box = styled_components_1.default.div.attrs(function (_a) {
    ...
    ";\n    /* ", "; */\n    visibility: ",
    ";\n    opacity: ", ";\n"])), function (props) { return (props.borderType !== 'none' ? '3px' : 0); }, themes_1.pickVariant('borderType', {
    none: '',
    hover: {
        enterprise: mixins_1.colorWithAlpha(themes_1.variables.accentColorL10, 0.7),
        prisma: mixins_1.colorWithAlpha(themes_1.variables.interactiveColorPrimary, 0.7),
    },
    select: {
        enterprise: mixins_1.colorWithAlpha(themes_1.variables.accentColorL10, 0.7),
        prisma: mixins_1.colorWithAlpha(themes_1.variables.interactiveColorPrimary, 0.7),
    },
    move: mixins_1.colorWithAlpha('#08E045', 0.7),
}), function (props) { return getTransition(props.selected === false); }, function (props) {
    return props.appearance === 'hidden' ? 'hidden' : 'visible';
}, function (props) { return (props.appearance === 'highlighted' ? 1 : 0.5); });
var ResponsiveBox = function (_a) {
    var _b = _a.borderType, borderType = _b === void 0 ? 'none' : _b, selected = _a.selected, _c = _a.appearance, appearance = _c === void 0 ? 'highlighted' : _c, children = _a.children, rest = __rest(_a, ["borderType", "selected", "appearance", "children"]);
    return (react_1.default.createElement(Box, __assign({ borderType: borderType, selected: selected, appearance: appearance }, rest), children));
};
...
var ResponsiveBlockItem = function (props) {
    var x = props.x, y = props.y, w = props.w, h = props.h, itemId = props.itemId, selected = props.selected, errorMessages = props.errorMessages, onItemSelected = props.onItemSelected, renderLayoutItem = props.renderLayoutItem, _a = props.appearance, appearance = _a === void 0 ? 'highlighted' : _a;
    var layoutItem = react_1.useMemo(function () {
        return renderLayoutItem(itemId, {
            width: w,
            height: h,
        }, 'block', onItemSelected);
    }, [w, h, itemId, onItemSelected, renderLayoutItem]);
    return (react_1.default.createElement(ResponsiveBox_1.default, { "data-test": "absolute-item", itemId: itemId, borderType: "none", selected: selected, appearance: appearance, x: x, y: y, w: w, h: h },
        layoutItem,
...
var react_1 = __importDefault(__webpack_require__(0));
var styled_components_1 = __importDefault(__webpack_require__(1));
var prop_types_1 = __importDefault(__webpack_require__(4));
var themes_1 = __webpack_require__(3);
...
var ResponsiveBlockOutline = function (_a) {
    var itemId = _a.itemId, _b = _a.scale, scale = _b === void 0 ? 1 : _b, _c = _a.connectable, connectable = _c === void 0 ? false : _c, _d = _a.resizable, resizable = _d === void 0 ? false : _d, _e = _a.isBlockMoving, isBlockMoving = _e === void 0 ? false : _e, _f = _a.selected, selected = _f === void 0 ? false : _f, _g = _a.onResize, onResize = _g === void 0 ? noop : _g, _h = _a.onResized, onResized = _h === void 0 ? noop : _h, _j = _a.onLineConnect, onLineConnect = _j === void 0 ? noop : _j, _k = _a.onLineDisconnect, onLineDisconnect = _k === void 0 ? noop : _k, handleDirections = _a.handleDirections, x = _a.x, y = _a.y, w = _a.w, h = _a.h;
    var _l = __read(react_1.useState(null), 2), startPosition = _l[0], setStartPosition = _l[1];
    var _m = __read(react_1.useState(false), 2), resizing = _m[0], setResizing = _m[1];
    var _o = __read(react_1.useState(null), 2), resizeDir = _o[0], setResizeDir = _o[1];
    ...
    var borderType = connectable ? 'none' : 'select';
    borderType = !connectable && isBlockMoving ? 'move' : borderType;
    return (react_1.default.createElement(ResponsiveBox_1.default, { "data-test": "select-outline", itemId: itemId, borderType: borderType, selected: selected, x: x, y: y, w: w, h: h },
        ResizeHandles,
        Ports));
};
...
var outerXPadding = 4;
var innerYPadding = 4;
var ActionMenuContainer = styled_components_1.default.div.attrs(function (_a) {
    var itemId = _a.itemId, x = _a.x, y = _a.y;
    return ({
        'data-id': itemId,
...
})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    display: flex;\n    flex-direction: column;\n    position: absolute;\n    background-color: ", ";\n    box-sizing: border-box;\n    pointer-events: auto;\n    border: 1px solid\n        ", ";\n    color: ", ";\n    border-radius: 2px;\n    & > div[data-test='action-item']:hover {\n        background-color: ", ";\n    }\n"], ["\n    display: flex;\n    flex-direction: column;\n    position: absolute;\n    background-color: ", ";\n    box-sizing: border-box;\n    pointer-events: auto;\n    border: 1px solid\n        ",
    ";\n    color: ", ";\n    border-radius: 2px;\n    & > div[data-test='action-item']:hover {\n        background-color: ",
    ";\n    }\n"])), themes_1.variables.backgroundColorPage, themes_1.pick({
    enterprise: themes_1.variables.accentColorL10,
    prisma: themes_1.variables.interactiveColorPrimary,
}), themes_1.variables.contentColorActive, themes_1.pick({
    enterprise: themes_1.variables.backgroundColorHover,
    prisma: themes_1.variables.backgroundColorDialog,
}));
var defaultRenderActionMenus = function () { return []; };
/**
 * Positional container for contextual action menus
 */
var ActionMenus = function (_a) {
    var canvasWidth = _a.canvasWidth, itemId = _a.itemId, _b = _a.renderActionMenus, renderActionMenus = _b === void 0 ? defaultRenderActionMenus : _b, x = _a.x, y = _a.y, w = _a.w;
    var menus = react_1.useMemo(function () { return renderActionMenus(itemId); }, [
        itemId,
        renderActionMenus,
    ]);
    var _c = react_1.useMemo(function () {
        var calcX = x + w + outerXPadding;
        var calcY = y;
        if (calcX + menuWidth > canvasWidth) {
            calcX = x + w - menuWidth - innerXPadding;
            calcY += innerYPadding;
        }
        return { calcX: calcX, calcY: calcY };
    }, [canvasWidth, x, y, w]), menuX = _c.calcX, menuY = _c.calcY;
    if (!Array.isArray(menus) || !menus.length) {
        return null;
    }
    return (react_1.default.createElement(ActionMenuContainer, { itemId: itemId, x: menuX, y: menuY }, menus));
};
exports.default = ActionMenus;
var templateObject_1;
...
Object.defineProperty(exports, "__esModule", { value: true });
var namedColors_1 = __importDefault(__webpack_require__(52));
...
Object.defineProperty(exports, "__esModule", { value: true });
var noop_1 = __importDefault(__webpack_require__(16));
var rxjs_1 = __webpack_require__(62);
var react_1 = __importStar(__webpack_require__(0));
...
var AbsoluteLayoutApi_1 = __importDefault(__webpack_require__(63));
var AbsoluteCanvas_1 = __importDefault(__webpack_require__(64));
...
var ActionMenus_1 = __importDefault(__webpack_require__(50));
var absoluteLayoutUtils_1 = __webpack_require__(67);
var absoluteLayoutOptionsSchema_1 = __importDefault(__webpack_require__(51));
var GRID_SIZE = 10;
var GRID_PADDING = 1;
...
var AbsoluteLayout = function (props) {
    var _a = props.mode, mode = _a === void 0 ? 'view' : _a, _b = props.showGrid, showGrid = _b === void 0 ? true : _b, _c = props.options, _d = _c === void 0 ? {} : _c, _e = _d.width, width = _e === void 0 ? DefaultOptions_1.absoluteLayoutOptions.width : _e, _f = _d.height, height = _f === void 0 ? DefaultOptions_1.absoluteLayoutOptions.height : _f, _g = _d.display, display = _g === void 0 ? DefaultOptions_1.absoluteLayoutOptions.display : _g, backgroundColor = _d.backgroundColor, backgroundImage = _d.backgroundImage, _h = props.layoutStructure, layoutStructure = _h === void 0 ? [] : _h, containerWidth = props.containerWidth, _j = props.selectedItems, selectedItems = _j === void 0 ? emptySelectedItems : _j, renderLayoutItem = props.renderLayoutItem, _k = props.renderActionMenus, renderActionMenus = _k === void 0 ? function () { return []; } : _k, _l = props.onLayoutItemsSelect, onLayoutItemsSelect = _l === void 0 ? noop_1.default : _l, _m = props.onLayoutStructureChange, onLayoutStructureChange = _m === void 0 ? noop_1.default : _m, _o = props.layoutApiRef, layoutApiRef = _o === void 0 ? noop_1.default : _o;
    var _p = __read(react_1.useState(false), 2), isBlockItemMoving = _p[0], setIsBlockItemMoving = _p[1];
    var _q = __read(react_1.useState(false), 2), isBlockItemResizing = _q[0], setIsBlockItemResizing = _q[1];
    var _r = __read(react_1.useState(null), 2), activeLine = _r[0], setActiveLine = _r[1];
    var _s = __read(react_1.useState(1), 2), scale = _s[0], setScaleInternal = _s[1];
    var _t = __read(react_1.useState(false), 2), fitToWidth = _t[0], setFitToWidth = _t[1];
    var _u = __read(react_1.useReducer(absoluteLayoutUtils_1.reducer, layoutStructure, absoluteLayoutUtils_1.initializeLayoutStructureState), 2), layoutStructureState = _u[0], dispatch = _u[1];
    ...
    var _v = react_1.useContext(dashboard_context_1.DashboardContext), keyboardListener = _v.keyboardListener, _w = _v.featureFlags, featureFlags = _w === void 0 ? {} : _w;
    ...
    var handleBlockItemResize = react_1.useCallback(function (e, itemId, offset, dir) {
        ...
        setIsBlockItemResizing(true);
    }, [layoutStructure]);
    var handleBlockItemResized = react_1.useCallback(function () {
        setIsBlockItemResizing(false);
        handleLayoutStructureChange();
    }, [handleLayoutStructureChange]);
    ...
    var blockItemElements = react_1.useMemo(function () {
        return blockUtils_1.getAllBlockItems({
            ...
            return (react_1.default.createElement(ResponsiveBlockItem_1.default, { key: item, itemId: item, x: x, y: y, w: w, h: h, renderLayoutItem: renderLayoutItem, onItemSelected: handleItemSelected }));
        });
    }, [
        handleItemSelected,
        layoutStructure,
    ...
    var outlineElements = react_1.useMemo(function () {
        ...
        return allBlockItems.map(function (block) {
            ...
            return (react_1.default.createElement(ResponsiveBlockOutline_1.default, { key: block.item, itemId: block.item, x: block.position.x, y: block.position.y, w: block.position.w, h: block.position.h, scale: scale, connectable: connectable, resizable: resizable, 
                // It is interesting that previous implementation did not pass selected and isBlockMoving props.
                // `isBlockMoving` affects whether the outline becomes green; `selected` affects whether the box has opacity transition.
                selected: selected, 
                // isBlockMoving={isBlockItemMoving}
                onResize: handleBlockItemResize, onResized: handleBlockItemResized, onLineConnect: handleLineConnected, onLineDisconnect: handleLineDisconnected }));
        });
    }, [
        activeLine,
    ...
    var actionMenusElement = react_1.useMemo(function () {
        var selectedBlockItems = blockUtils_1.findSelectedBlockItems({
            layoutStructure: Object.values(layoutStructureState),
            selectedItems: selectedItems,
        });
        if (selectedBlockItems.length !== 1 ||
            isBlockItemMoving ||
            isBlockItemResizing) {
            return null;
        }
        var _a = selectedBlockItems[0], item = _a.item, position = _a.position;
        return (react_1.default.createElement(ActionMenus_1.default, { canvasWidth: width, itemId: item, x: position.x, y: position.y, w: position.w, renderActionMenus: renderActionMenus }));
    }, [
        isBlockItemMoving,
        isBlockItemResizing,
        layoutStructureState,
    ...
    return (react_1.default.createElement(AbsoluteCanvas_1.default, __assign({ "data-test": "absolute-layout", blockItems: blockItems, width: width, height: height, scale: scale, 
        ...
        gridWidth: GRID_SIZE - 1, gridHeight: GRID_SIZE - 1, backgroundColor: backgroundColor, backgroundImageSrc: image.src, backgroundImageSizeType: image.sizeType, backgroundImageWidth: image.w, backgroundImageHeight: image.h, backgroundImagePositionX: image.x, backgroundImagePositionY: image.y, selectable: true, selectedLayoutItems: selectedItems, onItemSelected: handleItemSelected, ref: canvasRef }, modeSpecificProps),
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importStar(__webpack_require__(0));
var uniqBy_1 = __importDefault(__webpack_require__(65));
var noop_1 = __importDefault(__webpack_require__(16));
...
var AbsoluteCanvas = function (props) {
    var scale = props.scale, children = props.children, canvasRef = props.canvasRef, blockItems = props.blockItems, _a = props.onItemMove, onItemMove = _a === void 0 ? noop_1.default : _a, _b = props.onItemMoved, onItemMoved = _b === void 0 ? noop_1.default : _b, onItemSelected = props.onItemSelected, _c = props.movable, movable = _c === void 0 ? false : _c, _d = props.selectable, selectable = _d === void 0 ? false : _d, _e = props.selectedLayoutItems, selectedLayoutItems = _e === void 0 ? DEFAULT_SELECTED_LAYOUT_ITEMS : _e, _f = props.initialState, initialState = _f === void 0 ? defaultState : _f, canvasProps = __rest(props, ["scale", "children", "canvasRef", "blockItems", "onItemMove", "onItemMoved", "onItemSelected", "movable", "selectable", "selectedLayoutItems", "initialState"]);
    // State management
    var _g = __read(react_1.useState(initialState.startPosition), 2), startPosition = _g[0], setStartPosition = _g[1];
    var _h = __read(react_1.useState(initialState.currentPosition), 2), currentPosition = _h[0], setCurrentPosition = _h[1];
    var _j = __read(react_1.useState(initialState.isMoving), 2), isMoving = _j[0], setIsMoving = _j[1];
    var _k = __read(react_1.useState(initialState.isSelecting), 2), isSelecting = _k[0], setIsSelecting = _k[1];
    ...
    var handleMouseMove = useEventCallback_1.default(function (e) {
        if (startPosition) {
            ...
            if (newPosition) {
                ...
                // we don't need to check `isSelecting` flag as it will always be true in this case
        ...
        if (startPosition) {
            ...
            if (curPosition) {
                ...
                if (isMoving && layoutUtils_1.considerMoved(offset)) {
                    ...
                    // todo handle multiple select for line?
                    if (layoutUtils_1.considerMoved(offset)) {
                        // multi select
                        handleItemSelected(e, selectedBlocks);
                    }
                    else {
                        // select single item
    ...
    var handleMouseDown = useEventCallback_1.default(function (e) {
        ...
        // always track start position and perform selecting
        if (selectable) {
    ...
    var selectBox = react_1.useMemo(function () {
        if (isSelecting && !isMoving && startPosition && currentPosition) {
            return react_1.default.createElement(SelectBox_1.default, { start: startPosition, end: currentPosition });
        }
        return null;
    }, [isSelecting, isMoving, startPosition, currentPosition]);
