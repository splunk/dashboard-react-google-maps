...
var TextEditor = function (_a) {
    var initialValue = _a.value, _b = _a.onValueChange, onValueChange = _b === void 0 ? noop : _b, uniqKey = _a.uniqKey, _c = _a["data-test"], dataTest = _c === void 0 ? 'text-editor' : _c, defaultValue = _a.defaultValue, _d = _a.canClear, canClear = _d === void 0 ? true : _d, id = _a.id, otherProps = __rest(_a, ["value", "onValueChange", "uniqKey", 'data-test', "defaultValue", "canClear", "id"]);
    var _e = useTextInput_1.useTextInput({
        initialValue: initialValue,
        handleCommit: function (val) { return onValueChange(val); },
        uniqKey: uniqKey,
        defaultValue: defaultValue,
    }), onHandleBlur = _e.onHandleBlur, onHandleChange = _e.onHandleChange, onHandleKeyDown = _e.onHandleKeyDown, value = _e.value;
    return (react_1.default.createElement(Text_1.default, __assign({}, otherProps, { canClear: canClear, value: value, onBlur: onHandleBlur, onChange: onHandleChange, onKeyDown: onHandleKeyDown, "data-test": dataTest, inputId: id })));
};
