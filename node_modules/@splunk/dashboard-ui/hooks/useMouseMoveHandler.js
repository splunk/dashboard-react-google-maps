 ...
 */
var useMouseMoveHandler = function (_a) {
    var onMouseMove = _a.onMouseMove, _b = _a.isEnabled, isEnabled = _b === void 0 ? true : _b, throttledMs = _a.throttledMs;
    react_1.useEffect(function () {
        if (!isEnabled) {
            return undefined;
        }
        var throttledCallback;
        if (throttledMs) {
            throttledCallback = lodash_1.throttle(onMouseMove, throttledMs, {
                trailing: false,
            });
...
exports.default = useMouseMoveHandler;


/***/ })
/******/ ]);
//# sourceMappingURL=useMouseMoveHandler.js.map