...
var ErrorBoundary = /** @class */ (function (_super) {
    ...
    ErrorBoundary.prototype.render = function () {
        var _a = this.props, children = _a.children, customErrorMessage = _a.errorMessage, useMessageFromError = _a.useMessageFromError, customRender = _a.render;
        var _b = this.state, hasError = _b.hasError, errorMessage = _b.errorMessage;
        if (hasError) {
            return customRender(useMessageFromError && errorMessage
                ? errorMessage
                : customErrorMessage);
        }
        return children;
...
ErrorBoundary.defaultProps = {
    errorMessage: i18n_1._('failed to render react component'),
    render: function (errorMessage) { return react_1.default.createElement("div", null, errorMessage); },
...
ErrorBoundary.propTypes = {
    ...
    useMessageFromError: prop_types_1.default.bool,
};
