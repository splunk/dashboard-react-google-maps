...
var prop_types_1 = __importDefault(__webpack_require__(2));
var styled_components_1 = __importDefault(__webpack_require__(1));
var dashboard_icons_1 = __webpack_require__(29);
var riskyCommandUtils_1 = __webpack_require__(25);
var Clickable_1 = __importDefault(__webpack_require__(68));
var themes_1 = __webpack_require__(4);
var OptionalTooltip_1 = __importDefault(__webpack_require__(69));
var RiskyWarningPopover_1 = __importDefault(__webpack_require__(36));
var StatusIconContainer = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    height: ", "px;\n    width: ", "px;\n    // padding to increase the hover area on the icon to show tooltip\n    padding: 0 12px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    svg {\n        height: ", "px;\n        width: ", "px;\n    }\n\n    // Increase SVG size when this component is hovered over\n    &:hover svg {\n        height: ", "px;\n        width: ", "px;\n    }\n"], ["\n    height: ", "px;\n    width: ", "px;\n    // padding to increase the hover area on the icon to show tooltip\n    padding: 0 12px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    svg {\n        height: ", "px;\n        width: ", "px;\n    }\n\n    // Increase SVG size when this component is hovered over\n    &:hover svg {\n        height: ", "px;\n        width: ", "px;\n    }\n"])), function (props) { return props.height; }, function (props) { return props.width; }, function (props) { return props.iconSize; }, function (props) { return props.iconSize; }, function (props) { return props.iconSizeOnHover; }, function (props) { return props.iconSizeOnHover; });
var StatusIconWrapper = styled_components_1.default(Clickable_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    // the child svg icon has an attribute 'currentColor' that will inherit this 'color' property.\n    color: ", ";\n    cursor: ", ";\n"], ["\n    // the child svg icon has an attribute 'currentColor' that will inherit this 'color' property.\n    color: ", ";\n    cursor: ", ";\n"])), function (props) { return themes_1.variables[props.colorKey]; }, function (props) { return (props.showCursor ? 'pointer' : 'auto'); });
/**
 * map that containts:
 * [status]: {
...
var statusMap = {
    error: {
        component: dashboard_icons_1.StatusError,
        statusColorKey: 'statusColorHigh',
    },
    info: { component: dashboard_icons_1.StatusInfo, statusColorKey: 'statusColorMedium' },
    ok: { component: dashboard_icons_1.StatusOk, statusColorKey: 'statusColorInfo' },
    warning: {
        component: dashboard_icons_1.StatusWarning,
        statusColorKey: 'statusColorMedium',
    },
};
var StatusIconPlaceholder = styled_components_1.default.div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    width: ", "px;\n"], ["\n    width: ", "px;\n"])), function (props) { return props.width + 24; });
var handleMouseDown = function (e) {
    e.stopPropagation();
};
/**
 * Component to display the status of a Splunk Search.
 */
var SearchStatusIcon = function (_a) {
    var height = _a.height, message = _a.message, status = _a.status, search = _a.search, id = _a.id, iconSize = _a.iconSize, iconSizeOnHover = _a.iconSizeOnHover;
    if (!status) {
        /**
         * Intentionally have status as an optional parameter as we do not want to render an icon in either of the scenarios:
         * - partial search data has been returned
         * - total search data has been returned
         */
        return react_1.default.createElement(StatusIconPlaceholder, { width: iconSizeOnHover });
    }
    var StatusIcon = statusMap[status].component;
    var colorKey = statusMap[status].statusColorKey;
    var isRiskyCommand = riskyCommandUtils_1.isRiskyCommandError(message);
    var tooltipMessage = isRiskyCommand
        ? riskyCommandUtils_1.formatRiskyCommandErrorMessage(message)
        : message;
    var searchStatusIcon = (react_1.default.createElement(StatusIconWrapper, { colorKey: colorKey, showCursor: isRiskyCommand, tabIndex: isRiskyCommand ? 0 : -1 },
        react_1.default.createElement(StatusIcon, { hideDefaultTooltip: true })));
    return (react_1.default.createElement(OptionalTooltip_1.default, { message: tooltipMessage },
        react_1.default.createElement(StatusIconContainer, { height: height, width: iconSizeOnHover, iconSize: iconSize, iconSizeOnHover: iconSizeOnHover, onMouseDown: isRiskyCommand ? handleMouseDown : undefined, "data-test": "search-status-icon-container" }, isRiskyCommand ? (react_1.default.createElement(RiskyWarningPopover_1.default, { statusIcon: searchStatusIcon, riskySearch: search, id: id, message: message })) : (searchStatusIcon))));
};
SearchStatusIcon.propTypes = {
    /**
     * Splunk search status. This value maps to a respective status icon.
     */
    status: prop_types_1.default.oneOf(Object.keys(statusMap)),
    /**
     * Message that will be displayed on hover of the status icon.
     */
    ...
    /**
     * Icon size when hovered upon.
     */
    iconSizeOnHover: prop_types_1.default.number,
    /**
     * Height of container surrounding icon
     */
...
exports.default = react_1.default.memo(SearchStatusIcon);
...
var react_1 = __importDefault(__webpack_require__(0));
var prop_types_1 = __importDefault(__webpack_require__(2));
var Tooltip_1 = __importDefault(__webpack_require__(28));
// css prop line-height needs to be zero to prevent Tooltip from adding un-necessary height.
var tooltipStyle = { lineHeight: 0 };
/**
 * Component for tooltip that is a middle layer between it's children.
 */
var OptionalTooltip = function (_a) {
    var _b = _a.children, children = _b === void 0 ? null : _b, message = _a.message;
    if (!message) {
        return children;
    }
    return (react_1.default.createElement(Tooltip_1.default, { content: message, defaultPlacement: "below", style: tooltipStyle }, children));
};
OptionalTooltip.propTypes = {
    children: prop_types_1.default.node,
    message: prop_types_1.default.string,
};
exports.default = OptionalTooltip;


/***/ })
/******/ ]);
//# sourceMappingURL=SearchStatusIcon.js.map