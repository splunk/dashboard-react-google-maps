...
Object.defineProperty(exports, "__esModule", { value: true });
var isFunction_1 = __importDefault(__webpack_require__(68));
var react_1 = __importStar(__webpack_require__(0));
var prop_types_1 = __importDefault(__webpack_require__(2));
var resize_observer_polyfill_1 = __importDefault(__webpack_require__(69));
var styles = {
    position: 'absolute',
    width: 0,
    height: 0,
...
var SizeAwareWrapper = /** @class */ (function (_super) {
    __extends(SizeAwareWrapper, _super);
    function SizeAwareWrapper(props) {
        ...
        _this.renderChildren = function () {
            ...
            if (width != null && height != null && isFunction_1.default(children)) {
    ...
    SizeAwareWrapper.prototype.componentDidMount = function () {
        var resizableElement = this.getElement();
        if (resizableElement) {
            this.ro.observe(resizableElement);
        }
    };
    SizeAwareWrapper.prototype.componentWillUnmount = function () {
        var resizableElement = this.getElement();
        if (resizableElement) {
    ...
    SizeAwareWrapper.prototype.render = function () {
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("div", { key: "resize-detector", style: styles, ref: this.handleRef }),
            this.renderChildren()));
    };
...
exports.default = SizeAwareWrapper;
