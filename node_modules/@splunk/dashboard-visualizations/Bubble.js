...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "BubbleComponent", function() { return /* binding */ Bubble_BubbleComponent; });
...
// EXTERNAL MODULE: external "@splunk/react-visualizations/Bubble"
var Bubble_ = __webpack_require__(98);
var Bubble_default = /*#__PURE__*/__webpack_require__.n(Bubble_);

// EXTERNAL MODULE: external "@splunk/visualization-encoding-parsers/BubbleParser"
var BubbleParser_ = __webpack_require__(87);
...
// CONCATENATED MODULE: ./src/visualizations/Bubble/editorConfig.js


var editorConfig = [Axes["a" /* default */], Legend["a" /* default */]];
/* harmony default export */ var Bubble_editorConfig = (editorConfig);
// CONCATENATED MODULE: ./src/visualizations/Bubble/Bubble.jsx
...
var Bubble_BubbleComponent = /*#__PURE__*/function (_Component) {
  inherits_default()(BubbleComponent, _Component);

  var _super = _createSuper(BubbleComponent);

  function BubbleComponent() {
    classCallCheck_default()(this, BubbleComponent);

    return _super.apply(this, arguments);
  }

  createClass_default()(BubbleComponent, [{
    key: "render",
    value: function render() {
      ...
      var dataProps = Object(BubbleParser_["parse"])(dataSources, encoding); // todo: may need merge the truncateParsedData function with parse

      var truncationLimit = options && options['chart.resultTruncationLimit'];
      dataProps = Object(dataUtils_["truncateParsedData"])(dataProps, truncationLimit);
      ...
      return /*#__PURE__*/external_react_default.a.createElement(Bubble_default.a, extends_default()({
        width: width,
        height: height,
        style: style,
        themeKey: themeKey,
        ...
        size: dataProps.size,
        xFieldName: dataProps.xFieldName,
        yFieldName: dataProps.yFieldName,
        categoryFieldName: dataProps.categoryFieldName,
        sizeFieldName: dataProps.sizeFieldName,
        onPointClick: onPointClick,
        onLegendClick: onLegendClick
      }, Object(simpleXMLOptions_["getPropsForSimpleXMLOptions"])(options)));
    }
  }]);
...
defineProperty_default()(Bubble_BubbleComponent, "propTypes", BaseVisualization_default.a.propTypes);

defineProperty_default()(Bubble_BubbleComponent, "defaultProps", _objectSpread(_objectSpread({}, BaseVisualization_default.a.defaultProps), {}, {
  height: 250
}));

defineProperty_default()(Bubble_BubbleComponent, "dataContract", BubbleParser_["dataContract"]);

defineProperty_default()(Bubble_BubbleComponent, "vizContract", {
  initialDimension: {
    width: 300,
    height: 300
  }
...
defineProperty_default()(Bubble_BubbleComponent, "schema", optionsSchema);

defineProperty_default()(Bubble_BubbleComponent, "editor", Bubble_editorConfig);

/* harmony default export */ var Bubble = __webpack_exports__["default"] = (Object(enhancer_["withVisualizationAndThemeHOCs"])({
  ...
  placeholder: /*#__PURE__*/external_react_default.a.createElement(IconPlaceholder_default.a, {
    icon: /*#__PURE__*/external_react_default.a.createElement(visualization_icons_["Bubble"], null)
  })
})(Bubble_BubbleComponent));
...
module.exports = require("@splunk/visualization-encoding-parsers/BubbleParser");
...
module.exports = require("@splunk/react-visualizations/Bubble");
