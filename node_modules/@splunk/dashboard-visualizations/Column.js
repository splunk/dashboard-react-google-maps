...
module.exports = require("@splunk/visualization-encoding-parsers/ColumnParser");
...
module.exports = require("@splunk/react-visualizations/Column");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "ColumnComponent", function() { return /* binding */ Column_ColumnComponent; });
...
// EXTERNAL MODULE: external "@splunk/react-visualizations/Column"
var Column_ = __webpack_require__(99);
var Column_default = /*#__PURE__*/__webpack_require__.n(Column_);

// EXTERNAL MODULE: external "@splunk/visualization-encoding-parsers/ColumnParser"
var ColumnParser_ = __webpack_require__(88);
...
// CONCATENATED MODULE: ./src/visualizations/Column/editorConfig.js
...
/* harmony default export */ var Column_editorConfig = (editorConfig);
// CONCATENATED MODULE: ./src/visualizations/Column/Column.jsx
...
var Column_ColumnComponent = /*#__PURE__*/function (_Component) {
  inherits_default()(ColumnComponent, _Component);

  var _super = _createSuper(ColumnComponent);

  function ColumnComponent() {
    classCallCheck_default()(this, ColumnComponent);

    return _super.apply(this, arguments);
  }

  createClass_default()(ColumnComponent, [{
    key: "render",
    value: function render() {
      ...
      var columnProps = Object(ColumnParser_["parse"])(dataSources, encoding); // todo: may need merge the truncateParsedData function with parse

      var truncationLimit = options && options['chart.resultTruncationLimit'];
      columnProps = Object(dataUtils_["truncateParsedData"])(columnProps, truncationLimit);
      ...
      return /*#__PURE__*/external_react_default.a.createElement(Column_default.a, extends_default()({
        width: width,
        height: height,
        style: style,
        themeKey: themeKey,
...
defineProperty_default()(Column_ColumnComponent, "propTypes", BaseVisualization_default.a.propTypes);

defineProperty_default()(Column_ColumnComponent, "defaultProps", _objectSpread(_objectSpread({}, BaseVisualization_default.a.defaultProps), {}, {
  height: 250
}));

defineProperty_default()(Column_ColumnComponent, "dataContract", ColumnParser_["dataContract"]);

defineProperty_default()(Column_ColumnComponent, "vizContract", {
  initialDimension: {
    width: 300,
    height: 300
  }
...
defineProperty_default()(Column_ColumnComponent, "schema", optionsSchema);

defineProperty_default()(Column_ColumnComponent, "editor", Column_editorConfig);

/* harmony default export */ var Column = __webpack_exports__["default"] = (Object(enhancer_["withVisualizationAndThemeHOCs"])({
  ...
  placeholder: /*#__PURE__*/external_react_default.a.createElement(IconPlaceholder_default.a, {
    icon: /*#__PURE__*/external_react_default.a.createElement(visualization_icons_["Column"], null)
  })
})(Column_ColumnComponent));
