...
/* harmony default export */ __webpack_exports__["default"] = ({
  encoding: [{
    ...
    name: 'size',
    type: '[number]',
    desc: 'Specify the dataSource that is represented by the bubble size in the chart.',
    defaultValue: 'primary[2]',
    isRequired: 'true'
  }, {
    name: 'category',
    type: '[string]',
    desc: 'Specify the dataSource that is represented by the category color schemes.',
    defaultValue: 'primary[3]',
    isRequired: 'false'
  }],
  events: []
});
