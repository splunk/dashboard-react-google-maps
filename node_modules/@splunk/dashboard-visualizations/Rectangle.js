...
var isEmpty_ = __webpack_require__(28);
...
// EXTERNAL MODULE: external "@splunk/visualization-encoding-parsers/ShapeParser"
var ShapeParser_ = __webpack_require__(70);

// EXTERNAL MODULE: external "@splunk/visualizations/common/shapeUtils"
var shapeUtils_ = __webpack_require__(76);
...
// CONCATENATED MODULE: ./src/visualizations/Rectangle/optionsSchema.js
...
/* harmony default export */ var optionsSchema = ({
  ...
  strokeLinejoin: {
    default: 'miter',
    description: 'Specifies the shape to be used at the corners of paths when they are joined (arcs | bevel | miter | miter-clip | round)',
    type: 'string'
  }
});
...
var variables_ = __webpack_require__(4);
...
// CONCATENATED MODULE: ./src/visualizations/Rectangle/editorConfig.js




var editorConfig = [{
  label: Object(i18n_["_"])('Fill'),
  layout: [[{
    label: Object(i18n_["_"])('Color'),
    option: 'fill',
    editor: 'editor.color',
    editorProps: {
      pickFromTheme: function pickFromTheme(theme) {
        return pick_default()({
          enterprise: {
            light: variables_default.a.gray80,
            dark: variables_default.a.gray25
          },
          prisma: variables_default.a.backgroundColorSidebar
        })({
          theme: theme
        });
      }
  ...
  layout: [[{
    ...
    editorProps: {
      pickFromTheme: function pickFromTheme(theme) {
        return pick_default()({
          enterprise: {
            dark: variables_default.a.gray80,
            light: variables_default.a.textColor
          },
          prisma: variables_default.a.neutral500
        })({
          theme: theme
        });
      }
    ...
    label: Object(i18n_["_"])('Thickness (px)'),
    option: 'strokeWidth',
    ...
    label: Object(i18n_["_"])('Radius (px)'),
    option: 'rx',
    editor: 'editor.number',
    editorProps: {
      min: 0
    ...
    label: Object(i18n_["_"])('Dash Style'),
...
/* harmony default export */ var Rectangle_editorConfig = (editorConfig);
// CONCATENATED MODULE: ./src/visualizations/Rectangle/Rectangle.jsx
...
var SVGContainer = external_styled_components_default.a.svg(_templateObject || (_templateObject = taggedTemplateLiteral_default()(["\n    width: ", "px;\n    height: ", "px;\n"])), function (props) {
  return props.width;
}, function (props) {
  return props.height;
});
var RectangleShape = Object(shapeUtils_["getStyledShape"])('rect');

var Rectangle_Rectangle = /*#__PURE__*/function (_Component) {
  inherits_default()(Rectangle, _Component);
  ...
  createClass_default()(Rectangle, [{
    ...
    value: function render() {
      ...
      var options = _objectSpread(_objectSpread({}, defaultOptions), this.props.options);

      var encodingProps = !isEmpty_default()(dataSources) ? Object(ShapeParser_["parse"])(dataSources, encoding) : {};
      var onClick = Object(eventUtils_["enableClickHandler"])(hasEventHandlers, mode) ? Object(eventUtils_["getClickHandler"])(onEventTrigger, _objectSpread({}, encodingProps), 'rectangle.click') : null;
      return /*#__PURE__*/external_react_default.a.createElement(SVGContainer, {
        width: width,
        height: height
      }, /*#__PURE__*/external_react_default.a.createElement(RectangleShape, extends_default()({}, encodingProps, options, {
        x: "".concat(options.strokeWidth / 2, "px"),
        y: "".concat(options.strokeWidth / 2, "px"),
        vectorEffect: "non-scaling-stroke",
        width: "".concat(width - options.strokeWidth, "px"),
        height: "".concat(height - options.strokeWidth, "px"),
        onClick: onClick
      })));
    }
  }]);
...
defineProperty_default()(Rectangle_Rectangle, "propTypes", BaseVisualization_default.a.propTypes);

defineProperty_default()(Rectangle_Rectangle, "defaultProps", _objectSpread(_objectSpread({}, BaseVisualization_default.a.defaultProps), {}, {
  height: 250,
  width: 300
}));

defineProperty_default()(Rectangle_Rectangle, "dataContract", ShapeParser_["dataContract"]);

defineProperty_default()(Rectangle_Rectangle, "vizContract", {
  initialDimension: {
    width: 150,
    height: 150
  }
...
defineProperty_default()(Rectangle_Rectangle, "initialRequestParams", {
  offset: 0,
  count: 10000
});

defineProperty_default()(Rectangle_Rectangle, "supportedDataSources", ['primary']);

defineProperty_default()(Rectangle_Rectangle, "schema", optionsSchema);

defineProperty_default()(Rectangle_Rectangle, "editor", Rectangle_editorConfig);

/* harmony default export */ var visualizations_Rectangle_Rectangle = __webpack_exports__["default"] = (Rectangle_Rectangle);
...
module.exports = require("@splunk/visualization-encoding-parsers/ShapeParser");
...
module.exports = require("@splunk/visualizations/common/shapeUtils");
