...
module.exports = require("@splunk/visualization-encoding-parsers/LineParser");
...
module.exports = require("@splunk/react-visualizations/Line");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "LineComponent", function() { return /* binding */ Line_LineComponent; });
...
// EXTERNAL MODULE: external "@splunk/react-visualizations/Line"
var Line_ = __webpack_require__(102);
var Line_default = /*#__PURE__*/__webpack_require__.n(Line_);

// EXTERNAL MODULE: external "@splunk/visualization-encoding-parsers/LineParser"
var LineParser_ = __webpack_require__(89);
...
// CONCATENATED MODULE: ./src/visualizations/Line/editorConfig.js
...
/* harmony default export */ var Line_editorConfig = (editorConfig);
// CONCATENATED MODULE: ./src/visualizations/Line/Line.jsx
...
var Line_LineComponent = /*#__PURE__*/function (_Component) {
  inherits_default()(LineComponent, _Component);

  var _super = _createSuper(LineComponent);

  function LineComponent() {
    classCallCheck_default()(this, LineComponent);

    return _super.apply(this, arguments);
  }

  createClass_default()(LineComponent, [{
    key: "render",
    value: function render() {
      ...
      var lineProps = Object(LineParser_["parse"])(dataSources, encoding); // todo: may need merge the truncateParsedData function with parse

      var truncationLimit = options && options['chart.resultTruncationLimit'];
      lineProps = Object(dataUtils_["truncateParsedData"])(lineProps, truncationLimit);
      ...
      var _getAnnotationLabelAn = Object(propUtils["a" /* getAnnotationLabelAndColor */])({
        ...
        annotationLabelEncoding: lineProps.annotationLabel,
        annotationColorEncoding: lineProps.annotationColor
      }),
      ...
      return /*#__PURE__*/external_react_default.a.createElement(Line_default.a, extends_default()({
        width: width,
        height: height,
        style: style,
        themeKey: themeKey,
        ...
        y: lineProps.y,
        y2: lineProps.y2,
        annotationX: lineProps.annotationX,
        annotationLabel: annotationLabel,
        annotationColor: annotationColor,
        xFieldName: lineProps.xFieldName,
        yFieldName: lineProps.yFieldName,
        y2FieldName: lineProps.y2FieldName,
...
defineProperty_default()(Line_LineComponent, "propTypes", BaseVisualization_default.a.propTypes);

defineProperty_default()(Line_LineComponent, "defaultProps", _objectSpread(_objectSpread({}, BaseVisualization_default.a.defaultProps), {}, {
  height: 250
}));

defineProperty_default()(Line_LineComponent, "dataContract", LineParser_["dataContract"]);

defineProperty_default()(Line_LineComponent, "vizContract", {
  initialDimension: {
    width: 300,
    height: 150
  }
...
defineProperty_default()(Line_LineComponent, "schema", optionsSchema);

defineProperty_default()(Line_LineComponent, "editor", Line_editorConfig);

/* harmony default export */ var Line = __webpack_exports__["default"] = (Object(enhancer_["withVisualizationAndThemeHOCs"])({
  ...
  placeholder: /*#__PURE__*/external_react_default.a.createElement(IconPlaceholder_default.a, {
    icon: /*#__PURE__*/external_react_default.a.createElement(visualization_icons_["Line"], null)
  })
})(Line_LineComponent));
