...
var dataSourceUtils_1 = __webpack_require__(89);

var withDashboardViz_1 = __webpack_require__(26);

var PureLinkGraph_1 = __webpack_require__(165);
...
var createLinkGraphFromTable = function createLinkGraphFromTable(fieldsIn, columnsIn, nodeWidth, nodeHeight, nodeSpacingX, nodeSpacingY, resultLimit, fieldOrder) {
  ...
  var fields = _toConsumableArray(fieldsIn);

  var columns = _toConsumableArray(columnsIn);

  if (fieldOrder.length) {
    fields = _toConsumableArray(fieldOrder);
    columns = [];
  ...
  fields.forEach(function (field, fieldIndex) {
    ...
    columns[fieldIndex].forEach(function (column, columnIndex) {
      ...
      if (columns[fieldIndex + 1] && columns[fieldIndex + 1][columnIndex]) {
        ...
        if (Object.keys(nodes[field].nodes).length < resultLimit) {
      ...
      if (!graphDataModel.nodes[key] && Object.keys(nodes[field].nodes).length < resultLimit) {
...
var LinkGraph_1 = __webpack_require__(116);
...
var PureLinkGraphUtils_1 = __webpack_require__(117);

var Graph_1 = __webpack_require__(166);

var Field_1 = __webpack_require__(171);

var FieldStyles_1 = __webpack_require__(176);
...
var Edges_1 = __webpack_require__(167);

var Nodes_1 = __webpack_require__(168);

var GraphStyles_1 = __webpack_require__(118);
...
var Node_1 = __webpack_require__(169);
...
var Paragraph_1 = __webpack_require__(170);
...
var Dropdown_1 = __webpack_require__(172);

var Button_1 = __webpack_require__(173);

var Menu_1 = __webpack_require__(174);

var Chip_1 = __webpack_require__(175);
...
var colorConstants_1 = __webpack_require__(38);
...
var optionsSchema = {
  ...
  linkColor: {
    default: '> themes.defaultLinkColor',
...
var themes = {
  ...
  defaultLinkColor: function defaultLinkColor(props) {
    return pick_1.default({
      enterprise: {
        dark: '#6d6f76',
        light: '#6d6f76'
