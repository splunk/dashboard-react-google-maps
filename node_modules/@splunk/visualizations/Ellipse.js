...
exports.config = exports.themes = void 0;
...
var config_1 = __webpack_require__(157);
...
var SVGContainer = styled_components_1.default.svg.withConfig({
  displayName: "Ellipse__SVGContainer",
  componentId: "sc-1r6zsey-0"
})(["width:", "px;height:", "px;"], function (props) {
  return props.width;
}, function (props) {
  return props.height;
});
var EllipseShape = shapeUtils_1.getStyledShape('ellipse');

var EllipseVisualization = function EllipseVisualization(_ref) {
  var height = _ref.height,
      width = _ref.width,
      onEllipseClick = _ref.onEllipseClick,
      options = _ref.options;
  return React.createElement(SVGContainer, {
    width: width,
    height: height
  }, React.createElement(EllipseShape, Object.assign({
    cx: "50%",
    cy: "50%",
    rx: "".concat(Number(width) / 2 - options['strokeWidth'] / 2, "px"),
    ry: "".concat(Number(height) / 2 - options['strokeWidth'] / 2, "px")
  }, options, {
...
var computeVizProps = function computeVizProps(_a) {
  var width = _a.width,
      height = _a.height,
      options = __rest(_a, ["width", "height"]);

  var computedProps = {
    width: width,
    height: height
  };
  computedProps.options = lodash_1.chain(options).pick(validOptions).thru(shapeUtils_1.mapToOldKey).value();
...
var defaultProps = {
  ...
  width: 350,
  options: {},
  onEllipseClick: lodash_1.noop
};
EllipseVisualization.propTypes = propTypes;
EllipseVisualization.defaultProps = defaultProps;
var Ellipse = withDashboardViz_1.default({
  ReactViz: EllipseVisualization,
  computeVizProps: computeVizProps,
...
var themes = {
  defaultFillColor: function defaultFillColor(props) {
    return pick_1.default({
      enterprise: {
        dark: variables_1.default.gray25(props),
        light: variables_1.default.gray80(props)
      },
  ...
  defaultStrokeColor: function defaultStrokeColor(props) {
    return pick_1.default({
      enterprise: {
        dark: variables_1.default.gray80(props),
        light: variables_1.default.gray30(props)
      },
      prisma: variables_1.default.neutral500(props)
    })(props);
  }
};
