...
exports.PureSingleValueRadialThemes = exports.PureSingleValueRadial = exports.config = void 0;

var SingleValueRadial_1 = __webpack_require__(251);

var withDashboardViz_1 = __webpack_require__(26);

var config_1 = __webpack_require__(235);

exports.config = config_1.default;
exports.PureSingleValueRadial = SingleValueRadial_1.default; // TODO: proper theming support for SVR when we come back to SVR viz

exports.PureSingleValueRadialThemes = {};
exports.default = withDashboardViz_1.default({
  ReactViz: SingleValueRadial_1.default,
...
var NumberFormatting_1 = __webpack_require__(236);
...
var optionsSchema = {
  majorValue: {
    default: '> primary|seriesByIndex(0)|lastPoint()',
  ...
  majorColor: {
    description: 'Specify the dataSource color for the major value. The hex value format should be #FFFFFF.',
    pattern: schemaUtils_1.COLOR_OR_TOKEN_PATTERN,
    type: 'string'
  },
  trendValue: {
    default: '> primary|seriesByIndex(0)|delta(-2)',
    description: 'The trend value to display in the visualization.',
    type: 'number'
  },
  trendColor: {
    default: '> trendValue|rangeValue(trendColors)',
    description: 'Specify the color for trend value. The hex value format should be #FFFFFF.',
    pattern: schemaUtils_1.COLOR_OR_TOKEN_PATTERN,
    type: 'string'
  },
  trendDisplay: {
  ...
  trendIndicatorPosition: {
    default: 'standard',
    description: 'Specify where the trend indicator is displayed on a radial graph. Note: When the major value or trend value is too large to fit inside of the graph, the trend is displayed below the graph.',
    pattern: schemaUtils_1.getPattern(['standard', 'below', 'outside']),
    type: 'string'
  },
  backgroundColor: {
  ...
  radialBackgroundColor: {
    description: 'Specify the color for the radial background color. The hex value format should be #FFFFFF.',
    pattern: schemaUtils_1.COLOR_OR_TOKEN_PATTERN,
    type: 'string'
  },
  radialStrokeColor: {
...
var editorConfig = [{
  label: i18n_1._('Visualization Settings'),
  layout: [[{
    label: i18n_1._('Trend Display as'),
    option: 'trendDisplay',
    editor: 'editor.select',
    editorProps: {
      values: [{
        label: i18n_1._('Percent'),
        value: 'percent'
      }, {
        label: i18n_1._('Absolute'),
        value: 'absolute'
      }, {
        label: i18n_1._('Off'),
        value: 'off'
    ...
    label: i18n_1._('Trend Indicator Position'),
    option: 'trendIndicatorPosition',
    editor: 'editor.radioBar',
    editorProps: {
      values: [{
        label: i18n_1._('Standard'),
        value: 'standard'
      }, {
        label: i18n_1._('Below'),
        value: 'below'
      }, {
        label: i18n_1._('Outside'),
        value: 'outside'
      }]
    },
  ...
  label: i18n_1._('Background Color'),
  layout: [[{
    label: '',
    option: 'backgroundColor',
    editor: 'editor.color',
    editorProps: {
      themeVariable: '@splunk/dashboard-visualizations/SingleValueRadial.defaultBackgroundColor'
    }
  }]]
}, NumberFormatting_1.default];
/**
...
var config = {
  ...
  themes: {} //fixme todo implement themes
...
var numberFormatting = {
  label: Object(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["_"])('Number Formatting'),
  layout: [[{
    label: Object(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["_"])('Digit Precision'),
    ...
    label: Object(_splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_0__["_"])('Unit'),
    option: 'unit',
    editor: 'editor.text'
  }, {
    label: 'Position',
...
/* harmony default export */ __webpack_exports__["default"] = (numberFormatting);
...
// EXTERNAL MODULE: external "@splunk/themes/pick"
var pick_ = __webpack_require__(20);
var pick_default = /*#__PURE__*/__webpack_require__.n(pick_);

// EXTERNAL MODULE: external "@splunk/themes/variables"
var variables_ = __webpack_require__(19);
var variables_default = /*#__PURE__*/__webpack_require__.n(variables_);
...
var external_lodash_pick_ = __webpack_require__(62);
...
// CONCATENATED MODULE: ./src/SingleValueRadial/PureSingleValueRadial/RadialGraph.jsx




var RadialGraph_RadialGraph = function RadialGraph(_ref) {
  var progress = _ref.progress,
      _ref$size = _ref.size,
      size = _ref$size === void 0 ? 200 : _ref$size,
      strokeWidth = _ref.strokeWidth,
      _ref$backgroundColor = _ref.backgroundColor,
      backgroundColor = _ref$backgroundColor === void 0 ? colorConstants_["RADIAL_BACKGROUND_COLOR"] : _ref$backgroundColor,
      _ref$progressColor = _ref.progressColor,
      progressColor = _ref$progressColor === void 0 ? colorConstants_["RADIAL_STROKE_COLOR"] : _ref$progressColor;
  var normalizedSize = size / 2;
  var normalizedRadius = normalizedSize - strokeWidth * 2;
  var circumference = normalizedRadius * 2 * Math.PI;
  var bgCircleOffset = 0.8 * circumference;
  var progress80 = progress / 100 * 80;
  var progressWidth = progress80 / 100 * circumference; // Offset the start of the circle to a position that makes the arc look evenly spaced
  ...
  var strokeDashoffset = circumference * 0.65;
  return /*#__PURE__*/external_react_default.a.createElement("svg", {
    height: normalizedSize * 2,
    width: normalizedSize * 2
  }, /*#__PURE__*/external_react_default.a.createElement("g", null, /*#__PURE__*/external_react_default.a.createElement("circle", {
    "data-test": "background-radial",
    stroke: backgroundColor,
    fill: "transparent",
    strokeWidth: strokeWidth,
    strokeDasharray: "".concat(bgCircleOffset, " ").concat(circumference - bgCircleOffset),
    style: {
    ...
    fill: "transparent",
    strokeWidth: strokeWidth,
    strokeDasharray: "".concat(progressWidth, " ").concat(circumference - progressWidth),
    style: {
      strokeDashoffset: strokeDashoffset
    },
    r: normalizedRadius,
...
RadialGraph_RadialGraph.propTypes = {
  ...
  progressColor: external_prop_types_default.a.string
};
RadialGraph_RadialGraph.defaultProps = {
  progress: 0,
  strokeWidth: 12
};
/* harmony default export */ var PureSingleValueRadial_RadialGraph = (RadialGraph_RadialGraph);
// EXTERNAL MODULE: ./src/common/utils/singleValueUtils.js
var singleValueUtils = __webpack_require__(15);

// CONCATENATED MODULE: ./src/SingleValueRadial/PureSingleValueRadial/utils/displayUtils.js


var VALID_TREND_POSITIONS = ['standard', 'below', 'outside'];
var MAJOR_FONT_THRESHOLD = 25;
var TREND_FONT_THRESHOLD = 12;
var DEFAULT_RADIAL_STROKE_WIDTH = 12;
var SMALL_RADIAL_STROKE_WIDTH = 6;
/**
...
var displayUtils_getRadialColors = function getRadialColors(_ref) {
  var backgroundEnabled = _ref.backgroundEnabled,
      backgroundColor = _ref.backgroundColor;
  return Object(singleValueUtils["getGraphColors"])({
    backgroundEnabled: backgroundEnabled,
    backgroundColor: backgroundColor,
    defaultColors: colorConstants_["RADIAL_SEVERITY_COLORS"],
    customColorFormatter: function customColorFormatter(color) {
      return {
        background: Object(singleValueUtils["lighten"])(color),
        stroke: Object(singleValueUtils["darken"])(color)
      };
    }
  });
};
...
var displayUtils_getGraphSize = function getGraphSize(_ref2) {
  var width = _ref2.width,
      height = _ref2.height,
      underLabel = _ref2.underLabel;
  var size = Math.min(width, height);

  if (underLabel) {
    size -= singleValueUtils["DEFAULT_FONT"];
  }
...
var getValueContentSize = function getValueContentSize(_ref3) {
  var graphSize = _ref3.graphSize,
      radialStrokeWidth = _ref3.radialStrokeWidth; // Account for the graph's stroke width

  var diameter = graphSize - radialStrokeWidth; // Use pythagoreum theorum with circle diameter
  // to calculate the size of the sides of the square inside the circle

  return Math.floor(Math.sqrt(Math.pow(diameter, 2) / 2));
};
/*
...
var getRadialStrokeWidth = function getRadialStrokeWidth(graphSize) {
  return graphSize >= 90 ? DEFAULT_RADIAL_STROKE_WIDTH : SMALL_RADIAL_STROKE_WIDTH;
};
/*
...
var isValidPosition = function isValidPosition(position) {
  return VALID_TREND_POSITIONS.indexOf(position) > -1;
};
/**
...
var computeTrendIndicatorPosition = function computeTrendIndicatorPosition(_ref4) {
  var trendIndicatorPosition = _ref4.trendIndicatorPosition,
      majorTextFontSize = _ref4.majorTextFontSize,
      trendTextFontSize = _ref4.trendTextFontSize;
  var position = trendIndicatorPosition;

  if (!isValidPosition(position)) {
    position = 'standard';
  }

  if (position !== 'outside' && (trendTextFontSize < TREND_FONT_THRESHOLD || majorTextFontSize < MAJOR_FONT_THRESHOLD)) {
    position = 'below';
  }
...
var showTrendPositionStandard = function showTrendPositionStandard(_ref5) {
  var showTrendIndicator = _ref5.showTrendIndicator,
      position = _ref5.position;
  return showTrendIndicator && position === 'standard';
};
/*
...
var showTrendPositionBelow = function showTrendPositionBelow(_ref6) {
  var showTrendIndicator = _ref6.showTrendIndicator,
      position = _ref6.position;
  return showTrendIndicator && position === 'below';
};
/*
...
var showTrendPositionOutside = function showTrendPositionOutside(_ref7) {
  var showTrendIndicator = _ref7.showTrendIndicator,
      position = _ref7.position;
  return showTrendIndicator && position === 'outside';
};
/*
...
var getRadialProgress = function getRadialProgress(majorValue) {
  return Number.isNaN(Number(majorValue)) ? 0 : majorValue / Math.max(majorValue, 100) * 100;
};
// CONCATENATED MODULE: ./src/SingleValueRadial/PureSingleValueRadial/RadialLayout.jsx
...
var PositionDiv = external_styled_components_default.a.div.withConfig({
  displayName: "RadialLayout__PositionDiv",
  componentId: "sc-13x2rjt-0"
})(["position:absolute;", ";bottom:", "px;left:0;width:100%;height:100%;display:flex;align-items:", ";justify-content:center;"], function (props) {
  return props.bottom ? '' : 'top: 0';
}, function (props) {
...
var Column = external_styled_components_default.a.div.withConfig({
  displayName: "RadialLayout__Column",
  componentId: "sc-13x2rjt-1"
})(["display:flex;flex-direction:column;align-items:", ";justify-content:", ";"], function (props) {
  return props.align || 'center';
}, function (props) {
  return props.align || 'center';
});
var Row = external_styled_components_default.a.div.withConfig({
  displayName: "RadialLayout__Row",
  componentId: "sc-13x2rjt-2"
})(["display:flex;flex-direction:row;align-items:center;justify-content:center;"]);
var Square = external_styled_components_default.a.div.withConfig({
  displayName: "RadialLayout__Square",
  componentId: "sc-13x2rjt-3"
})(["position:relative;margin:0 auto;width:", "px;height:", "px;"], function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
var UnderLabelContainer = external_styled_components_default.a.div.withConfig({
  displayName: "RadialLayout__UnderLabelContainer",
  componentId: "sc-13x2rjt-4"
})(["color:", ";margin-top:", ";font-size:", "px;"], function (props) {
  return props.color;
}, function (props) {
  return props.size && "-".concat(props.size * 0.1, "px") || 0;
}, function (props) {
...
var RadialLayout_renderIsolateTrend = function renderIsolateTrend(_ref) {
  var trendText = _ref.trendText,
      trendColor = _ref.trendColor,
      contentSize = _ref.contentSize;
  var trendTextFontSize = Object(singleValueUtils["getTrendFontSize"])({
    width: contentSize / 2,
    height: contentSize / 4,
    trendText: trendText,
    spaceRatio: 1
  });
  return /*#__PURE__*/external_react_default.a.createElement(SingleValueBasic["SingleValueTrendValue"], {
...
RadialLayout_renderIsolateTrend.propTypes = {
  trendText: external_prop_types_default.a.string,
  trendColor: external_prop_types_default.a.string,
  contentSize: external_prop_types_default.a.number
};

var RadialLayout_RadialContent = function RadialContent(_ref2) {
  var props = extends_default()({}, _ref2);
  ...
  var majorColor = props.majorColor,
      ...
      trendPosition = props.trendPosition,
      unit = props.unit,
      ...
      showRadialGraph = props.showRadialGraph,
      graphSize = props.graphSize,
      progress = props.progress,
      radialBackgroundColor = props.radialBackgroundColor,
      radialStrokeColor = props.radialStrokeColor,
      radialStrokeWidth = props.radialStrokeWidth; // for trend position below and outside

  var trendComponent = RadialLayout_renderIsolateTrend({
    trendText: trendText,
    trendColor: trendColor,
    contentSize: contentSize
  });
  var basicSingleValues = /*#__PURE__*/external_react_default.a.createElement(SingleValueBasic["default"], {
    majorColor: majorColor,
    majorText: majorText,
    majorTextFontSize: majorTextFontSize,
    majorValueTitle: majorValueTitle,
    ...
    trendText: trendText,
    trendTextFontSize: trendTextFontSize,
    showTrendIndicator: showTrendPositionStandard({
  ...
  var radialGraph = showRadialGraph ? /*#__PURE__*/external_react_default.a.createElement(PureSingleValueRadial_RadialGraph, {
    size: graphSize,
    progress: progress,
  ...
  var underLabelComponent = underLabel ? /*#__PURE__*/external_react_default.a.createElement(UnderLabelContainer, {
    "data-test": "underLabel",
    color: underLabelColor,
    size: underLabelFontSize
  }, underLabel) : null;
  var outsideComponent = showTrendPositionOutside({
    showTrendIndicator: showTrendIndicator,
    position: trendPosition
  }) ? /*#__PURE__*/external_react_default.a.createElement(Column, {
    align: "end",
    "data-test": "trend-position-outside"
  }, trendComponent, underLabelComponent) : null;
  var belowTrendComponent = showTrendPositionBelow({
    showTrendIndicator: showTrendIndicator,
    position: trendPosition
  }) ? /*#__PURE__*/external_react_default.a.createElement(PositionDiv, {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(Row, null, /*#__PURE__*/external_react_default.a.createElement(Column, null, /*#__PURE__*/external_react_default.a.createElement(Square, {
    size: graphSize
  }, radialGraph, belowTrendComponent, /*#__PURE__*/external_react_default.a.createElement(PositionDiv, null, basicSingleValues)), trendPosition !== 'outside' && underLabelComponent), outsideComponent);
};

RadialLayout_RadialContent.propTypes = _objectSpread(_objectSpread({}, SingleValueBasic["default"].propTypes), {}, {
  trendPosition: external_prop_types_default.a.string,
  contentSize: external_prop_types_default.a.number,
  showRadialGraph: external_prop_types_default.a.bool,
  graphSize: external_prop_types_default.a.number,
  progress: external_prop_types_default.a.number,
  radialBackgroundColor: external_prop_types_default.a.string,
  radialStrokeColor: external_prop_types_default.a.string,
  radialStrokeWidth: external_prop_types_default.a.number
});
/* harmony default export */ var RadialLayout = (RadialLayout_RadialContent);
// CONCATENATED MODULE: ./src/SingleValueRadial/PureSingleValueRadial/SingleValueRadial.jsx
...
var Container = external_styled_components_default.a.div.withConfig({
  displayName: "SingleValueRadial__Container",
  componentId: "sc-404dvw-0"
})(["overflow:hidden;", ";"], function (props) {
  return Object(style_["toDimension"])(external_lodash_pick_default()(props, ['width', 'height']));
});

var SingleValueRadial_SingleValueRadial = function SingleValueRadial(_ref) {
  ...
  var width = props.width,
      ...
      _props$trendIndicator = props.trendIndicatorPosition,
      trendIndicatorPosition = _props$trendIndicator === void 0 ? 'standard' : _props$trendIndicator,
      onValueClick = props.onValueClick; // calculate colors

  var defaultColors = {
    defaultFontColor: pick_default()({
      enterprise: {
        dark: variables_default.a.textColor(props),
        light: variables_default.a.gray20(props)
      },
      prisma: variables_default.a.contentColorActive(props)
    })(props),
    defaultBlockFontColor: pick_default()({
      enterprise: variables_default.a.white(props),
      prisma: variables_default.a.contentColorActive(props)
    })(props)
  };
  ...
  var radialColors = displayUtils_getRadialColors({
    backgroundEnabled: backgroundEnabled,
    backgroundColor: backgroundColor
  });
  var radialBackgroundColor = props.radialBackgroundColor || radialColors.background;
  var radialStrokeColor = props.radialStrokeColor || radialColors.stroke;
  ...
  var renderVisualization = function renderVisualization(_ref2) {
    ...
    var trendDisplay = props.trendDisplay,
        unit = props.unit,
        underLabel = props.underLabel;
    var showRadialGraph = true; // calculate radial graph, major and trend content, and underlabel size

    var graphSize = displayUtils_getGraphSize({
      width: containerWidth,
      height: containerHeight,
      underLabel: underLabel
    });
    var radialStrokeWidth = getRadialStrokeWidth(graphSize);
    var valueContentSize = getValueContentSize({
      graphSize: graphSize,
      radialStrokeWidth: radialStrokeWidth
    });
    var underLabelFontSize = Object(singleValueUtils["getUnderLabelHeight"])(graphSize * 0.1); // calculate major and trend text
    ...
    if (!isEmpty_default()(smallVizProps)) {
      ...
      showRadialGraph = smallVizProps.showRadialGraph;
      trendDisplay = smallVizProps.trendDisplay;
      unit = smallVizProps.unit;
    } // calculate trend position


    var position = computeTrendIndicatorPosition({
      trendIndicatorPosition: trendIndicatorPosition,
      majorTextFontSize: majorTextFontSize,
      trendTextFontSize: trendTextFontSize
    }); // calculate radial

    var progress = getRadialProgress(majorValue);
    return /*#__PURE__*/external_react_default.a.createElement(VizStyleWrapper["default"], {
      backgroundColor: backgroundColor,
      style: style,
      dataTestKey: "SingleValueRadialWrapper"
    }, /*#__PURE__*/external_react_default.a.createElement(RadialLayout, {
...
SingleValueRadial_SingleValueRadial.propTypes = {
  ...
  trendDisplay: external_prop_types_default.a.string,
  trendIndicatorPosition: external_prop_types_default.a.oneOf(['standard', 'below', 'outside']),
...
SingleValueRadial_SingleValueRadial.defaultProps = {
  width: '100%',
  height: 250,
  majorValue: 'N/A',
  majorValueField: '',
...
/* harmony default export */ var PureSingleValueRadial_SingleValueRadial = __webpack_exports__["default"] = (Object(external_styled_components_["withTheme"])(SingleValueRadial_SingleValueRadial));
...
/******/ });
//# sourceMappingURL=SingleValueRadial.js.map