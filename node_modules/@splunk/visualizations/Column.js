...
var config_1 = __webpack_require__(156);

exports.config = config_1.default;

var withDashboardViz_1 = __webpack_require__(27);

var columnUtils_1 = __webpack_require__(157);
...
var computeVizProps = function computeVizProps(_a) {
  var dataSources = _a.dataSources,
      ...
      otherOptions = __rest(_a, ["dataSources", "onEventTrigger", "x", "y", "xField", "yFields", "annotationX", "annotationLabel", "annotationColor", "visualizationApiRef"]); // options to be passed as props


  var computedProps = {
    visualizationApiRef: visualizationApiRef
  };
  var y2Fields = otherOptions.y2Fields,
      y2 = otherOptions.y2,
      hasEventHandlers = otherOptions.hasEventHandlers;
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(columnUtils_1.convertToColumnSCProperties).thru(function (options) {
    return Object.assign(Object.assign({}, simpleXMLOptions_1.getSimpleXMLOptionsForProps(lodash_1.omit(options, ['y2Fields']))), {
      chart: 'column'
    });
  }).value();
...
var Column = withDashboardViz_1.default({
...
var Column_1 = __webpack_require__(113);
...
exports.optionsSchema = {
  ...
  columnGrouping: {
    ...
    pattern: schemaUtils_1.getPattern(['auto', 'overlay']),
    type: 'string'
  },
  columnSpacing: {
  ...
  showTooltip: {
    description: 'Specify whether a tooltip should be visible on hover',
    type: 'boolean',
    default: true
  },
  showXMajorGridLines: {
...
exports.convertToColumnSCProperties = exports.mapToOldKey = exports.convertToStringValues = exports.convertAuto = exports.convertTitleVisibilityOptions = exports.convertYAxisLabelOptions = exports.convertLegendDisplayOptions = exports.columnOptionValuesSCMapping = void 0;
...
exports.columnOptionValuesSCMapping = {
  xAxisTitleVisibility: {
    hide: 'collapsed'
  },
  yAxisTitleVisibility: {
...
var convertLegendDisplayOptions = function convertLegendDisplayOptions() {
  var originalOptions = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var convertedOptions = Object.assign({}, originalOptions);
  ['legendPlacement', 'legendLabelOverflowMode'].forEach(function (key) {
    var updatedValue = exports.columnOptionValuesSCMapping[key][originalOptions[key]];
...
exports.convertLegendDisplayOptions = convertLegendDisplayOptions;
/**
...
var convertYAxisLabelOptions = function convertYAxisLabelOptions(originalOptions) {
  var convertedOptions = Object.assign({}, originalOptions);
  var updatedValue = exports.columnOptionValuesSCMapping.yAxisAbbreviation[originalOptions.yAxisAbbreviation];
...
exports.convertYAxisLabelOptions = convertYAxisLabelOptions;
/**
...
var convertTitleVisibilityOptions = function convertTitleVisibilityOptions(originalOptions) {
  var convertedOptions = Object.assign({}, originalOptions);
  ['xAxisTitleVisibility', 'yAxisTitleVisibility', 'y2AxisTitleVisibility'].forEach(function (key) {
...
exports.convertTitleVisibilityOptions = convertTitleVisibilityOptions;
/**
...
var convertAuto = function convertAuto(originalOptions) {
  var convertedOptions = Object.assign({}, originalOptions);
  ['stackMode'].forEach(function (key) {
...
exports.convertAuto = convertAuto;
/**
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return columnOptionsSCMapping[key] ? columnOptionsSCMapping[key] : key;
  });
};
...
var convertToColumnSCProperties = function convertToColumnSCProperties(originalOptions) {
  return lodash_1.chain(exports.mapToOldKey(originalOptions)).thru(chartingUtils_1.mapToValues(exports.columnOptionValuesSCMapping)).thru(chartingUtils_1.convertY2AxisOptions).thru(chartingUtils_1.convertOverlayFields).thru(exports.convertTitleVisibilityOptions).thru(exports.convertLegendDisplayOptions).thru(exports.convertToStringValues).thru(exports.convertAuto).thru(exports.convertYAxisLabelOptions).value();
};

exports.convertToColumnSCProperties = convertToColumnSCProperties;
