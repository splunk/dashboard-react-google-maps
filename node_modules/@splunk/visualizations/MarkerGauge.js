...
var MarkerGauge_1 = __webpack_require__(182);
...
var markerGaugeUtils_1 = __webpack_require__(188);
...
var computeVizProps = function computeVizProps(props) {
  ...
  var options = lodash_1.chain(otherOptions).pick(validOptions).thru(markerGaugeUtils_1.convertToMarkerGaugeProperties).value();
  var defaultColors = {
  ...
  var computedProps = Object.assign(Object.assign({
...
var MarkerGauge = withDashboardViz_1.default({
...
var MarkerGauge_1 = __webpack_require__(120);
...
var id_1 = __webpack_require__(183);

var gaugeUtils_1 = __webpack_require__(184);

var GaugeMajorTicks_1 = __webpack_require__(185);

var GaugeValueMarker_1 = __webpack_require__(186);
...
var MarkerGauge = function MarkerGauge(_a) {
  ...
  var errorMessage = react_1.useCallback(function (containerWidth, containerHeight, err) {
    return React.createElement(Message_1.default, {
  ...
  var renderVisualization = react_1.useCallback(function (_ref) {
    ...
    if ((containerWidth < MAX_VERTICAL_CONTAINER_WIDTH || containerHeight + 58 < MIN_VERTICAL_CONTAINER_HEIGHT) && orientation === 'vertical' || (containerWidth < MIN_HORIZONTAL_CONTAINER_WIDTH || containerHeight < MIN_HORIZONTAL_CONTAINER_HEIGHT) && orientation === 'horizontal') {
      return errorMessage(containerWidth, containerHeight, i18n_1._('Too small to render content'));
    }

    if (error) {
      return errorMessage(containerWidth, containerHeight, error);
    }
  ...
  }, [orientation, error, calculateMarkerGaugeDimensions, backgroundColor, linearGradient, fillColor, min, max, majorUnit, showLabels, usePercentageRange, majorTickFillColor, majorTickStrokeColor, linearGradientId, value, showValue, usePercentageValue, valueMarkerFillColor, valueMarkerLabelFillColor, errorMessage]);
...
/* harmony import */ var lodash_uniqBy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(101);
...
/* harmony import */ var _splunk_visualizations_shared_colorConstants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(38);
...
/* harmony import */ var _splunk_ui_utils_i18n__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
...
/* harmony import */ var _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
...
/* harmony import */ var _splunk_visualizations_shared_numberUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(24);
...
var config = {
   ...
   * viz icon
   */
  icon: visualization_icons_1.MarkerGauge,
...
exports.convertToMarkerGaugeProperties = exports.mapValueLabelDisplay = exports.mapToOldKey = void 0;

var lodash_1 = __webpack_require__(2); // map for new options names to old option names


var markerGaugeOptionsMapping = {
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return markerGaugeOptionsMapping[key] ? markerGaugeOptionsMapping[key] : key;
  });
};
...
/**
 * Chained helper for mapping the option properties (and values) we expose in config.ts into property values that marker gauge accepts
 ...
 * @method convertToMarkerGaugeProperties
 * @param {Object} originalOptions
 * @returns {Object}
 */

var convertToMarkerGaugeProperties = function convertToMarkerGaugeProperties(originalOptions) {
...
exports.convertToMarkerGaugeProperties = convertToMarkerGaugeProperties;
