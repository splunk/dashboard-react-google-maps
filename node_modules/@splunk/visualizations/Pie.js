...
exports.config = exports.themes = exports.computeVizProps = exports.PieInnerSize = void 0;
...
var computeVizProps = function computeVizProps(_a) {
  var dataSources = _a.dataSources,
      ...
      label = _a.label,
      value = _a.value,
      showDonutHole = _a.showDonutHole,
      visualizationApiRef = _a.visualizationApiRef,
      otherOptions = __rest(_a, ["dataSources", "onEventTrigger", "label", "value", "showDonutHole", "visualizationApiRef"]); // options to be passed as props


  var computedProps = {
    visualizationApiRef: visualizationApiRef
  };
  var labelField = otherOptions.labelField,
      valueField = otherOptions.valueField,
      hasEventHandlers = otherOptions.hasEventHandlers;
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(pieUtils_1.convertToPieSCProperties).thru(function (options) {
  ...
  var primaryData = Object.assign(Object.assign({}, dataSources.primary.data), {
    columns: [label, value]
  });
  primaryData.fields = [{
    name: labelField
  ...
  primaryData.columns.forEach(function (column, index) {
    if (column) {
  ...
  if (showDonutHole) {
    computedProps.options['chart.pieInnerSize'] = exports.PieInnerSize;
  } else {
...
var Pie = withDashboardViz_1.default({
...
var Pie_1 = __webpack_require__(124);

Object.defineProperty(exports, "default", {
  enumerable: true,
  get: function get() {
    return Pie_1.default;
  }
});
...
var ChartPie_1 = __webpack_require__(204);
...
exports.convertToPieSCProperties = exports.mapToOldKey = exports.mapLabelDisplay = exports.convertToStringValues = void 0;

var lodash_1 = __webpack_require__(2);

var propUtils_1 = __webpack_require__(18); // CONVERT THIS TO PIE THEN ADD TO Pie.TSX
// map for key names which are either new or not present in SimpleXML options mapping


var pieOptionsSCMapping = {
  resultLimit: 'resultTruncationLimit',
  seriesColorsByValue: 'fieldColors',
...
var mapLabelDisplay = function mapLabelDisplay(_a) {
  var labelDisplay = _a.labelDisplay,
      options = __rest(_a, ["labelDisplay"]);

  var convertedOptions = Object.assign(Object.assign({}, options), {
...
exports.mapLabelDisplay = mapLabelDisplay;
/**
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return pieOptionsSCMapping[key] ? pieOptionsSCMapping[key] : key;
  });
};
...
var convertToPieSCProperties = function convertToPieSCProperties(originalOptions) {
  return lodash_1.chain(exports.mapToOldKey(originalOptions)).thru(exports.convertToStringValues).thru(exports.mapLabelDisplay).value();
};

exports.convertToPieSCProperties = convertToPieSCProperties;
