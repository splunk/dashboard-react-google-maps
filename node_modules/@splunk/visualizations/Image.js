...
exports.config = exports.themes = exports.toImageDimensions = exports.shouldShowPlaceholder = void 0;
...
var RemoteImage_1 = __webpack_require__(116);

var styled_components_1 = __webpack_require__(4);

var T = __webpack_require__(0);

var config_1 = __webpack_require__(166);

exports.config = config_1.default;

var withDashboardViz_1 = __webpack_require__(27);

var ImageApi_1 = __webpack_require__(167);

var useEffect = React.useEffect,
    useRef = React.useRef;
var validOptions = Object.keys(config_1.default.optionsSchema);
var Container = styled_components_1.default.div.attrs(function () {
  return {
    'data-test': 'image-container'
  };
}).withConfig({
  displayName: "Image__Container",
  componentId: "kplb09-0"
})(["position:relative;box-sizing:border-box;display:flex;justify-content:center;align-items:center;cursor:", ";", ";"], function (props) {
  return props.onClick ? 'pointer' : 'inherit';
}, function (props) {
  return style_1.toDimension(lodash_1.pick(props, ['width', 'height']));
});

var shouldShowPlaceholder = function shouldShowPlaceholder(dataSources, loading, options) {
  if (options.src) {
    return false;
  }
...
exports.shouldShowPlaceholder = shouldShowPlaceholder;
...
exports.toImageDimensions = toImageDimensions;
var StyledImage = styled_components_1.default.img.withConfig({
  displayName: "Image__StyledImage",
  componentId: "kplb09-1"
})(["display:block;", ";"], function (props) {
  return exports.toImageDimensions(props);
});

var computeVizProps = function computeVizProps(_a) {
  var visualizationApiRef = _a.visualizationApiRef,
      title = _a.title,
      otherOptions = __rest(_a, ["visualizationApiRef", "title"]);

  var options = lodash_1.chain(otherOptions).pick(validOptions).value();
  return {
    options: options,
    title: title,
...
var ImageVisualization = function ImageVisualization(_ref) {
  var height = _ref.height,
      width = _ref.width,
      _ref$title = _ref.title,
      title = _ref$title === void 0 ? '' : _ref$title,
      visualizationApiRef = _ref.visualizationApiRef,
      options = _ref.options,
      onImageClick = _ref.onImageClick;
  var src = options.src,
      preserveAspectRatio = options.preserveAspectRatio;
  var remoteImage = useRef(null);
  var api = useRef(new ImageApi_1.default({
    options: {
      src: src,
  ...
  var isRemote = RemoteImage_1.isRemoteImage(src);
  useEffect(function () {
  ...
  return React.createElement(Container, {
  ...
  }, isRemote ? React.createElement(RemoteImage_1.default, {
    imageURL: src,
    title: title,
    preserveAspectRatio: preserveAspectRatio,
    width: width,
    ...
    onError: function onError(e) {
      e.target.alt = i18n_1._('Image not found');
    },
...
var defaultProps = {
  ...
  onImageClick: lodash_1.noop
};
ImageVisualization.propTypes = propTypes;
ImageVisualization.defaultProps = defaultProps;
var Image = withDashboardViz_1.default({
  ReactViz: ImageVisualization,
  vizConfig: config_1.default,
  useIconPlaceholder: exports.shouldShowPlaceholder,
...
var Image_1 = __webpack_require__(115);
...
var editorConfig = [{
  ...
  layout: [[{
    ...
    label: i18n_1._('Preserve Aspect Ratio'),
...
var config = {
   ...
   */
  name: 'Image',
  category: VizCategory_1.VizCategory.MISC,
...
var ImageApi = /*#__PURE__*/function () {
  ...
  _createClass(ImageApi, [{
    ...
    value: function snapshot() {
      var srcFromOptions = lodash_1.get(this.viz.options, 'src', '');
      var isRemote = RemoteImage_1.isRemoteImage(srcFromOptions);
      return {
        options: Object.assign(Object.assign({}, this.viz.options), {
          src: isRemote && this.viz.remoteImage ? lodash_1.get(this.viz.remoteImage, ['current', 'state', 'imageDataURI'], '') : srcFromOptions
        })
      };
    }
  }]);
