...
var bubbleUtils_1 = __webpack_require__(143);
...
var computeVizProps = function computeVizProps(_a) {
  var dataSources = _a.dataSources,
      ...
      otherOptions = __rest(_a, ["dataSources", "onEventTrigger", "visualizationApiRef", "x", "y", "size", "category", "xField", "yField", "sizeField", "categoryField"]); // options to be passed as props
  ...
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(bubbleUtils_1.convertToBubbleSCProperties).thru(function (options) {
  ...
  var columns = [x.map(String), y.map(String), size.map(String)];
  var fields = [{
    name: xField
  }, {
    name: yField
...
var Bubble = withDashboardViz_1.default({
...
var Bubble_1 = __webpack_require__(111);
...
var optionsSchema = {
  ...
  bubbleSizeMethod: {
    ...
    pattern: schemaUtils_1.getPattern(['area', 'diameter']),
    type: 'string'
  },
  legendDisplay: {
    default: 'right',
...
exports.convertToBubbleSCProperties = exports.mapToOldKey = exports.convertToStringValues = exports.bubbleOptionValuesSCMapping = void 0;
...
exports.bubbleOptionValuesSCMapping = {
  xAxisTitleVisibility: {
    hide: 'collapsed'
  },
  yAxisTitleVisibility: {
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return bubbleOptionsSCMapping[key] ? bubbleOptionsSCMapping[key] : key;
  });
};
...
var convertToBubbleSCProperties = function convertToBubbleSCProperties(originalOptions) {
  return lodash_1.chain(exports.mapToOldKey(originalOptions)).thru(chartingUtils_1.mapToValues(exports.bubbleOptionValuesSCMapping)).thru(exports.convertToStringValues).value();
};

exports.convertToBubbleSCProperties = convertToBubbleSCProperties;
