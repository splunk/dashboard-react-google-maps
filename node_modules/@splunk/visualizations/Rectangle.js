...
exports.config = exports.computeVizProps = void 0;
...
var config_1 = __webpack_require__(214);

exports.config = config_1.default;

var shapeUtils_1 = __webpack_require__(88);

var SVGContainer = styled_components_1.default.svg.withConfig({
  displayName: "Rectangle__SVGContainer",
  componentId: "iwvil2-0"
...
var RectangleShape = shapeUtils_1.getStyledShape('rect');

var RectangleViz = function RectangleViz(props) {
  var width = props.width,
      height = props.height,
      onRectangleClick = props.onRectangleClick;
  var options = props.options;
  return React.createElement(SVGContainer, {
    width: width,
    height: height
  }, React.createElement(RectangleShape, Object.assign({}, options, {
...
var computeVizProps = function computeVizProps(props) {
  var dataSources = props.dataSources,
      otherOptions = __rest(props, ["dataSources"]);

  var computedProps = {
    dataSources: dataSources,
    options: null
  };
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(shapeUtils_1.mapToOldKey).value();
...
var Rectangle = withDashboardViz_1.default({
...
var Rectangle_1 = __webpack_require__(123);
...
var themes_1 = __webpack_require__(91);
...
var DynamicFillColorEditor_1 = __webpack_require__(84);

var DynamicStrokeColorEditor_1 = __webpack_require__(85);

var StaticFillColorEditor_1 = __webpack_require__(86);

var StaticStrokeColorEditor_1 = __webpack_require__(87);
...
exports.optionsSchema = {
  ...
  strokeJoinStyle: {
    ...
    type: 'string',
    default: 'miter',
    pattern: schemaUtils_1.getPattern(['arcs', 'bevel', 'miter', 'miter-clip', 'round'])
  },
  strokeOpacity: {
...
var themes = {
  defaultFillColor: function defaultFillColor(props) {
    return themes_1.pick({
      enterprise: {
        dark: themes_1.variables.gray25(props),
        light: themes_1.variables.gray80(props)
      },
      prisma: themes_1.variables.backgroundColorSidebar(props)
    })(props);
  },
  defaultStrokeColor: function defaultStrokeColor(props) {
    return themes_1.pick({
      enterprise: {
        dark: themes_1.variables.gray80(props),
        light: themes_1.variables.gray30(props)
      },
      prisma: themes_1.variables.neutral500(props)
    })(props);
  }
};
...
var editorConfig = [{
  ...
  layout: [[{
    ...
    label: i18n_1._('Stroke Dash Style'),
  ...
  }], [Object.assign(Object.assign({}, StaticFillColorEditor_1.default), {
    editorProps: {
      labelPosition: 'left',
      themes: themes
    }
  })], [DynamicFillColorEditor_1.getDynamicFillColorEditor({
    defaultContext: defaultContext,
    defaultPalettesConfig: PresetPalettes_1.defaultPalettesConfig
  })], [Object.assign(Object.assign({}, StaticStrokeColorEditor_1.default), {
    editorProps: {
      labelPosition: 'left',
      themes: themes
    }
  })], [DynamicStrokeColorEditor_1.getDynamicStrokeColorEditor({
    defaultContext: defaultContext,
    defaultPalettesConfig: PresetPalettes_1.defaultPalettesConfig
  })]]
}];
...
var config = {
   ...
   */
  name: 'Rectangle',
  category: VizCategory_1.VizCategory.SHAPES,

  /**
   * viz icon
   */
  icon: visualization_icons_1.Rectangle,
...
exports.getDynamicFillColorEditor = void 0;

var i18n_1 = __webpack_require__(3);

var configUtils_1 = __webpack_require__(8);

var getDynamicFillColorEditor = function getDynamicFillColorEditor(_ref) {
  var defaultContext = _ref.defaultContext,
      defaultPalettesConfig = _ref.defaultPalettesConfig;
  return {
    label: i18n_1._('Dynamic Fill'),
    option: 'fillColor',
    context: 'fillColorEditorConfig',
    editor: 'editor.dynamicColor',
    showEditor: function showEditor(_ref2) {
      var options = _ref2.options;
      return configUtils_1.isDynamicOption(options.fillColor);
    },
    editorProps: {
      labelPosition: 'left',
      flyoutTitle: i18n_1._('Dynamic Coloring: Fill Color'),
      formatters: [{
...
exports.getDynamicFillColorEditor = getDynamicFillColorEditor;
...
exports.getDynamicStrokeColorEditor = void 0;

var i18n_1 = __webpack_require__(3);

var configUtils_1 = __webpack_require__(8);

var getDynamicStrokeColorEditor = function getDynamicStrokeColorEditor(_ref) {
  var defaultContext = _ref.defaultContext,
      defaultPalettesConfig = _ref.defaultPalettesConfig;
  return {
    label: i18n_1._('Dynamic Stroke'),
    option: 'strokeColor',
    ...
    editorProps: {
      labelPosition: 'left',
      flyoutTitle: i18n_1._('Dynamic Coloring: Stroke Color'),
      formatters: [{
        label: i18n_1._('Ranges'),
        value: 'rangeValue',
        defaults: {
...
exports.getDynamicStrokeColorEditor = getDynamicStrokeColorEditor;
...
var StaticFillColorEditor = {
  label: i18n_1._('Static Fill'),
  option: 'fillColor',
  editor: 'editor.color',
...
exports.default = StaticFillColorEditor;
...
var StaticStrokeColorEditor = {
  label: i18n_1._('Static Stroke'),
  option: 'strokeColor',
  editor: 'editor.color',
  showEditor: function showEditor(_ref) {
    var options = _ref.options;
...
exports.default = StaticStrokeColorEditor;
...
exports.getStyledShape = exports.mapToOldKey = void 0;
...
var propUtils_1 = __webpack_require__(17); // map for new options names to old option names


var shapeOptionsMapping = {
  fillColor: 'fill',
  strokeColor: 'stroke',
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return shapeOptionsMapping[key] ? shapeOptionsMapping[key] : key;
  });
};
...
var getStyledShape = function getStyledShape(shape) {
  return styled_components_1.default(shape).withConfig({
    displayName: "shapeUtils",
    componentId: "sc-1myvp5h-0"
  })(["fill:", ";stroke:", ";cursor:", ";"], function (props) {
    return props.fill && propUtils_1.formatColor(props.fill) || pick_1.default({
      enterprise: {
        light: variables_1.default.gray80,
        dark: variables_1.default.gray25
      },
      prisma: variables_1.default.backgroundColorSidebar
    })(props);
  }, function (props) {
    return props.stroke && propUtils_1.formatColor(props.stroke) || pick_1.default({
      enterprise: {
        dark: variables_1.default.gray80,
        light: variables_1.default.textColor
      },
      prisma: variables_1.default.neutral500
    })(props);
  }, function (props) {
...
exports.getStyledShape = getStyledShape;
