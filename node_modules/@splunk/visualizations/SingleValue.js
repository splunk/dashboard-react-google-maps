...
/* harmony import */ var _splunk_visualizations_shared_numberUtils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24);
...
/* harmony import */ var _splunk_visualizations_shared_domUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
...
/* harmony import */ var _splunk_visualizations_shared_propUtils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17);
...
/* harmony import */ var _splunk_visualizations_shared_colorConstants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(38);
...
var getTrendText = function getTrendText(_ref6) {
  ...
  var value = trendValue;
  var showPercent = trendDisplay === 'percent';

  if (showPercent) {
    value = Number(majorValue) !== Number(trendValue) ? trendValue / (majorValue - trendValue) * 100 : 0;
  }

  var trendText = computeText({
    value: value,
    numberPrecision: numberPrecision,
    shouldUseThousandSeparators: shouldUseThousandSeparators,
    shouldAbbreviateTrendValue: shouldAbbreviateTrendValue
  });
  return showPercent ? "".concat(trendText, "%") : trendText;
};
/**
...
exports.themes = exports.computeVizProps = exports.PureSingleValue = exports.config = void 0;

var SingleValue_1 = __webpack_require__(249);

var withDashboardViz_1 = __webpack_require__(26);

var singleValueUtils_1 = __webpack_require__(15);

var config_1 = __webpack_require__(227);

exports.config = config_1.default;
exports.PureSingleValue = SingleValue_1.default;

var computeVizProps = function computeVizProps(_ref) {
  var themeFunc = _ref.themeFunc;
  var defaultThemeColorVariables = ['defaultFontColor', 'defaultBackgroundColor', 'defaultBlockFontColor', 'defaultSparklineStrokeColor', 'sparklineSeverityColors'];
  ...
  if (typeof defaultThemeColors.sparklineSeverityColors === 'string') {
    ...
    try {
      defaultThemeColors.sparklineSeverityColors = JSON.parse(defaultThemeColors.sparklineSeverityColors);
    } catch (e) {}
  }
...
var viz = withDashboardViz_1.default({
  ReactViz: SingleValue_1.default,
...
var PresetPalettes_1 = __webpack_require__(59);

var variables_1 = __webpack_require__(228);

var pick_1 = __webpack_require__(20);

var variables_2 = __webpack_require__(19);

var visualization_icons_1 = __webpack_require__(40);

var singleValueContext_1 = __webpack_require__(93);

var VizBehavior_1 = __webpack_require__(5);

var DynamicMajorColorEditor_1 = __webpack_require__(94);

var DynamicTrendColorEditor_1 = __webpack_require__(95);

var DynamicBackgroundColorEditor_1 = __webpack_require__(96);

var StaticMajorAndTrendLayout_1 = __webpack_require__(97);

var StaticMajorColorEditor_1 = __webpack_require__(98);

var StaticTrendColorEditor_1 = __webpack_require__(99);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "CONTENT_OVERFLOW_FADEOUT_AREA_PX", function() { return /* binding */ SingleValue_CONTENT_OVERFLOW_FADEOUT_AREA_PX; });
__webpack_require__.d(__webpack_exports__, "DEFAULT_CONTENT_HEIGHT_ALLOCATION_RATIO", function() { return /* binding */ DEFAULT_CONTENT_HEIGHT_ALLOCATION_RATIO; });

// EXTERNAL MODULE: external "@babel/runtime/helpers/extends"
var extends_ = __webpack_require__(42);
...
var SizeAwareWrapper_ = __webpack_require__(18);
...
var VizStyleWrapper = __webpack_require__(56);

// EXTERNAL MODULE: external "@babel/runtime/helpers/defineProperty"
var defineProperty_ = __webpack_require__(6);
var defineProperty_default = /*#__PURE__*/__webpack_require__.n(defineProperty_);

// EXTERNAL MODULE: ./src/SingleValueBasic/SingleValueBasic.jsx + 2 modules
var SingleValueBasic = __webpack_require__(61);

// EXTERNAL MODULE: external "@splunk/react-sparkline/Line"
var Line_ = __webpack_require__(76);
var Line_default = /*#__PURE__*/__webpack_require__.n(Line_);

// EXTERNAL MODULE: external "@splunk/visualizations-shared/propUtils"
var propUtils_ = __webpack_require__(17);

// CONCATENATED MODULE: ./src/SingleValue/PureSingleValue/SingleValueSparkline.jsx





var SingleValueSparkline_SingleValueSparkline = function SingleValueSparkline(_ref) {
  var width = _ref.width,
      height = _ref.height,
      data = _ref.data,
      fill = _ref.fill,
      _ref$fillOpacity = _ref.fillOpacity,
      fillOpacity = _ref$fillOpacity === void 0 ? 0.2 : _ref$fillOpacity,
      stroke = _ref.stroke,
      showTooltip = _ref.showTooltip,
      isArea = _ref.isArea,
      _ref$lineLength = _ref.lineLength,
      lineLength = _ref$lineLength === void 0 ? 0 : _ref$lineLength,
      _ref$endDotCount = _ref.endDotCount,
      endDotCount = _ref$endDotCount === void 0 ? 0 : _ref$endDotCount,
      _ref$acceptNull = _ref.acceptNull,
      acceptNull = _ref$acceptNull === void 0 ? true : _ref$acceptNull;
  return /*#__PURE__*/external_react_default.a.createElement(Line_default.a, {
    lineColor: Object(propUtils_["formatColor"])(stroke),
    fillColor: Object(propUtils_["formatColor"])(fill),
    ...
    endDotStroke: Object(propUtils_["formatColor"])(stroke),
    endDotFillColor: Object(propUtils_["formatColor"])(stroke),
...
SingleValueSparkline_SingleValueSparkline.propTypes = {
  acceptNull: external_prop_types_default.a.bool,
  data: external_prop_types_default.a.arrayOf(external_prop_types_default.a.number),
  endDotCount: external_prop_types_default.a.number,
  fill: external_prop_types_default.a.string,
  fillOpacity: external_prop_types_default.a.number,
  ...
  stroke: external_prop_types_default.a.string,
  width: external_prop_types_default.a.number
};
/* harmony default export */ var PureSingleValue_SingleValueSparkline = (SingleValueSparkline_SingleValueSparkline);
// EXTERNAL MODULE: external "@splunk/visualizations-shared/colorConstants"
var colorConstants_ = __webpack_require__(38);

// EXTERNAL MODULE: external "@splunk/visualizations-shared/numberUtils"
var numberUtils_ = __webpack_require__(24);

// EXTERNAL MODULE: ./src/common/utils/singleValueUtils.js
var singleValueUtils = __webpack_require__(15);

// CONCATENATED MODULE: ./src/SingleValue/PureSingleValue/utils/displayUtils.js



var CONTENT_NEXT_TO_SPARKLINE_WIDTH_ALLOCATION_RATIO = 0.4;
var LINEHEIGHT_FACTOR = 1.2;
var CONTENT_SPARKLINE_SPACING = 16;
var VALID_SPARKLINE_POSITIONS = ['below', 'before', 'after', 'off'];
/*
...
var getUnderLabelHeight = function getUnderLabelHeight(_ref) {
  var underLabel = _ref.underLabel,
      underLabelFontSize = _ref.underLabelFontSize;
  return underLabel && underLabel.length ? underLabelFontSize * LINEHEIGHT_FACTOR : 0;
};
/**
...
var getAvailableContentWidth = function getAvailableContentWidth(_ref2) {
  var hasSparkline = _ref2.hasSparkline,
      isSparklinePositionBelow = _ref2.isSparklinePositionBelow,
      containerWidth = _ref2.containerWidth,
      overflowArea = _ref2.overflowArea;
  var overflowTotalArea = 2 * overflowArea; // left and right overflow
...
var getAvailableContentHeight = function getAvailableContentHeight(_ref3) {
  var height = _ref3.height,
      hasSparkline = _ref3.hasSparkline,
      isSparklinePositionBelow = _ref3.isSparklinePositionBelow,
      majorTextFontSize = _ref3.majorTextFontSize,
      _ref3$underLabelHeigh = _ref3.underLabelHeight,
      underLabelHeight = _ref3$underLabelHeigh === void 0 ? 0 : _ref3$underLabelHeigh;
...
var isValidPosition = function isValidPosition(sparklinePosition) {
  return VALID_SPARKLINE_POSITIONS.indexOf(sparklinePosition) > -1;
};
/**
...
var displayUtils_parseSparklineValues = function parseSparklineValues(_ref4) {
  var sparklineValues = _ref4.sparklineValues;
  return (// todo: need this function to maitain the behavior for dashboard-viz and react-viz.
    // can refactor it after we discard dashboard-viz and react-viz repo
    Array.isArray(sparklineValues) ? sparklineValues.map(function (v) {
      var numV = Object(numberUtils_["parseNumber"])(v);
...
var displayUtils_shouldShowSparkline = function shouldShowSparkline(_ref5) {
  var showSparkline = _ref5.showSparkline,
      sparklineValues = _ref5.sparklineValues;
  return showSparkline && Array.isArray(sparklineValues) && sparklineValues.length > 1 && sparklineValues.every(function (v) {
    return v === null || !Number.isNaN(Object(numberUtils_["parseNumber"])(v));
  }) && sparklineValues.filter(function (v) {
    return v !== null;
  }).length > 0;
}; // don't show sparkline if all values are null
...
var getSparklineWidth = function getSparklineWidth(_ref6) {
  var width = _ref6.width,
      isSparklinePositionBelow = _ref6.isSparklinePositionBelow;
  var spaceRatio = isSparklinePositionBelow ? 1 : 0.6;
...
var getSparklineHeight = function getSparklineHeight(_ref7) {
  var height = _ref7.height,
      contentHeight = _ref7.contentHeight,
      isSparklinePositionBelow = _ref7.isSparklinePositionBelow;
  return isSparklinePositionBelow ? height - contentHeight : height;
};
/*
...
var getSparklineSegments = function getSparklineSegments(_ref8) {
  var hasSparkline = _ref8.hasSparkline,
      sparklineHighlightSegments = _ref8.sparklineHighlightSegments;
  return hasSparkline && typeof sparklineHighlightSegments === 'number' && sparklineHighlightSegments > 0 ? sparklineHighlightSegments + 1 : 0;
};
/*
 * getEndDots
 * @param {Object} props
...
var getEndDots = function getEndDots(_ref9) {
  var hasSparkline = _ref9.hasSparkline,
      sparklineHighlightDots = _ref9.sparklineHighlightDots;
  return !hasSparkline || typeof sparklineHighlightDots === 'string' || sparklineHighlightDots < 0 ? 0 : sparklineHighlightDots;
};
/**
...
var displayUtils_getSparklineColors = function getSparklineColors(_ref10) {
  var backgroundEnabled = _ref10.backgroundEnabled,
      backgroundColor = _ref10.backgroundColor,
      sparklineSeverityColors = _ref10.sparklineSeverityColors;
  return Object(singleValueUtils["getGraphColors"])({
    backgroundEnabled: backgroundEnabled,
    backgroundColor: backgroundColor,
    defaultColors: sparklineSeverityColors,
    customColorFormatter: function customColorFormatter(color) {
      if (color === colorConstants_["SPARKLINE_WHITE"]) {
        return sparklineSeverityColors.none;
      }

      return {
        background: Object(singleValueUtils["darken"])(color),
        stroke: colorConstants_["SPARKLINE_WHITE"]
      };
    }
  });
};
...
var getSparklines = function getSparklines(_ref11) {
  var width = _ref11.width,
      height = _ref11.height,
      contentHeight = _ref11.contentHeight,
      hasSparkline = _ref11.hasSparkline,
      isSparklinePositionBelow = _ref11.isSparklinePositionBelow,
      sparklineHighlightSegments = _ref11.sparklineHighlightSegments,
      sparklineHighlightDots = _ref11.sparklineHighlightDots;
  var sparklineWidth = getSparklineWidth({
    width: width,
    isSparklinePositionBelow: isSparklinePositionBelow
  });
  var sparklineHeight = getSparklineHeight({
    height: height,
    contentHeight: contentHeight,
    isSparklinePositionBelow: isSparklinePositionBelow
  });
  var sparklineSegments = getSparklineSegments({
    hasSparkline: hasSparkline,
    sparklineHighlightSegments: sparklineHighlightSegments
  });
  var endDots = getEndDots({
    hasSparkline: hasSparkline,
    sparklineHighlightDots: sparklineHighlightDots
  });
  return {
...
// CONCATENATED MODULE: ./src/SingleValue/PureSingleValue/StandardLayout.jsx
...
var CONTENT_OVERFLOW_FADEOUT_AREA_PX = 16;
var Column = external_styled_components_default.a.div.withConfig({
  displayName: "StandardLayout__Column",
  componentId: "isgrrp-0"
})(["display:flex;flex-direction:column;height:100%;width:100%;justify-content:center;"]);
var Row = external_styled_components_default.a.div.withConfig({
  displayName: "StandardLayout__Row",
  componentId: "isgrrp-1"
})(["display:flex;flex-direction:row;"]);
var OverflowWrapper = external_styled_components_default.a.div.attrs(function () {
  return {
    'data-test': 'overflowWrapper'
  };
}).withConfig({
  displayName: "StandardLayout__OverflowWrapper",
  componentId: "isgrrp-2"
})(["box-sizing:border-box;padding-left:16px;padding-right:16px;width:100%;height:", "px;position:relative;display:flex;align-items:start;justify-content:center;&:after,&:before{position:absolute;height:100%;width:", "px;content:'';top:0;}&:after{right:0;background:linear-gradient( 90deg,", "00,", " );}&:before{left:0;background:linear-gradient( -90deg,", "00,", " );}"], function (props) {
  return props.height;
}, CONTENT_OVERFLOW_FADEOUT_AREA_PX, function (props) {
  return props.overflowBackgroundColor;
}, function (props) {
  return props.overflowBackgroundColor;
}, function (props) {
  return props.overflowBackgroundColor;
...
var StandardLayout_SingleValueContent = function SingleValueContent(_ref) {
  ...
  var backgroundColor = props.backgroundColor,
      ...
      sparklinePosition = props.sparklinePosition,
      sparklineWidth = props.sparklineWidth,
      sparklineHeight = props.sparklineHeight,
      sparklineValues = props.sparklineValues,
      sparklineAreaColor = props.sparklineAreaColor,
      sparklineStrokeColor = props.sparklineStrokeColor,
      showSparklineTooltip = props.showSparklineTooltip,
      showSparklineAreaGraph = props.showSparklineAreaGraph,
      shouldSparklineAcceptNullData = props.shouldSparklineAcceptNullData,
      sparklineSegments = props.sparklineSegments,
      endDots = props.endDots;
  var sparkline = null;

  if (displayUtils_shouldShowSparkline({
    showSparkline: showSparkline,
    sparklineValues: sparklineValues
  })) {
    sparkline = /*#__PURE__*/external_react_default.a.createElement(PureSingleValue_SingleValueSparkline, {
  ...
  return /*#__PURE__*/external_react_default.a.createElement(Column, null, /*#__PURE__*/external_react_default.a.createElement(Row, null, sparklinePosition === 'before' && sparkline, /*#__PURE__*/external_react_default.a.createElement(OverflowWrapper, {
    overflowBackgroundColor: backgroundColor,
    height: contentHeight
  }, /*#__PURE__*/external_react_default.a.createElement(SingleValueBasic["default"], {
    majorColor: majorColor,
    majorText: majorText,
    majorTextFontSize: majorTextFontSize,
    majorValueTitle: majorValueTitle,
  ...
  })), sparklinePosition === 'after' && sparkline), sparklinePosition === 'below' && sparkline);
};

StandardLayout_SingleValueContent.propTypes = _objectSpread(_objectSpread({}, SingleValueBasic["default"].propTypes), {}, {
  contentHeight: external_prop_types_default.a.number,
  backgroundColor: external_prop_types_default.a.string,
  showSparkline: external_prop_types_default.a.bool,
  sparklinePosition: external_prop_types_default.a.oneOf(VALID_SPARKLINE_POSITIONS),
  sparklineWidth: external_prop_types_default.a.number,
  sparklineHeight: external_prop_types_default.a.number,
  sparklineValues: external_prop_types_default.a.arrayOf(external_prop_types_default.a.oneOfType([external_prop_types_default.a.string, external_prop_types_default.a.number])),
  sparklineAreaColor: external_prop_types_default.a.string,
  sparklineStrokeColor: external_prop_types_default.a.string,
  showSparklineTooltip: external_prop_types_default.a.bool,
  showSparklineAreaGraph: external_prop_types_default.a.bool,
  shouldSparklineAcceptNullData: external_prop_types_default.a.bool,
  sparklineSegments: external_prop_types_default.a.number,
  endDots: external_prop_types_default.a.number
});
/* harmony default export */ var StandardLayout = (StandardLayout_SingleValueContent);
// CONCATENATED MODULE: ./src/SingleValue/PureSingleValue/SingleValue.jsx
...
var SingleValue_CONTENT_OVERFLOW_FADEOUT_AREA_PX = 16;
var DEFAULT_CONTENT_HEIGHT_ALLOCATION_RATIO = 0.8;
var DEFAULT_SPARKLINE_SEVERITY_COLORS = {
  none: {
    background: '#818d99',
    stroke: '#171d21'
  },
...
var Container = external_styled_components_default.a.div.withConfig({
  displayName: "SingleValue__Container",
  componentId: "sc-19822k8-0"
})(["overflow:hidden;", ";"], function (props) {
  return Object(style_["toDimension"])(pick_default()(props, ['width', 'height']));
});

var SingleValue_SingleValue = function SingleValue(_ref) {
  var props = extends_default()({}, _ref);
  ...
  var width = props.width,
      ...
      sparklineValues = props.sparklineValues,
      sparklineHighlightSegments = props.sparklineHighlightSegments,
      sparklineHighlightDots = props.sparklineHighlightDots,
      showSparklineAreaGraph = props.showSparklineAreaGraph,
      showSparklineTooltip = props.showSparklineTooltip,
      shouldSparklineAcceptNullData = props.shouldSparklineAcceptNullData,
      onValueClick = props.onValueClick,
      ...
      _props$sparklineSever = props.sparklineSeverityColors,
      sparklineSeverityColors = _props$sparklineSever === void 0 ? DEFAULT_SPARKLINE_SEVERITY_COLORS : _props$sparklineSever,
      sparklineAreaColor = props.sparklineAreaColor;
  var defaultColors = {
    defaultFontColor: defaultFontColor,
    defaultBackgroundColor: defaultBackgroundColor,
    defaultBlockFontColor: defaultBlockFontColor,
    sparklineSeverityColors: sparklineSeverityColors
  };
  ...
  }, [onValueClick, majorValue, majorValueField, trendValue]); // FIXME todo 'compute colors' is not pure, it must be lifted into behavior or DSL
  // compute colors

  var _computeColors = Object(singleValueUtils["computeColors"])(props, defaultColors),
      backgroundEnabled = _computeColors.backgroundEnabled,
      backgroundColor = _computeColors.backgroundColor,
      majorColor = _computeColors.majorColor,
      trendColor = _computeColors.trendColor,
      underLabelColor = _computeColors.underLabelColor; // TODO(fkurniawan): possibly remove getSparklineColors, since for the new viz package,
  // the default is obtained from > themes.defaultSparklineStrokeColor


  var sparklineStrokeColor = props.sparklineStrokeColor || displayUtils_getSparklineColors({
    backgroundEnabled: backgroundEnabled,
    backgroundColor: backgroundColor,
    sparklineSeverityColors: sparklineSeverityColors
  }).stroke;
  ...
  var renderVisualization = function renderVisualization(_ref2) {
    ...
    if (containerWidth < 35 || containerHeight < 35) {
      return /*#__PURE__*/external_react_default.a.createElement(Message_default.a, {
        width: containerWidth,
        height: containerHeight,
        message: Object(i18n_["_"])('Too small to render content'),
        level: "info"
      });
    } // will update later based on text size


    var _props$sparklineDispl = props.sparklineDisplay,
        sparklineDisplay = _props$sparklineDispl === void 0 ? 'below' : _props$sparklineDispl,
        _props$trendDisplay = props.trendDisplay,
        trendDisplay = _props$trendDisplay === void 0 ? 'absolute' : _props$trendDisplay,
        unit = props.unit,
        underLabel = props.underLabel; // todo: need this function to maitain the behavior for dashboard-viz and react-viz.
    // can refactor it after we discard dashboard-viz and react-viz repo

    var parsedSparklineValues = displayUtils_parseSparklineValues({
      sparklineValues: sparklineValues
    });
    var hasSparkline = displayUtils_shouldShowSparkline({
    ...
    var isSparklinePositionBelow = hasSparkline && sparklineDisplay === 'below';
    var contentWidth = getAvailableContentWidth({
      hasSparkline: hasSparkline,
      isSparklinePositionBelow: isSparklinePositionBelow,
      containerWidth: containerWidth,
      overflowArea: SingleValue_CONTENT_OVERFLOW_FADEOUT_AREA_PX
    }); // calculate major and trend text and font size

    var toRemoveList = [{
      key: 'sparklineDisplay',
      value: 'off'
    }, {
      key: 'underLabel',
      value: ''
    ...
    if (!isEmpty_default()(smallVizProps)) {
      sparklineDisplay = smallVizProps.sparklineDisplay;
      trendDisplay = smallVizProps.trendDisplay;
      unit = smallVizProps.unit;
      underLabel = smallVizProps.underLabel;
      hasSparkline = displayUtils_shouldShowSparkline({
        showSparkline: isValidPosition(sparklineDisplay) && sparklineDisplay !== 'off',
        sparklineValues: parsedSparklineValues
      });
    }

    var contentHeight = getAvailableContentHeight({
      height: containerHeight,
      hasSparkline: hasSparkline,
      isSparklinePositionBelow: isSparklinePositionBelow,
      majorTextFontSize: majorTextFontSize,
      underLabelHeight: getUnderLabelHeight({
        underLabel: underLabel,
        underLabelFontSize: underLabelFontSize
      })
    }); // calculate sparkline size and positions

    var _getSparklines = getSparklines({
      width: containerWidth,
      height: containerHeight,
      contentHeight: contentHeight,
      hasSparkline: hasSparkline,
      ...
      sparklineHighlightDots: sparklineHighlightDots
        ...
        sparklineWidth = _getSparklines.sparklineWidth,
        sparklineHeight = _getSparklines.sparklineHeight,
        sparklineSegments = _getSparklines.sparklineSegments,
        endDots = _getSparklines.endDots;

    return /*#__PURE__*/external_react_default.a.createElement(VizStyleWrapper["default"], {
      backgroundColor: backgroundColor,
      style: style,
      dataTestKey: "SingleValueWrapper"
    }, /*#__PURE__*/external_react_default.a.createElement(StandardLayout, {
...
SingleValue_SingleValue.propTypes = {
  ...
  showSparklineTooltip: external_prop_types_default.a.bool,
  showSparklineAreaGraph: external_prop_types_default.a.bool,
  sparklineDisplay: external_prop_types_default.a.oneOf(VALID_SPARKLINE_POSITIONS),
  sparklineAreaColor: external_prop_types_default.a.string,
  sparklineStrokeColor: external_prop_types_default.a.string,
  shouldSparklineAcceptNullData: external_prop_types_default.a.bool,
  sparklineHighlightSegments: external_prop_types_default.a.number,
  sparklineHighlightDots: external_prop_types_default.a.number,
  onValueClick: external_prop_types_default.a.func,
  defaultFontColor: external_prop_types_default.a.string,
  defaultBackgroundColor: external_prop_types_default.a.string,
  defaultBlockFontColor: external_prop_types_default.a.string,
  sparklineSeverityColors: external_prop_types_default.a.object
};
SingleValue_SingleValue.defaultProps = {
  width: '100%',
  height: 250,
  majorValue: 'N/A',
  majorValueField: '',
  ...
  onValueClick: function onValueClick() {} // fixme todo: a pure viz should not be passed a map of severity colors! This should be resolved
  // by behaviors or DSL in future. Pure viz does not understand concepts such as severity.

};
/* harmony default export */ var PureSingleValue_SingleValue = __webpack_exports__["default"] = (SingleValue_SingleValue);
