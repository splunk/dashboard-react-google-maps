...
var Markdown_1 = __webpack_require__(186);
...
var Container = styled_components_1.default.div.withConfig({
  ...
  componentId: "zd3qkg-0"
})(["overflow:auto;position:relative;box-sizing:border-box;", ";", ";background-color:", ";& *:not(code):not(pre):not(code *):not(a){color:", ";}"], function (props) {
  return style_1.toDimension(lodash_1.pick(props, ['width', 'height']));
}, function (props) {
  return style_1.toMargin(props.margin);
}, function (props) {
...
var MarkdownVisualization = function MarkdownVisualization(_ref) {
  ...
  return React.createElement(Container, {
    ...
    backgroundColor: backgroundColor,
    fontColor: fontColor
  }, React.createElement(Markdown_1.default, {
    text: markdown
  }));
};
...
var Markdown = withDashboardViz_1.default({
  ReactViz: MarkdownVisualization,
...
var Markdown_1 = __webpack_require__(121);
...
var themes = {
  defaultFontColor: function defaultFontColor(props) {
    return themes_1.pick({
      ...
      prisma: themes_1.variables.contentColorDefault(props)
    })(props);
  }
};
var editorConfig = [{
  label: i18n_1._('Markdown Settings'),
  open: true,
  layout: [[{
    label: '',
    option: 'markdown',
  ...
  }].concat(_toConsumableArray(BackgroundColor_1.default({
...
var config = {
  ...
  supports: [VizBehavior_1.VizBehavior.DYNAMIC_OPTIONS],
  themes: themes
};
