...
module.exports = require("@splunk/react-ui/Multiselect");
...
var uniqBy_1 = __importDefault(__webpack_require__(26));
var isEmpty_1 = __importDefault(__webpack_require__(27));
var differenceBy_1 = __importDefault(__webpack_require__(28));
var Base_1 = __webpack_require__(29);
var dashboard_utils_1 = __webpack_require__(30);
...
exports.default = {
    ...
    extend: {
        ...
        anyOf: [
            {
                properties: __assign({ selectFirstSearchResult: {
            ...
            },
            {
                properties: __assign({ selectFirstSearchResult: {
                    ...
                    defaultValue: false }, commonProperties),
                additionalProperties: false,
            },
        ],
    },
...
var RadioBar_1 = __importDefault(__webpack_require__(36));
var ComboBoxEditor_1 = __importDefault(__webpack_require__(37));
var MultiselectDefaultValueEditor_1 = __importDefault(__webpack_require__(38));
var DEFAULT_VALUE_TYPE_DESCRIPTION = {
    defined: i18n_1._('Assigns the user defined values as the default'),
    first: i18n_1._('Assigns the first value as the default'),
    none: i18n_1._('No value will be assigned as the default'),
};
var DefaultSelectedValueEditor = function (_a) {
    var options = _a.options, context = _a.context, onChange = _a.onChange, defaultValue = _a.value, isMultiselect = _a.isMultiselect;
    var valueType = 'none';
    ...
    var staticItems = react_1.useMemo(function () {
        if (Array.isArray(options.items)) {
            return options.items;
        }
        var _a = context.statics, statics = _a === void 0 ? [[], []] : _a;
        return lodash_1.zipWith.apply(void 0, __spread(statics, [function (_l, v) { return ({
                value: v,
            }); }]));
    }, [options, context]);
    var handleValueTypeChange = react_1.useCallback(function (event, _a) {
        var type = _a.value;
        var newDefaultValue = type === 'defined' ? '' : undefined;
        var newSelectFirstSearchResult = type === 'first' ? true : undefined;
        onChange(event, {
            options: {
    ...
    var handleDefaultValueChange = react_1.useCallback(function (event, updatedValue) {
        onChange(event, {
            options: {
    ...
    var selectedValueInput = react_1.useMemo(function () {
        if (valueType !== 'defined') {
            return null;
        }
        var DefaultValueEditor = isMultiselect
            ? MultiselectDefaultValueEditor_1.default
            : ComboBoxEditor_1.default;
        return (react_1.default.createElement(ControlGroup_1.default, { label: i18n_1._('Choose a Default Value'), labelPosition: "top", hideLabel: true, controlsLayout: "none" },
            react_1.default.createElement(DefaultValueEditor, { value: defaultValue, onChange: handleDefaultValueChange, options: staticItems, placeholder: i18n_1._('Choose or type a default value...') })));
    }, [
        isMultiselect,
        valueType,
        defaultValue,
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(ControlGroup_1.default, { label: i18n_1._('Default Selected Value'), labelPosition: "top", hideLabel: true, help: DEFAULT_VALUE_TYPE_DESCRIPTION[valueType] },
            react_1.default.createElement(RadioBar_1.default, { "data-test": "default-selected-value-type", onChange: handleValueTypeChange, value: valueType },
                react_1.default.createElement(RadioBar_1.default.Option, { label: i18n_1._('Choose Default'), value: "defined" }),
                react_1.default.createElement(RadioBar_1.default.Option, { label: i18n_1._('First Value'), value: "first" }),
                react_1.default.createElement(RadioBar_1.default.Option, { label: i18n_1._('None'), value: "none" }))),
        selectedValueInput));
};
exports.default = DefaultSelectedValueEditor;
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importStar(__webpack_require__(1));
var without_1 = __importDefault(__webpack_require__(9));
var i18n_1 = __webpack_require__(0);
var difference_1 = __importDefault(__webpack_require__(10));
var isEqual_1 = __importDefault(__webpack_require__(11));
var mapKeys_1 = __importDefault(__webpack_require__(12));
var dashboard_icons_1 = __webpack_require__(2);
var Multiselect_1 = __importDefault(__webpack_require__(3));
var enhancer_1 = __webpack_require__(13);
var inputItem_1 = __webpack_require__(5);
var BaseInput_1 = __importDefault(__webpack_require__(32));
var MultiselectSchema_1 = __importDefault(__webpack_require__(6));
var MultiselectEditorConfig_1 = __importDefault(__webpack_require__(34));
var noItems = [];
...
var toValue = function (arr) { return (arr ? arr.join(',') : ''); };
/**
 * We use SUI Multiselect under the hood to render the input
 */
var Multiselect = function (_a) {
    var value = _a.value, _b = _a.context, context = _b === void 0 ? {} : _b, _c = _a.options, _d = _c.items, items = _d === void 0 ? [] : _d, defaultValue = _c.defaultValue, _e = _c.clearDefaultOnSelection, clearDefaultOnSelection = _e === void 0 ? true : _e, _f = _c.selectFirstSearchResult, selectFirstSearchResult = _f === void 0 ? false : _f, _g = _a.dataSources, dataSources = _g === void 0 ? {} : _g, encoding = _a.encoding, onValueChange = _a.onValueChange, isLoading = _a.loading, isError = _a.isError, errorMessage = _a.errorMessage, initialDisabledStatus = _a.isDisabled, initialDisabledMessaged = _a.disabledMessage;
    var searchHasNoResults = inputItem_1.getSearchStatus(dataSources);
    var defaultValueArray = react_1.useMemo(function () { return (defaultValue ? parseValue(defaultValue) : noItems); }, [defaultValue]);
    // defaultValue should be null as it can evaluate to static items if the values are not presented in the item list
    var isDisabled = initialDisabledStatus || (searchHasNoResults && defaultValue == null);
    var disabledMessage = isDisabled && (initialDisabledMessaged || i18n_1._('No search results'));
    ...
    var _h = react_1.useMemo(function () {
        ...
        var hasDynamicItems = inputItem_1.hasDynamicOptions([items]);
        var dynamicItems = inputItem_1.fetchDynamicContent({
            context: context,
            items: items,
        ...
        var firstResult = selectFirstSearchResult && dynamicItems.length > 0
            ? [dynamicItems[0].value]
            : noItems;
        // Merge dynamic and static values
        var staticItems = hasDynamicItems ? noItems : items;
        var mergedItems = inputItem_1.mergeItems({
            dynamicItems: dynamicItems,
        ...
        var validItems = mergedItems.filter(function (item) { return !!item.value; });
    ...
    ]), menuItems = _h.menuItems, firstSearchResult = _h.firstSearchResult;
    ...
    var selectedValues = react_1.useMemo(function () {
    ...
    var multiselectOptions = react_1.useMemo(function () {
        return menuItems.map(function (_a) {
            var label = _a.label, val = _a.value;
            return (react_1.default.createElement(Multiselect_1.default.Option, { label: label, value: val, key: val }));
        });
    }, [menuItems]);
    var placeholder = react_1.useMemo(function () {
        return i18n_1._(errorMessage || disabledMessage || 'Select a value');
    }, [disabledMessage, errorMessage]);
    var loadingMessage = i18n_1._('Loading menu items...');
    // onChange handler for multiselect, dereferences the item value from SUI payload
    var handleValueChange = react_1.useCallback(function (evt, _a) {
        ...
        var isSelectAllClicked = isEqual_1.default(__spread(values).sort(), menuItems.map(function (item) { return item.value; }).sort());
        // special case: we want to clear default value when user selects a new value
        var hasDefaultValue = defaultValueArray.length > 0;
        var isNonDefaultValueSelected = difference_1.default(values, defaultValueArray).length > 0;
        var wasOnlyDefaultValueSelected = isEqual_1.default(__spread(selectedValues).sort(), __spread(defaultValueArray).sort());
        var shouldClearDefaultValue = clearDefaultOnSelection &&
            hasDefaultValue &&
            isNonDefaultValueSelected &&
            wasOnlyDefaultValueSelected &&
            !isSelectAllClicked;
        var newValues = shouldClearDefaultValue
            ? without_1.default.apply(void 0, __spread([values], defaultValueArray)) : values;
    ...
    return (react_1.default.createElement(Multiselect_1.default, { values: selectedValues, onChange: handleValueChange, placeholder: placeholder, disabled: isDisabled || isError, isLoadingOptions: isLoading, loadingMessage: loadingMessage, compact: true, defaultPlacement: "below" }, multiselectOptions));
};
/**
 ...
 * @returns {Object}
 */
Multiselect.valueToTokens = function (value, _a) {
    var _b, _c;
    var token = _a.token;
    if (!token) {
        return {};
...
Multiselect.propTypes = __assign({}, BaseInput_1.default.propTypes);
Multiselect.defaultProps = __assign({}, BaseInput_1.default.defaultProps);
var meta = {
    label: i18n_1._('Multiselect'),
    description: i18n_1._('Select multiple list values'),
    defaultConfig: {
        options: {
            items: [
                { label: i18n_1._('All'), value: '*' },
                { label: i18n_1._('Item 1'), value: 'item001' },
                { label: i18n_1._('Item 2'), value: 'item002' },
                { label: i18n_1._('Item 3'), value: 'item003' },
            ],
            defaultValue: 'item001,item002',
        },
        title: i18n_1._('Multiselect Input Title'),
    },
    tokenPrefix: 'ms',
    icon: dashboard_icons_1.MultiselectInput,
};
Multiselect.config = __assign({ optionsSchema: MultiselectSchema_1.default, editorConfig: MultiselectEditorConfig_1.default, dataContract: inputItem_1.dataContract }, mapKeys_1.default(meta, function (value, key) {
    return key === 'defaultConfig' ? 'baseShape' : key;
}));
exports.default = enhancer_1.withInputWrapper(Multiselect);
...
var react_1 = __importStar(__webpack_require__(1));
var styled_components_1 = __importDefault(__webpack_require__(14));
var i18n_1 = __webpack_require__(0);
var get_1 = __importDefault(__webpack_require__(15));
var lodash_1 = __webpack_require__(4);
var react_sortable_hoc_1 = __webpack_require__(16);
var Remove_1 = __importDefault(__webpack_require__(17));
var Warning_1 = __importDefault(__webpack_require__(18));
var Tooltip_1 = __importDefault(__webpack_require__(19));
var Clickable_1 = __importDefault(__webpack_require__(20));
var dashboard_context_1 = __webpack_require__(21);
var themes_1 = __webpack_require__(22);
var riskyCommandUtils_1 = __webpack_require__(23);
var RiskyWarningPopover_1 = __importDefault(__webpack_require__(24));
var OptionalTooltip_1 = __importDefault(__webpack_require__(25));
var dashboard_icons_1 = __webpack_require__(2);
var inputItem_1 = __webpack_require__(5);
...
Object.defineProperty(exports, "__esModule", { value: true });
var prop_types_1 = __importDefault(__webpack_require__(33));
var noop = function () { };
...
Object.defineProperty(exports, "__esModule", { value: true });
var i18n_1 = __webpack_require__(0);
var DefaultSelectedValueEditor_1 = __importDefault(__webpack_require__(7));
var DropdownEditorConfig_1 = __webpack_require__(39);
exports.default = __spread(DropdownEditorConfig_1.BaseEditor, [
    {
        label: i18n_1._('Default Selected Values'),
            ...
            [
                {
                    ...
                    option: 'defaultValue',
                    context: 'statics',
                    editor: DefaultSelectedValueEditor_1.default,
...
module.exports = require("@splunk/react-ui/RadioBar");

/***/ }),
/* 37 */
/***/ (function(module, exports) {

module.exports = require("@splunk/dashboard-ui/ComboBoxEditor");
 ...
 */
var MultiselectDefaultValueEditor = function (_a) {
    var value = _a.value, options = _a.options, placeholder = _a.placeholder, onChange = _a.onChange;
    var handleChange = react_1.useCallback(function (evt, _a) {
        var values = _a.values;
    ...
    var multiselectOptions = react_1.useMemo(function () {
        return options.map(function (_a) {
            var v = _a.value;
            return (react_1.default.createElement(Multiselect_1.default.Option, { key: v, label: v, value: v }));
        });
    }, [options]);
    return (react_1.default.createElement(Multiselect_1.default, { values: uniqueValues, onChange: handleChange, placeholder: placeholder, allowNewValues: true }, multiselectOptions));
};
exports.default = MultiselectDefaultValueEditor;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.BaseEditor = exports.DynamicItemEditorConfig = exports.StaticItemEditorConfig = void 0;
var i18n_1 = __webpack_require__(0);
var DefaultSelectedValueEditor_1 = __importDefault(__webpack_require__(7));
exports.StaticItemEditorConfig = {
    label: '',
    option: 'items',
...
exports.DynamicItemEditorConfig = {
    label: i18n_1._('Dynamic Menu Configuration'),
    option: 'items',
    context: 'statics',
    ...
    editorProps: {
        help: i18n_1._('Advanced configuration options are being used by this input. Please edit in source mode.'),
    },
};
exports.BaseEditor = [
    {
    ...
    {
        label: i18n_1._('Menu Configuration'),
        enableCollapsible: true,
        enableSeparator: true,
        layout: [[exports.DynamicItemEditorConfig]],
    },
];
exports.default = __spread(exports.BaseEditor, [
    {
        label: i18n_1._('Default Selected Values'),
        enableSeparator: false,
        layout: [
...
var Multiselect_1 = __webpack_require__(8);
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return __importDefault(Multiselect_1).default; } });
