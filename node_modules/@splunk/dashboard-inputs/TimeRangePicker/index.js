...
var Dropdown_1 = __importDefault(__webpack_require__(31));
...
var dashboard_telemetry_1 = __webpack_require__(33);
var get_1 = __importDefault(__webpack_require__(4));
var dashboard_icons_1 = __webpack_require__(6);
var BaseInput_1 = __importDefault(__webpack_require__(34));
...
var enhancer_1 = __webpack_require__(10);
var DefaultTimeRangeConnector_1 = __importDefault(__webpack_require__(28));
var BaseTimeRange_1 = __webpack_require__(7);
var TRPEditor_1 = __importDefault(__webpack_require__(35));
var TimeRangePicker = function (props) {
    return (react_1.default.createElement(DefaultTimeRangeConnector_1.default, null,
        react_1.default.createElement(BaseTimeRange_1.BaseTimeRangePicker, __assign({}, props))));
};
TimeRangePicker.valueToTokens = BaseTimeRange_1.BaseTimeRangePicker.valueToTokens;
TimeRangePicker.tokensToValue = BaseTimeRange_1.BaseTimeRangePicker.tokensToValue;
var editor = [
    {
            ...
            [
                {
                    ...
                    editorProps: {
                        Connector: DefaultTimeRangeConnector_1.default,
                    },
                },
            ],
        ],
...
TimeRangePicker.config = __assign({ editorConfig: editor, optionsSchema: BaseTimeRange_1.BaseTimeRangePicker.config.schema }, mapKeys_1.default(BaseTimeRange_1.BaseTimeRangePicker.config.meta, function (value, key) {
    return key === 'defaultConfig' ? 'baseShape' : key;
}));
exports.default = enhancer_1.withInputWrapper(TimeRangePicker);
...
var react_sortable_hoc_1 = __webpack_require__(12);
var Remove_1 = __importDefault(__webpack_require__(13));
var Warning_1 = __importDefault(__webpack_require__(14));
var Tooltip_1 = __importDefault(__webpack_require__(15));
var Clickable_1 = __importDefault(__webpack_require__(16));
var dashboard_context_1 = __webpack_require__(5);
var themes_1 = __webpack_require__(17);
var riskyCommandUtils_1 = __webpack_require__(18);
var RiskyWarningPopover_1 = __importDefault(__webpack_require__(19));
var OptionalTooltip_1 = __importDefault(__webpack_require__(20));
var dashboard_icons_1 = __webpack_require__(6);
var inputItem_1 = __webpack_require__(21);
...
var uniqBy_1 = __importDefault(__webpack_require__(22));
var isEmpty_1 = __importDefault(__webpack_require__(23));
var differenceBy_1 = __importDefault(__webpack_require__(24));
var Base_1 = __webpack_require__(25);
var dashboard_utils_1 = __webpack_require__(26);
...
var react_1 = __importStar(__webpack_require__(0));
var prop_types_1 = __importDefault(__webpack_require__(1));
var promise_1 = __webpack_require__(29);
var time_1 = __webpack_require__(30);
var parsePromise = function (time) { return Promise.resolve(time_1.parse(time)); };
var DefaultTimeRangeConnector = function (_a) {
    var children = _a.children;
    var _b = __read(react_1.useState(null), 2), parseEarliest = _b[0], setParseEarliest = _b[1];
    var _c = __read(react_1.useState(null), 2), parseLatest = _c[0], setParseLatest = _c[1];
    var cancelableEarliestTimeParser = react_1.useRef(null);
    var cancelableLatestTimeParser = react_1.useRef(null);
    react_1.useEffect(function () {
        // cancel on unmount
        return function () {
    ...
    var handleRequestParseEarliest = react_1.useCallback(function (time) {
        if (cancelableEarliestTimeParser.current) {
            cancelableEarliestTimeParser.current.cancel();
        }
        // Wrap with a cancelable promise
        cancelableEarliestTimeParser.current = promise_1.makeCancelable(parsePromise(time));
    ...
    var handleRequestParseLatest = react_1.useCallback(function (time) {
        if (cancelableLatestTimeParser.current) {
            cancelableLatestTimeParser.current.cancel();
        }
        // Wrap with a cancelable promise
        cancelableLatestTimeParser.current = promise_1.makeCancelable(parsePromise(time));
        // Call set state when promise resolves
    ...
    return react_1.cloneElement(react_1.default.Children.only(children), {
        presets: time_1.defaultTimePreset,
        parseEarliest: parseEarliest,
...
exports.default = DefaultTimeRangeConnector;
...
var ControlGroup_1 = __importDefault(__webpack_require__(37));
var styled_components_1 = __importDefault(__webpack_require__(3));
var BaseTimeRange_1 = __webpack_require__(7);
...
var TimeRangePicker_1 = __webpack_require__(8);
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return __importDefault(TimeRangePicker_1).default; } });
