...
var Number_1 = __importDefault(__webpack_require__(7));
var dashboard_icons_1 = __webpack_require__(3);
var debounce_1 = __importDefault(__webpack_require__(8));
var get_1 = __importDefault(__webpack_require__(4));
var mapKeys_1 = __importDefault(__webpack_require__(9));
var BaseInput_1 = __importDefault(__webpack_require__(10));
var enhancer_1 = __webpack_require__(11);
var NumberSchema_1 = __importDefault(__webpack_require__(5));
var NumberInput = function (_a) {
    var id = _a.id, _b = _a.options, min = _b.min, max = _b.max, step = _b.step, defaultValue = _b.defaultValue, value = _a.value, onValueChange = _a.onValueChange, isDisabled = _a.isDisabled, disabledMessage = _a.disabledMessage, errorMessage = _a.errorMessage, isError = _a.isError, isSelected = _a.isSelected;
    var handleChange = react_1.useMemo(function () { return debounce_1.default(function (e, payload) { return onValueChange(e, payload.value); }, 250); }, [onValueChange]);
    var consolidatedValue = value != null ? value : defaultValue;
    // if there is no value or defaultValue, show input as blank by passing null
    var displayValue = consolidatedValue != null ? Number(consolidatedValue) : null;
    ...
    return (react_1.default.createElement(Number_1.default, { min: min, max: max, step: step, error: isError, disabled: isDisabled, inputId: id, onChange: handleChange, 
        // we want to show disabled message if the input is disabled
        value: message ? null : displayValue, placeholder: message, 
...
NumberInput.propTypes = __assign(__assign({}, BaseInput_1.default.propTypes), { options: prop_types_1.default.shape({
...
NumberInput.defaultProps = __assign({}, BaseInput_1.default.defaultProps);
var editor = [
    {
...
var meta = {
    ...
    description: i18n_1._('Field to enter a number'),
    defaultConfig: {
        options: {
            defaultValue: 10,
        },
        title: i18n_1._('Number Input Title'),
    },
    tokenPrefix: 'num',
    icon: dashboard_icons_1.NumberInput,
};
NumberInput.config = __assign({ editorConfig: editor, optionsSchema: NumberSchema_1.default }, mapKeys_1.default(meta, function (value, key) {
 ...
 * @returns {Object}
 */
NumberInput.valueToTokens = function (value, _a) {
    var _b, _c;
    var token = _a.token;
    if (!token) {
        return {};
 ...
 * @returns {Number|null}
 */
NumberInput.tokensToValue = function (_a) {
    ...
    var value = Number(get_1.default(tokens, [tokenNamespace, tokenName]));
 ...
 * @returns {Object}
 */
NumberInput.validate = function (inputDef) {
    if (inputDef === void 0) { inputDef = {}; }
    var options = get_1.default(inputDef, 'options', {});
    var errorMessages = [];
...
exports.default = enhancer_1.withInputWrapper(NumberInput);
...
var dashboard_icons_1 = __webpack_require__(3);
var inputItem_1 = __webpack_require__(24);
...
var uniqBy_1 = __importDefault(__webpack_require__(25));
var isEmpty_1 = __importDefault(__webpack_require__(26));
var differenceBy_1 = __importDefault(__webpack_require__(27));
var Base_1 = __webpack_require__(28);
var dashboard_utils_1 = __webpack_require__(29);
var Options_1 = __webpack_require__(30);
...
Object.defineProperty(exports, "default", { enumerable: true, get: function () { return __importDefault(Number_1).default; } });
