...
var mapKeys_1 = __importDefault(__webpack_require__(6));
var Text_1 = __importDefault(__webpack_require__(7));
var dashboard_icons_1 = __webpack_require__(3);
var useTextInput_1 = __webpack_require__(8);
var enhancer_1 = __webpack_require__(9);
var BaseInput_1 = __importDefault(__webpack_require__(30));
var TextSchema_1 = __importDefault(__webpack_require__(4));
var TextInputIcon = function (props) { return (react_1.default.createElement(dashboard_icons_1.Text, __assign({ screenReaderText: i18n_1._('Text Input') }, props))); };
/**
 * We use SUI Text under the hood to render the input
 */
var Text = function (_a) {
    var id = _a.id, _b = _a.options, customPlaceholder = _b.placeholder, defaultValue = _b.defaultValue, committedValue = _a.value, onValueChange = _a.onValueChange, isDisabled = _a.isDisabled, disabledMessage = _a.disabledMessage, errorMessage = _a.errorMessage, isError = _a.isError, isSelected = _a.isSelected;
    var inputRef = react_1.useRef(null);
    var initialValue = committedValue || defaultValue || '';
    var placeholder = errorMessage || disabledMessage || customPlaceholder || '';
    var uniqKey = react_1.useMemo(function () { return ({ id: id }); }, [id]);
    var handleCommit = react_1.useCallback(function (val) { return onValueChange(null, val); }, [
        onValueChange,
    ]);
    ...
    }), onHandleBlur = _c.onHandleBlur, onHandleChange = _c.onHandleChange, onHandleKeyDown = _c.onHandleKeyDown, inputValue = _c.value;
    ...
    return (react_1.default.createElement(Text_1.default, { canClear: true, inputId: id, placeholder: placeholder, disabled: isDisabled, error: isError, value: inputValue, onChange: onHandleChange, onKeyDown: onHandleKeyDown, onBlur: onHandleBlur, 
 ...
 * @returns {Object}
 */
Text.valueToTokens = function (value, _a) {
    var _b, _c;
...
Text.propTypes = __assign(__assign({}, BaseInput_1.default.propTypes), { placeholder: prop_types_1.default.string });
Text.defaultProps = __assign({}, BaseInput_1.default.defaultProps);
var editor = [
    {
...
var meta = {
    label: i18n_1._('Text'),
    description: i18n_1._('Field to enter text'),
    defaultConfig: {
        options: {
            defaultValue: i18n_1._('Default Text'),
        },
...
Text.schema = TextSchema_1.default;
Text.editor = editor;
Text.meta = meta;
Text.config = __assign({ editorConfig: editor, optionsSchema: TextSchema_1.default }, mapKeys_1.default(meta, function (value, key) {
    return key === 'defaultConfig' ? 'baseShape' : key;
}));
exports.default = enhancer_1.withInputWrapper(Text);
...
module.exports = require("@splunk/dashboard-ui/hooks/useTextInput");
...
var react_1 = __importStar(__webpack_require__(0));
var styled_components_1 = __importDefault(__webpack_require__(10));
var i18n_1 = __webpack_require__(2);
var get_1 = __importDefault(__webpack_require__(11));
...
var dashboard_context_1 = __webpack_require__(18);
var themes_1 = __webpack_require__(19);
var riskyCommandUtils_1 = __webpack_require__(20);
var RiskyWarningPopover_1 = __importDefault(__webpack_require__(21));
var OptionalTooltip_1 = __importDefault(__webpack_require__(22));
var dashboard_icons_1 = __webpack_require__(3);
var inputItem_1 = __webpack_require__(23);
