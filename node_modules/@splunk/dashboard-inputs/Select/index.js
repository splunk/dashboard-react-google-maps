...
var uniqBy_1 = __importDefault(__webpack_require__(24));
var isEmpty_1 = __importDefault(__webpack_require__(25));
var differenceBy_1 = __importDefault(__webpack_require__(26));
var Base_1 = __webpack_require__(27);
var dashboard_utils_1 = __webpack_require__(28);
...
var Select_1 = __importDefault(__webpack_require__(7));
var i18n_1 = __webpack_require__(1);
var mapKeys_1 = __importDefault(__webpack_require__(8));
var dashboard_icons_1 = __webpack_require__(2);
var BaseInput_1 = __importDefault(__webpack_require__(9));
var enhancer_1 = __webpack_require__(11);
var inputItem_1 = __webpack_require__(4);
var SelectSchema_1 = __importDefault(__webpack_require__(5));
var DropdownEditorConfig_1 = __importDefault(__webpack_require__(30));
var selectStyle = {
    width: '100%',
};
...
var Select = function (_a) {
    var value = _a.value, onValueChange = _a.onValueChange, _b = _a.options, defaultValue = _b.defaultValue, _c = _b.items, items = _c === void 0 ? noItems : _c, _d = _b.selectFirstSearchResult, selectFirstSearchResult = _d === void 0 ? false : _d, dataSources = _a.dataSources, encoding = _a.encoding, context = _a.context, isLoading = _a.loading, isError = _a.isError, errorMessage = _a.errorMessage, initialDisableStatus = _a.isDisabled, initialDisabledMessage = _a.disabledMessage;
    ...
    var isDisabled = initialDisableStatus || (searchHasNoResults && defaultValue == null);
    var disabledMessage = isDisabled && (initialDisabledMessage || i18n_1._('No search results'));
    ...
    var _e = react_1.useMemo(function () {
        ...
        var defaultValues = defaultValue != null ? [defaultValue] : noItems;
        var staticItems = inputItem_1.hasDynamicOptions([items]) ? noItems : items;
        ...
        var menuOptions = validItems.map(function (_a) {
            var label = _a.label, itemValue = _a.value;
            return (react_1.default.createElement(Select_1.default.Option, { label: label, value: itemValue, key: itemValue, truncate: true }));
        });
    ...
    ]), menuItems = _e.menuItems, firstSearchResult = _e.firstSearchResult;
    var currentValue = value || firstSearchResult || defaultValue || '';
    ...
    var handleClick = react_1.useCallback(function (evt, _a) {
        var itemValue = _a.value;
    ...
    return (react_1.default.createElement(Select_1.default, { value: currentValue, onChange: handleClick, disabled: isDisabled || isError, defaultPlacement: "below", 
        ...
        isLoadingOptions: isLoading, loadingMessage: loadingMessage, placeholder: placeholder, filter: !isLoading, inline: true, style: selectStyle }, menuItems));
};
Select.propTypes = __assign({}, BaseInput_1.default.propTypes);
Select.defaultProps = __assign({}, BaseInput_1.default.defaultProps);
var meta = {
    label: i18n_1._('Dropdown'),
    description: i18n_1._('Select a single list value'),
    defaultConfig: {
        options: {
            items: [
        ...
        title: i18n_1._('Dropdown Input Title'),
    },
    tokenPrefix: 'dd',
    icon: dashboard_icons_1.DropdownInput,
};
Select.config = __assign({ optionsSchema: SelectSchema_1.default, editorConfig: DropdownEditorConfig_1.default, dataContract: inputItem_1.dataContract }, mapKeys_1.default(meta, function (value, key) {
 ...
 * @returns {Object}
 */
Select.valueToTokens = function (value, _a) {
    var _b, _c;
    var token = _a.token, _d = _a.prefix, prefix = _d === void 0 ? '' : _d, _e = _a.suffix, suffix = _e === void 0 ? '' : _e;
    if (!token) {
        return {};
    }
    if (!value) {
    ...
    return _c = {},
        _c[token] = "" + prefix + value + suffix,
        _c;
};
exports.default = enhancer_1.withInputWrapper(Select);
...
var react_1 = __importStar(__webpack_require__(0));
var styled_components_1 = __importDefault(__webpack_require__(12));
var i18n_1 = __webpack_require__(1);
var get_1 = __importDefault(__webpack_require__(13));
var lodash_1 = __webpack_require__(3);
var react_sortable_hoc_1 = __webpack_require__(14);
var Remove_1 = __importDefault(__webpack_require__(15));
var Warning_1 = __importDefault(__webpack_require__(16));
var Tooltip_1 = __importDefault(__webpack_require__(17));
var Clickable_1 = __importDefault(__webpack_require__(18));
var dashboard_context_1 = __webpack_require__(19);
var themes_1 = __webpack_require__(20);
var riskyCommandUtils_1 = __webpack_require__(21);
var RiskyWarningPopover_1 = __importDefault(__webpack_require__(22));
var OptionalTooltip_1 = __importDefault(__webpack_require__(23));
var dashboard_icons_1 = __webpack_require__(2);
var inputItem_1 = __webpack_require__(4);
...
var i18n_1 = __webpack_require__(1);
var DefaultSelectedValueEditor_1 = __importDefault(__webpack_require__(31));
...
var lodash_1 = __webpack_require__(3);
var i18n_1 = __webpack_require__(1);
var ControlGroup_1 = __importDefault(__webpack_require__(32));
var RadioBar_1 = __importDefault(__webpack_require__(33));
var ComboBoxEditor_1 = __importDefault(__webpack_require__(34));
var MultiselectDefaultValueEditor_1 = __importDefault(__webpack_require__(35));
...
Object.defineProperty(exports, "__esModule", { value: true });
var react_1 = __importStar(__webpack_require__(0));
var Multiselect_1 = __importDefault(__webpack_require__(36));
/**
