 ...
 */
import { ImportDataset, IndexDataset, KVCollectionDataset, LookupDataset, MetricDataset, ViewDataset } from './';
/**
 * @type Dataset
 * A complete dataset as rendered in POST, PATCH responses.
 * @export
 */
export declare type Dataset = ImportDataset | IndexDataset | KVCollectionDataset | LookupDataset | MetricDataset | ViewDataset;
