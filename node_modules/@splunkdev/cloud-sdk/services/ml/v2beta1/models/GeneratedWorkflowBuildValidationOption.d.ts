 ...
 */
import { WorkflowValidationOption } from './';
/**
 ...
 * @export
 * @interface WorkflowBuildValidationOption
 */
export interface WorkflowBuildValidationOption {
    /**
     *
     * @type {string}
     * @memberof WorkflowBuildValidationOption
     */
    kind: WorkflowBuildValidationOptionKindEnum;
    /**
     *
     * @type {WorkflowValidationOption}
     * @memberof WorkflowBuildValidationOption
     */
    option?: WorkflowValidationOption;
}
/**
 * @export
 */
export declare enum WorkflowBuildValidationOptionKindEnum {
    TrainTest = "TrainTest",
