 ...
 */
import { InputData, OutputData, Score, TaskSummary, Workflow, WorkflowBuildValidationOption, WorkflowBuildValidationScore } from './';
/**
 *
 * @export
 ...
 * @export
 */
export declare enum WorkflowBuildStatusEnum {
    Running = "running",
    Failed = "failed",
    Success = "success",
    Scheduled = "scheduled"
