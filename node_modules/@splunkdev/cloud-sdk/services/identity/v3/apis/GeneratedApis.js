...
var GeneratedIdentityService = /** @class */ (function (_super) {
    ...
    function GeneratedIdentityService() {
        ...
        _this.deletePrincipalPublicKey = function (principal, keyId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_6 || (templateObject_6 = __makeTemplateObject(["/system/identity/v3/principals/", "/keys/", ""], ["/system/identity/v3/principals/", "/keys/", ""])), 'principal', 'keyId')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.deleteRole = function (role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_7 || (templateObject_7 = __makeTemplateObject(["/identity/v3/roles/", ""], ["/identity/v3/roles/", ""])), 'role')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getGroup = function (group, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_8 || (templateObject_8 = __makeTemplateObject(["/identity/v3/groups/", ""], ["/identity/v3/groups/", ""])), 'group')(path_params);
        ...
        _this.getGroupMember = function (group, member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_9 || (templateObject_9 = __makeTemplateObject(["/identity/v3/groups/", "/members/", ""], ["/identity/v3/groups/", "/members/", ""])), 'group', 'member')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getGroupRole = function (group, role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_10 || (templateObject_10 = __makeTemplateObject(["/identity/v3/groups/", "/roles/", ""], ["/identity/v3/groups/", "/roles/", ""])), 'group', 'role')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getMember = function (member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_11 || (templateObject_11 = __makeTemplateObject(["/identity/v3/members/", ""], ["/identity/v3/members/", ""])), 'member')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPrincipal = function (principal, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_12 || (templateObject_12 = __makeTemplateObject(["/system/identity/v3/principals/", ""], ["/system/identity/v3/principals/", ""])), 'principal')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPrincipalPublicKey = function (principal, keyId, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_13 || (templateObject_13 = __makeTemplateObject(["/system/identity/v3/principals/", "/keys/", ""], ["/system/identity/v3/principals/", "/keys/", ""])), 'principal', 'keyId')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getPrincipalPublicKeys = function (principal, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_14 || (templateObject_14 = __makeTemplateObject(["/system/identity/v3/principals/", "/keys"], ["/system/identity/v3/principals/", "/keys"])), 'principal')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getRole = function (role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_15 || (templateObject_15 = __makeTemplateObject(["/identity/v3/roles/", ""], ["/identity/v3/roles/", ""])), 'role')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.getRolePermission = function (role, permission, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_16 || (templateObject_16 = __makeTemplateObject(["/identity/v3/roles/", "/permissions/", ""], ["/identity/v3/roles/", "/permissions/", ""])), 'role', 'permission')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listGroupMembers = function (group, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_17 || (templateObject_17 = __makeTemplateObject(["/identity/v3/groups/", "/members"], ["/identity/v3/groups/", "/members"])), 'group')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listGroupRoles = function (group, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_18 || (templateObject_18 = __makeTemplateObject(["/identity/v3/groups/", "/roles"], ["/identity/v3/groups/", "/roles"])), 'group')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listMemberGroups = function (member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_19 || (templateObject_19 = __makeTemplateObject(["/identity/v3/members/", "/groups"], ["/identity/v3/members/", "/groups"])), 'member')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listMemberPermissions = function (member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_20 || (templateObject_20 = __makeTemplateObject(["/identity/v3/members/", "/permissions"], ["/identity/v3/members/", "/permissions"])), 'member')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listMemberRoles = function (member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_21 || (templateObject_21 = __makeTemplateObject(["/identity/v3/members/", "/roles"], ["/identity/v3/members/", "/roles"])), 'member')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listRoleGroups = function (role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_22 || (templateObject_22 = __makeTemplateObject(["/identity/v3/roles/", "/groups"], ["/identity/v3/roles/", "/groups"])), 'role')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.listRolePermissions = function (role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_23 || (templateObject_23 = __makeTemplateObject(["/identity/v3/roles/", "/permissions"], ["/identity/v3/roles/", "/permissions"])), 'role')(path_params);
            return _this.client.get(exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.removeGroupMember = function (group, member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_24 || (templateObject_24 = __makeTemplateObject(["/identity/v3/groups/", "/members/", ""], ["/identity/v3/groups/", "/members/", ""])), 'group', 'member')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.removeGroupRole = function (group, role, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_25 || (templateObject_25 = __makeTemplateObject(["/identity/v3/groups/", "/roles/", ""], ["/identity/v3/groups/", "/roles/", ""])), 'group', 'role')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.removeMember = function (member, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_26 || (templateObject_26 = __makeTemplateObject(["/identity/v3/members/", ""], ["/identity/v3/members/", ""])), 'member')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.removeRolePermission = function (role, permission, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_27 || (templateObject_27 = __makeTemplateObject(["/identity/v3/roles/", "/permissions/", ""], ["/identity/v3/roles/", "/permissions/", ""])), 'role', 'permission')(path_params);
            return _this.client["delete"](exports.IDENTITY_SERVICE_CLUSTER, _this.client.buildPath('', path.split('/').slice(1)), { query: args, statusCallback: requestStatusCallback })
                .then(function (response) { return response.body; });
        };
        /**
        ...
        _this.revokePrincipalAuthTokens = function (principal, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_28 || (templateObject_28 = __makeTemplateObject(["/system/identity/v3/principals/", "/revoke"], ["/system/identity/v3/principals/", "/revoke"])), 'principal')(path_params);
        ...
        _this.updatePrincipalPublicKey = function (principal, keyId, principalPublicKeyStatusBody, args, requestStatusCallback) {
            ...
            var path = _this.template(templateObject_29 || (templateObject_29 = __makeTemplateObject(["/system/identity/v3/principals/", "/keys/", ""], ["/system/identity/v3/principals/", "/keys/", ""])), 'principal', 'keyId')(path_params);
