 ...
 */
import { DeleteSearchJob, FieldsSummary, ListPreviewResultsResponse, ListSearchResultsResponse, RecurringSearch, SearchJob, SearchModule, SearchStatus, TimeBucketsSummary, UpdateJob, UpdateRecurringSearch } from '../models';
...
export declare class GeneratedSearchService extends BaseApiService {
     ...
     * @return SearchModule
     */
    createMultiSearch: (searchModule?: SearchModule | undefined, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SearchModule>;
    /**
     ...
     */
    createRecurringSearch: (recurringSearch?: RecurringSearch | undefined, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RecurringSearch>;
    /**
     * Create a multi-statement module with inter-dependencies between statements.
     * @param searchModule
     * @param args parameters to be sent with the request
     ...
     * @return RecurringSearch
     */
    deleteRecurringSearch: (rsid: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RecurringSearch>;
    /**
     ...
     */
    getAllJobsForRecurringSearch: (rsid: string, args?: {
        [key: string]: any;
     ...
     * @return SearchJob
     */
    getJobForRecurringSearch: (rsid: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<SearchJob>;
    /**
     ...
     * @return RecurringSearch
     */
    getRecurringSearch: (rsid: string, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RecurringSearch>;
    /**
     ...
     */
    listRecurringSearches: (args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RecurringSearch[]>;
    /**
     ...
     * @return RecurringSearch
     */
    updateRecurringSearch: (rsid: string, updateRecurringSearch?: UpdateRecurringSearch | undefined, args?: object | undefined, requestStatusCallback?: ((requestStatus: RequestStatus) => void) | undefined) => Promise<RecurringSearch>;
}
