...
var _possibleConstructorReturn = __webpack_require__(9);
...
var Downloader_1 = __webpack_require__(27);

var FileDownloader = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(FileDownloader, _React$PureComponent);
  ...
  _createClass(FileDownloader, [{
    ...
    value: function initiateDownload() {
      var _this2 = this;

      this.setState({});
      var url = this.props.url;
      var downloader = new Downloader_1.default(this.props.protocolHandlers);
      downloader.downloadWithProgress(url, function (content) {
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          _this$props$renderPro = _this$props.renderProgress,
          renderProgress = _this$props$renderPro === void 0 ? function (p) {
        return React.createElement("div", null, p.message);
      } : _this$props$renderPro,
          _this$props$renderErr = _this$props.renderError,
          renderError = _this$props$renderErr === void 0 ? function (msg) {
        return React.createElement("div", null, msg);
      } : _this$props$renderErr;
      var _this$state = this.state,
          content = _this$state.content,
          _this$state$progress = _this$state.progress,
          progress = _this$state$progress === void 0 ? {
        message: "Downloading ".concat(url, "..."),
        bytesDownloaded: 0
