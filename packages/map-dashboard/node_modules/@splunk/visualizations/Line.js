...
var lineUtils_1 = __webpack_require__(170);
...
var computeVizProps = function computeVizProps(_a) {
  var dataSources = _a.dataSources,
      ...
      otherOptions = __rest(_a, ["dataSources", "x", "y", "xField", "yFields", "onEventTrigger", "annotationX", "annotationColor", "annotationLabel", "visualizationApiRef"]); // options to be passed as props
  ...
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(lineUtils_1.convertToLineSCProperties).thru(function (options) {
...
var Line = withDashboardViz_1.default({
...
var Line_1 = __webpack_require__(117);
...
var MissingValueSkipped_1 = __webpack_require__(78);

var MissingValueZero_1 = __webpack_require__(79);

var MissingValueJoin_1 = __webpack_require__(80);
...
var optionsSchema = {
  ...
  lineDashStyle: {
    ...
    pattern: schemaUtils_1.getPattern(['solid', 'shortDash', 'shortDot', 'shortDashDot', 'shortDashDotDot', 'dot', 'dash', 'longDash', 'dashDot', 'longDashDot', 'longDashDotDot']),
    type: 'string'
  },
  ...
  markerDisplay: {
    ...
    pattern: schemaUtils_1.getPattern(['off', 'filled', 'outlined']),
...
exports.convertToLineSCProperties = exports.convertToStringValues = exports.mapToOldKey = exports.convertMarkerOptions = exports.lineOptionValuesSCMapping = void 0;
...
exports.lineOptionValuesSCMapping = {
  lineMarkerStyle: {
    filled: 'normal',
    outlined: 'hollow'
  },
...
var convertMarkerOptions = function convertMarkerOptions(originalOptions) {
  var convertedOptions = {
    showMarkers: false
  };

  if (lodash_1.values(exports.lineOptionValuesSCMapping.lineMarkerStyle).includes(originalOptions.lineMarkerStyle)) {
    convertedOptions.showMarkers = true;
    return Object.assign(Object.assign({}, originalOptions), convertedOptions);
  }

  return lodash_1.omit(Object.assign(Object.assign({}, originalOptions), convertedOptions), ['lineMarkerStyle']);
};

exports.convertMarkerOptions = convertMarkerOptions;
/**
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return lineOptionsSCMapping[key] ? lineOptionsSCMapping[key] : key;
  });
};
...
var convertToLineSCProperties = function convertToLineSCProperties(originalOptions) {
  return lodash_1.chain(exports.mapToOldKey(originalOptions)).thru(chartingUtils_1.mapToValues(exports.lineOptionValuesSCMapping)).thru(exports.convertToStringValues).thru(exports.convertMarkerOptions).thru(chartingUtils_1.convertOverlayFields).thru(chartingUtils_1.convertY2AxisOptions).value();
};

exports.convertToLineSCProperties = convertToLineSCProperties;
