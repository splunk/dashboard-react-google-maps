...
var config_1 = __webpack_require__(228);

exports.config = config_1.default;

var withDashboardViz_1 = __webpack_require__(27);

var scatterUtils_1 = __webpack_require__(229);
...
var computeVizProps = function computeVizProps(_a) {
  var dataSources = _a.dataSources,
      ...
      xField = _a.xField,
      yField = _a.yField,
      categoryField = _a.categoryField,
      otherOptions = __rest(_a, ["dataSources", "onEventTrigger", "visualizationApiRef", "x", "y", "category", "xField", "yField", "categoryField"]); // options to be passed as props


  var computedProps = {
    visualizationApiRef: visualizationApiRef
  };
  var hasEventHandlers = otherOptions.hasEventHandlers;
  computedProps.options = lodash_1.chain(otherOptions).pick(validOptions).thru(scatterUtils_1.convertToScatterSCProperties).thru(function (options) {
  ...
  var columns = [x.map(String), y.map(String)];
  var fields = [{
    name: xField
  }, {
    name: yField
  ...
  if (hasEventHandlers) {
    computedProps.onClick = function (event) {
      onEventTrigger(Object.assign(Object.assign({}, event), {
        payload: Object.assign(Object.assign({}, event.payload), {
          name: yField
        })
      }));
    };
...
var Scatter_1 = __webpack_require__(127);
...
exports.optionsSchema = {
  ...
  xAxisAbbreviation: {
    ...
    pattern: schemaUtils_1.getPattern(['auto', 'off']),
    type: 'string'
  },
  yAxisAbbreviation: {
    default: 'auto',
...
var config = {
  ...
  events: {
    ...
    'point.click': {
      description: 'triggered when user clicks on a point in the scatter chart'
    }
  },
...
exports.convertToScatterSCProperties = exports.mapToOldKey = exports.convertToStringValues = exports.scatterOptionValuesSCMapping = void 0;
...
exports.scatterOptionValuesSCMapping = {
  xAxisTitleVisibility: {
    hide: 'collapsed'
  },
  yAxisTitleVisibility: {
...
var mapToOldKey = function mapToOldKey(options) {
  return lodash_1.mapKeys(options, function (val, key) {
    return scatterOptionsSCMapping[key] ? scatterOptionsSCMapping[key] : key;
  });
};
 ...
 * @method convertToScatterSCProperties
 * @param {Object} originalOptions
 * @returns {Object}
 */

var convertToScatterSCProperties = function convertToScatterSCProperties(originalOptions) {
  return lodash_1.chain(exports.mapToOldKey(originalOptions)).thru(chartingUtils_1.mapToValues(exports.scatterOptionValuesSCMapping)).thru(exports.convertToStringValues).value();
};

exports.convertToScatterSCProperties = convertToScatterSCProperties;
