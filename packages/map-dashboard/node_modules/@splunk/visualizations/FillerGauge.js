...
var colorConstants_1 = __webpack_require__(39);
...
exports.themes = exports.computeVizProps = exports.PureFillerGauge = exports.config = void 0;
...
var FillerGauge_1 = __webpack_require__(164);

var gaugeUtils_1 = __webpack_require__(71);

exports.config = config_1.default;
exports.PureFillerGauge = FillerGauge_1.default;
...
var computeVizProps = function computeVizProps(_a) {
  ...
  var defaultColors = {
    backgroundBarFillColor: exports.config.themes.defaultBackgroundBarFillColor(props),
    majorTickFillColor: exports.config.themes.majorTickFillColor(props),
    majorTickStrokeColor: exports.config.themes.majorTickStrokeColor(props),
    valueMarkerFillColor: exports.config.themes.valueMarkerFillColor(props),
    valueMarkerLabelFillColor: exports.config.themes.valueMarkerLabelFillColor(props)
  };
...
var viz = withDashboardViz_1.default({
  ReactViz: FillerGauge_1.default,
...
var GaugeFiller_1 = __webpack_require__(162);
...
var Gauge_1 = __webpack_require__(89);

var BackgroundColor_1 = __webpack_require__(44);

var DynamicGaugeColorEditor_1 = __webpack_require__(163);
...
var optionsSchema = {
  ...
  orientation: {
    ...
    pattern: schemaUtils_1.getPattern(['vertical', 'horizontal']),
    type: 'string'
  },
  value: {
...
var themes = {
  ...
  defaultBackgroundBarFillColor: function defaultBackgroundBarFillColor(props) {
    return pick_1.default({
      enterprise: variables_1.default.backgroundColorHover(props),
      prisma: {
        light: variables_1.default.contentColorActive(props),
        dark: variables_1.default.neutral100(props)
      }
    })(props);
  },
...
var editorConfig = [{
  ...
  layout: [[DynamicGaugeColorEditor_1.getDynamicGaugeColorEditor({
...
exports.getDynamicGaugeColorEditor = void 0;

var i18n_1 = __webpack_require__(3);

var getDynamicGaugeColorEditor = function getDynamicGaugeColorEditor(_ref) {
  var defaultContext = _ref.defaultContext,
      defaultPalettesConfig = _ref.defaultPalettesConfig;
  return {
    label: i18n_1._('Gauge'),
    option: 'gaugeColor',
    context: 'gaugeColorConfig',
    editor: 'editor.dynamicColor',
    editorProps: {
      labelPosition: 'left',
      flyoutTitle: i18n_1._('Dynamic Coloring: Gauge'),
      formatters: [{
...
exports.getDynamicGaugeColorEditor = getDynamicGaugeColorEditor;
...
exports.AXIS_ORIENTATION_TYPES = void 0;
...
var GaugeMajorTicks_1 = __webpack_require__(90);

var GaugeValueMarker_1 = __webpack_require__(91);

var Container = styled_components_1.default.div.withConfig({
  displayName: "FillerGauge__Container",
  componentId: "u356pd-0"
})(["overflow:hidden;", ";background-color:", ";"], function (props) {
  return style_1.toDimension(lodash_1.pick(props, ['width', 'height']));
}, function (props) {
  return props.backgroundColor;
});
var FillerGaugeWrapper = styled_components_1.default.div.withConfig({
  displayName: "FillerGauge__FillerGaugeWrapper",
  componentId: "u356pd-1"
})(["display:flex;justify-content:center;flex-direction:row;width:100%;height:100%;background-color:", ";"], function (props) {
  return props.backgroundColor;
});
var FillerGaugeContainer = styled_components_1.default.div.withConfig({
  displayName: "FillerGauge__FillerGaugeContainer",
  componentId: "u356pd-2"
})(["overflow:hidden;position:relative;", ";"], function (props) {
  return style_1.toDimension(lodash_1.pick(props, ['width', 'height']));
});
var FillerGaugeSVG = styled_components_1.default.svg.withConfig({
  displayName: "FillerGauge__FillerGaugeSVG",
  componentId: "u356pd-3"
})(["", ";"], function (props) {
  return style_1.toDimension(lodash_1.pick(props, ['width', 'height']));
});
var BackgroundBar = styled_components_1.default.rect.attrs({
  ...
  displayName: "FillerGauge__BackgroundBar",
  componentId: "u356pd-4"
})(["fill:", ";"], function (props) {
  return props.backgroundBarFillColor;
});
var FillBar = styled_components_1.default.rect.attrs({
  'data-test': 'fill-bar-rect'
}).withConfig({
  displayName: "FillerGauge__FillBar",
  componentId: "u356pd-5"
})(["fill:", ";"], function (props) {
  return props.color;
});
...
var FillerGauge = function FillerGauge(_a) {
  var props = __rest(_a, []);
  ...
  var width = props.width,
      ...
      usePercentageValue = props.usePercentageValue,
      backgroundColor = props.backgroundColor,
      backgroundBarFillColor = props.backgroundBarFillColor,
      majorTickFillColor = props.majorTickFillColor,
      majorTickStrokeColor = props.majorTickStrokeColor,
      valueMarkerFillColor = props.valueMarkerFillColor,
      valueMarkerLabelFillColor = props.valueMarkerLabelFillColor;
  ...
  var renderVisualization = function renderVisualization(_ref) {
    ...
    var _gaugeUtils_1$getFill = gaugeUtils_1.getFillBarDimensions({
      gaugeLength: gaugeLength,
      gaugeStartX: gaugeStartX,
      gaugeStartY: gaugeStartY,
      gaugeWidth: gaugeWidth,
      ...
      orientation: orientation
        ...
        fillBarLength = _gaugeUtils_1$getFill.fillBarLength,
        fillBarX = _gaugeUtils_1$getFill.fillBarX,
        fillBarY = _gaugeUtils_1$getFill.fillBarY,
        fillBarWidth = _gaugeUtils_1$getFill.fillBarWidth,
        fillBarHeight = _gaugeUtils_1$getFill.fillBarHeight;

    var _gaugeUtils_1$getFill2 = gaugeUtils_1.getFillerGaugeValueMarkerPositions({
      fillBarX: fillBarX,
      fillBarY: fillBarY,
      fillBarLength: fillBarLength,
      orientation: orientation
    }),
        valueMarkerX = _gaugeUtils_1$getFill2.valueMarkerX,
        valueMarkerY = _gaugeUtils_1$getFill2.valueMarkerY;

    return React.createElement(FillerGaugeWrapper, {
      backgroundColor: backgroundColor,
      "data-test": "FillerGaugeWrapper"
    }, React.createElement(FillerGaugeContainer, {
      width: containerWidth,
      height: containerHeight,
      "data-test": "FillerGaugeContainer"
    }, React.createElement(FillerGaugeSVG, {
      width: containerWidth,
      height: containerHeight,
      "data-test": "FillerGaugeSVG"
    }, React.createElement(BackgroundBar, {
      x: gaugeStartX,
      y: gaugeStartY,
      width: gaugeWidth,
      height: gaugeHeight,
      ...
      majorTickFillColor: majorTickFillColor,
      majorTickStrokeColor: majorTickStrokeColor
    }), React.createElement(FillBar, {
      x: fillBarX,
      y: fillBarY,
      width: fillBarWidth,
      height: fillBarHeight,
      color: gaugeColor || gaugeUtils_1.assignGaugeColor({
        value: value,
        min: min,
        max: max
      }),
