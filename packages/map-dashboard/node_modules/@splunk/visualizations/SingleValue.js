...
/* harmony import */ var _splunk_visualizations_shared_colorConstants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(39);
...
var getTrendText = function getTrendText(_ref6) {
  ...
  if (showPercent) {
    ...
    if (trendValue === majorValue && trendValue !== 0 && majorValue !== 0) {
      value = 'N/A';
    }
  }
  ...
  return showPercent && !Number.isNaN(Number(value)) ? "".concat(trendText, "%") : trendText;
};
/**
...
var SingleValue_1 = __webpack_require__(253);
...
var variables_1 = __webpack_require__(232);
...
var propUtils_ = __webpack_require__(18);
...
var colorConstants_ = __webpack_require__(39);

// EXTERNAL MODULE: external "@splunk/visualizations-shared/numberUtils"
var numberUtils_ = __webpack_require__(20);
...
var SingleValue_SingleValue = function SingleValue(_ref) {
  ...
  var renderVisualization = function renderVisualization(_ref2) {
    var containerWidth = _ref2.width,
        containerHeight = _ref2.height; // will update later based on text size
