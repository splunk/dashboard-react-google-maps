...
var PureTable = function PureTable(props) {
  ...
  var drilldown = React.useCallback(function (e, payload) {
  ...
  var debouncedDrilldown = React.useCallback(debounce(drilldown, 200), []);
  ...
  return React.createElement(VizTableContainer, {
    ...
    onClick: onCellClick ? drilldownHandler : function () {}
...
var Line_1 = __webpack_require__(76);
